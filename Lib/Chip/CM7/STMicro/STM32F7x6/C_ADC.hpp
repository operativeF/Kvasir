...
//Common ADC registers
    ...
    namespace CAdcCdr{    ///<ADC common regular data register for dual          and triple modes
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> data1{}; 
    }
}
