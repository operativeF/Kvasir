...
//General-purpose I/Os
    namespace GpioiModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40022000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40022004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioiGpiobOspeedr{    ///<GPIO port output speed          register
    ...
    namespace GpioiIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40022010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40022014,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40022018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002201c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiAfrl{    ///<GPIO alternate function          lowregister
    ...
    namespace GpioiAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40022024,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40022028,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
