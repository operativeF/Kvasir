...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011000,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart1Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011008,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001101c,0xff802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Usart1Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40011020,0xffede4a0,0x00000000,std::uint32_t>;
