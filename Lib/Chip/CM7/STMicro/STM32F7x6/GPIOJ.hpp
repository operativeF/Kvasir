...
//General-purpose I/Os
    namespace GpiojModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40022400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40022404,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiojGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40022408,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiojPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002240c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiojIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40022410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40022414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40022418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002241c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojAfrl{    ///<GPIO alternate function          lowregister
        using Addr = Register::Address<0x40022420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40022424,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40022428,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
