...
//USB on the go full speed
    ...
    namespace OtgFsGlobalOtgFsGpwrdn{    ///<OTG power down register
        using Addr = Register::Address<0x50000058,0xff7ffffe,0x00000000,std::uint32_t>;
        ///ADP module enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> adpmen{}; 
        ///ADP interrupt flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> adpif{}; 
    }
    namespace OtgFsGlobalOtgFsGadpctl{    ///<OTG ADP timer, control and status          register
        using Addr = Register::Address<0x50000060,0xe0000000,0x00000000,std::uint32_t>;
        ///Probe discharge
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> prbdschg{}; 
        ///Probe delta
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> prbdelta{}; 
        ///Probe period
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> prbper{}; 
        ///Ramp time
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rtim{}; 
        ///Enable probe
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> enaprb{}; 
        ///Enable sense
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> enasns{}; 
        ///ADP reset
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> adprst{}; 
        ///ADP enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> adpen{}; 
        ///ADP probe interrupt flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> adpprbif{}; 
        ///ADP sense interrupt flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> adpsnsif{}; 
        ///ADP timeout interrupt flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> adptoif{}; 
        ///ADP probe interrupt mask
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> adpprbim{}; 
        ///ADP sense interrupt mask
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> adpsnsim{}; 
        ///ADP timeout interrupt mask
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> adptoim{}; 
        ///Access request
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(28,27),Register::ReadWriteAccess,unsigned> ar{}; 
    }
