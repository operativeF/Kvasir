...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart7Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40007800,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Uart7Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007808,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000781c,0xff802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Uart7Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40007820,0xffede4a0,0x00000000,std::uint32_t>;
