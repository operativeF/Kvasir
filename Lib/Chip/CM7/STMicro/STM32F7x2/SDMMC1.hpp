...
//Secure digital input/output      interface
    ...
    namespace Sdmmc1Cmd{    ///<command register
        using Addr = Register::Address<0x40012c0c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Sta{    ///<status register
        using Addr = Register::Address<0x40012c34,0xff800200,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Icr{    ///<interrupt clear register
        using Addr = Register::Address<0x40012c38,0xffbffa00,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Mask{    ///<mask register
        using Addr = Register::Address<0x40012c3c,0xff800200,0x00000000,std::uint32_t>;
