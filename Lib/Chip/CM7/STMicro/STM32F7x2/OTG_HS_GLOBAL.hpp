...
//USB on the go high speed
    ...
    namespace OtgHsGlobalOtgHsHnptxfsizHost{    ///<OTG_HS nonperiodic transmit FIFO size          register (host mode)
    ...
    namespace OtgHsGlobalOtgHsDieptxf0Device{    ///<Endpoint 0 transmit FIFO size (peripheral          mode)
        using Addr = Register::Address<0x40040028,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace OtgHsGlobalOtgHsHnptxsts{    ///<OTG_HS nonperiodic transmit FIFO/queue          status register
    ...
    namespace OtgHsGlobalOtgHsDieptxf3{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x4004010c,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    ...
    namespace OtgHsGlobalOtgHsDieptxf4{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40040110,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    ...
    namespace OtgHsGlobalOtgHsDieptxf5{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40040114,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    ...
    namespace OtgHsGlobalOtgHsDieptxf6{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40040118,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    ...
    namespace OtgHsGlobalOtgHsGrxstsrDevice{    ///<OTG_HS Receive status debug read register          (peripheral mode mode)
    ...
    namespace OtgHsGlobalOtgHsGrxstspDevice{    ///<OTG_HS status read and pop register          (peripheral mode)
    ...
    namespace OtgHsGlobalOtgHsGlpmcfg{    ///<OTG core LPM configuration          register
    ...
    namespace OtgHsGlobalOtgHsGi2cctl{    ///<OTG I2C access register
        using Addr = Register::Address<0x40040030,0x22000000,0x00000000,std::uint32_t>;
        ///I2C Busy/Done
