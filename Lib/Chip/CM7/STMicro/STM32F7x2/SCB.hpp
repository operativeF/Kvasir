...
//System control block
    ...
    namespace ScbCcr{    ///<Configuration and control          register
        using Addr = Register::Address<0xe000ed14,0xfff8fce4,0x00000000,std::uint32_t>;
        ...
        ///DC
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> dc{}; 
        ///IC
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> ic{}; 
        ///BP
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> bp{}; 
    }
