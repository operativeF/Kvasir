...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart2Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40004400,0xe0000002,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart2Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004408,0xfef10000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000441c,0xfdd82000,0x00000000,std::uint32_t>;
        ///TEACK
    ...
    namespace Usart2Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40004420,0xfffde420,0x00000000,std::uint32_t>;
