...
//General-purpose-timers
    namespace Tim13Cr1{    ///<control register 1
        using Addr = Register::Address<0x40001c00,0xfffffc70,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim13Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40001c18,0xfffeff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40001c08,0x00000000,0x00000000,std::uint32_t>;
        ///Res.
