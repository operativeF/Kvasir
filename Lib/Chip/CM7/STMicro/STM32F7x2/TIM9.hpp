...
//General purpose timers
    ...
    namespace Tim9Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001400c,0xffffffb8,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Sr{    ///<status register
        using Addr = Register::Address<0x40014010,0xfffff9b8,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Egr{    ///<event generation register
        using Addr = Register::Address<0x40014014,0xffffffb8,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim9Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40014020,0xffffff44,0x00000000,std::uint32_t>;
