...
//Advanced-timers
    ...
    namespace Tim8Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40010408,0xfffe0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Sr{    ///<status register
        using Addr = Register::Address<0x40010410,0xffffe000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccmr2Input{    ///<capture/compare mode register 1 (input          mode)
    ...
    namespace Tim8Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4001044c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccr6{    ///<capture/compare register 6
