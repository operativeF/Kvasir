...
//Serial peripheral interface
    ...
    namespace Spi5Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015004,0xffff8000,0x00000000,std::uint32_t>;
    ...
    namespace Spi5Sr{    ///<status register
        using Addr = Register::Address<0x40015008,0xffffe000,0x00000000,std::uint32_t>;
        ///frame format error
    ...
    namespace Spi5I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001501c,0xffffe040,0x00000000,std::uint32_t>;
        ///I2S mode selection
