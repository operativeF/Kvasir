...
//Secure digital input/output      interface
    ...
    namespace Sdmmc2Cmd{    ///<command register
        using Addr = Register::Address<0x40011c0c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Sta{    ///<status register
        using Addr = Register::Address<0x40011c34,0xff800200,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Icr{    ///<interrupt clear register
        using Addr = Register::Address<0x40011c38,0xffbffa00,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Mask{    ///<mask register
        using Addr = Register::Address<0x40011c3c,0xff800200,0x00000000,std::uint32_t>;
