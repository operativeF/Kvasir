...
//Secure digital input/output      interface
    namespace Sdmmc2Power{    ///<power control register
        using Addr = Register::Address<0x40011c00,0xfffffffc,0x00000000,std::uint32_t>;
        ///PWRCTRL
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> pwrctrl{}; 
    }
    namespace Sdmmc2Clkcr{    ///<SDI clock control register
        using Addr = Register::Address<0x40011c04,0xffff8000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Arg{    ///<argument register
        using Addr = Register::Address<0x40011c08,0x00000000,0x00000000,std::uint32_t>;
        ///Command argument
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cmdarg{}; 
    }
    namespace Sdmmc2Cmd{    ///<command register
        using Addr = Register::Address<0x40011c0c,0xffff8000,0x00000000,std::uint32_t>;
        ///CE-ATA command
    ...
    namespace Sdmmc2Respcmd{    ///<command response register
        using Addr = Register::Address<0x40011c10,0xffffffc0,0x00000000,std::uint32_t>;
        ///Response command index
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> respcmd{}; 
    }
    namespace Sdmmc2Resp1{    ///<response 1..4 register
        using Addr = Register::Address<0x40011c14,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus1{}; 
    }
    namespace Sdmmc2Resp2{    ///<response 1..4 register
        using Addr = Register::Address<0x40011c18,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus2{}; 
    }
    namespace Sdmmc2Resp3{    ///<response 1..4 register
        using Addr = Register::Address<0x40011c1c,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus3{}; 
    }
    namespace Sdmmc2Resp4{    ///<response 1..4 register
        using Addr = Register::Address<0x40011c20,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus4{}; 
    }
    namespace Sdmmc2Dtimer{    ///<data timer register
        using Addr = Register::Address<0x40011c24,0x00000000,0x00000000,std::uint32_t>;
        ///Data timeout period
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> datatime{}; 
    }
    namespace Sdmmc2Dlen{    ///<data length register
        using Addr = Register::Address<0x40011c28,0xfe000000,0x00000000,std::uint32_t>;
        ///Data length value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,0),Register::ReadWriteAccess,unsigned> datalength{}; 
    }
    namespace Sdmmc2Dctrl{    ///<data control register
        using Addr = Register::Address<0x40011c2c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Dcount{    ///<data counter register
        using Addr = Register::Address<0x40011c30,0xfe000000,0x00000000,std::uint32_t>;
        ///Data count value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,0),Register::ReadWriteAccess,unsigned> datacount{}; 
    }
    namespace Sdmmc2Sta{    ///<status register
        using Addr = Register::Address<0x40011c34,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Icr{    ///<interrupt clear register
        using Addr = Register::Address<0x40011c38,0xff3ff800,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Mask{    ///<mask register
        using Addr = Register::Address<0x40011c3c,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Fifocnt{    ///<FIFO counter register
        using Addr = Register::Address<0x40011c48,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2Fifo{    ///<data FIFO register
        using Addr = Register::Address<0x40011c80,0x00000000,0x00000000,std::uint32_t>;
