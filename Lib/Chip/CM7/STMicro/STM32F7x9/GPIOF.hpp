...
//General-purpose I/Os
    namespace GpiofModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40021400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40021404,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40021408,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002140c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40021410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40021414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40021418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002141c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofAfrl{    ///<GPIO alternate function          lowregister
        using Addr = Register::Address<0x40021420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40021424,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40021428,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
