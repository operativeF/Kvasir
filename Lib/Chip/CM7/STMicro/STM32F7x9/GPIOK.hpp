...
//General-purpose I/Os
    namespace GpiokModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40022800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40022804,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiokGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40022808,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiokPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002280c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiokIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40022810,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40022814,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40022818,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002281c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokAfrl{    ///<GPIO alternate function          lowregister
        using Addr = Register::Address<0x40022820,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40022824,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiokBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40022828,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
