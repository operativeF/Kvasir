...
//General-purpose I/Os
    namespace GpioaModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40020000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioaOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40020004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioaGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40020008,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioaPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002000c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioaIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40020010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioaLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002001c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioaBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40020028,0xffff0000,0x00000000,std::uint32_t>;
        ///Port A Reset bit 0
