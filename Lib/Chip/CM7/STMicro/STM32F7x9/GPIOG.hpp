...
//General-purpose I/Os
    namespace GpiogModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40021800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40021804,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40021808,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002180c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40021810,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40021814,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40021818,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002181c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogAfrl{    ///<GPIO alternate function          lowregister
        using Addr = Register::Address<0x40021820,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40021824,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40021828,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
