...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart8Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40007c00,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Uart8Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007c08,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x40007c1c,0xff802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Uart8Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40007c20,0xffede4a0,0x00000000,std::uint32_t>;
