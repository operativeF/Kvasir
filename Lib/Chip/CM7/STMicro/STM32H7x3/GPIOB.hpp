...
namespace Kvasir {
//GPIO
    namespace GpiobGpioaModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x58020400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x58020404,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x58020408,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x5802040c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x58020410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x58020414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x58020418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaLckr{    ///<This register is used to lock the          configuration of the port bits when a correct write          sequence is applied to bit 16 (LCKK). The value of bits          [15:0] is used to lock the configuration of the GPIO.          During the write sequence, the value of LCKR[15:0] must          not change. When the LOCK sequence has been applied on a          port bit, the value of this port bit can no longer be          modified until the next MCU reset or peripheral reset.A          specific write sequence is used to write to the          GPIOx_LCKR register. Only word access (32-bit long) is          allowed during this locking sequence.Each lock bit          freezes a specific configuration register (control and          alternate function registers).
        using Addr = Register::Address<0x5802041c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x58020420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobGpioaAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x58020424,0x00000000,0x00000000,std::uint32_t>;
