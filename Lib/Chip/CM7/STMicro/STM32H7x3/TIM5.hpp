...
//General purpose timers
    ...
    namespace Tim5Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000c08,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim5Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40000c60,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim5Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40000c68,0xf0f0f0f0,0x00000000,std::uint32_t>;
