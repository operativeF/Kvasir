...
//Serial peripheral interface
    namespace Spi4Cr1{    ///<control register 1
        using Addr = Register::Address<0x40013400,0xfffe00fe,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Cr2{    ///<control register 2
        using Addr = Register::Address<0x40013404,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Cfg1{    ///<configuration register 1
        using Addr = Register::Address<0x40013408,0x8fa02000,0x00000000,std::uint32_t>;
        ///Master baud rate
    ...
    namespace Spi4Cfg2{    ///<configuration register 2
        using Addr = Register::Address<0x4001340c,0x08017f00,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40013410,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Sr{    ///<Status Register
        using Addr = Register::Address<0x40013414,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Ifcr{    ///<Interrupt/Status Flags Clear          Register
        using Addr = Register::Address<0x40013418,0xfffff007,0x00000000,std::uint32_t>;
        ///SUSPend flag clear
    ...
    namespace Spi4Txdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40013420,0x00000000,0x00000000,std::uint32_t>;
        ///Transmit data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> txdr{}; 
    }
    namespace Spi4Rxdr{    ///<Receive Data Register
        using Addr = Register::Address<0x40013430,0x00000000,0x00000000,std::uint32_t>;
        ///Receive data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rxdr{}; 
    }
    namespace Spi4Crcpoly{    ///<Polynomial Register
        using Addr = Register::Address<0x40013440,0x00000000,0x00000000,std::uint32_t>;
        ///CRC polynomial register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> crcpoly{}; 
    }
    namespace Spi4Txcrc{    ///<Transmitter CRC Register
        using Addr = Register::Address<0x40013444,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Rxcrc{    ///<Receiver CRC Register
        using Addr = Register::Address<0x40013448,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Udrdr{    ///<Underrun Data Register
        using Addr = Register::Address<0x4001344c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Cgfr{    ///<configuration register
        using Addr = Register::Address<0x40013450,0xfc008040,0x00000000,std::uint32_t>;
