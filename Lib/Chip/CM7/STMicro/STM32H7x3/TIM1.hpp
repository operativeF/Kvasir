...
//Advanced-timers
    ...
    namespace Tim1Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40010008,0xffce0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Sr{    ///<status register
        using Addr = Register::Address<0x40010010,0xfffcc000,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4001004c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Crr6{    ///<capture/compare register 6
    ...
    namespace Tim1Af1{    ///<TIM1 alternate function option register          1
        using Addr = Register::Address<0x40010060,0xfffc30f8,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Af2{    ///<TIM1 Alternate function odfsdm1_breakster          2
        using Addr = Register::Address<0x40010064,0xfffff0f8,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Tisel{    ///<TIM1 timer input selection          register
        using Addr = Register::Address<0x40010068,0xf0f0f0f0,0x00000000,std::uint32_t>;
