...
namespace Kvasir {
//DELAY_Block_SDMMC1
    namespace DelayBlockSdmmc2Cr{    ///<DLYB control register
        using Addr = Register::Address<0x48022800,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace DelayBlockSdmmc2Cfgr{    ///<DLYB configuration register
        using Addr = Register::Address<0x48022804,0x700080f0,0x00000000,std::uint32_t>;
