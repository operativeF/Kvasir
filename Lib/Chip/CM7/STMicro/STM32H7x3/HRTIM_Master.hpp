...
//High Resolution Timer: Master      Timers
    namespace HrtimMasterMcr{    ///<Master Timer Control Register
        using Addr = Register::Address<0x40017400,0x11c000c0,0x00000000,std::uint32_t>;
        ///Burst DMA Update
    ...
    namespace HrtimMasterMisr{    ///<Master Timer Interrupt Status          Register
        using Addr = Register::Address<0x40017404,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMicr{    ///<Master Timer Interrupt Clear          Register
        using Addr = Register::Address<0x40017408,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMdier4{    ///<MDIER4
        using Addr = Register::Address<0x4001740c,0xff80ff80,0x00000000,std::uint32_t>;
        ///MUPDDE
    ...
    namespace HrtimMasterMcntr{    ///<Master Timer Counter Register
        using Addr = Register::Address<0x40017410,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> mcnt{}; 
    }
    namespace HrtimMasterMper{    ///<Master Timer Period Register
        using Addr = Register::Address<0x40017414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMrep{    ///<Master Timer Repetition          Register
        using Addr = Register::Address<0x40017418,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMcmp1r{    ///<Master Timer Compare 1          Register
        using Addr = Register::Address<0x4001741c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMcmp2r{    ///<Master Timer Compare 2          Register
        using Addr = Register::Address<0x40017424,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMcmp3r{    ///<Master Timer Compare 3          Register
        using Addr = Register::Address<0x40017428,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimMasterMcmp4r{    ///<Master Timer Compare 4          Register
        using Addr = Register::Address<0x4001742c,0xffff0000,0x00000000,std::uint32_t>;
