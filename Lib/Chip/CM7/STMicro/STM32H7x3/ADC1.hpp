...
//Analog to Digital Converter
    namespace Adc1Isr{    ///<ADC interrupt and status          register
        using Addr = Register::Address<0x40022000,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ier{    ///<ADC interrupt enable register
        using Addr = Register::Address<0x40022004,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Cr{    ///<ADC control register
        using Addr = Register::Address<0x40022008,0x003efec0,0x00000000,std::uint32_t>;
        ///ADC calibration
    ...
    namespace Adc1Cfgr{    ///<ADC configuration register 1
        using Addr = Register::Address<0x4002200c,0x00008010,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Cfgr2{    ///<ADC configuration register 2
        using Addr = Register::Address<0x40022010,0x0c00801c,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Smpr1{    ///<ADC sampling time register 1
        using Addr = Register::Address<0x40022014,0xc0000007,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Smpr2{    ///<ADC sampling time register 2
        using Addr = Register::Address<0x40022018,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ltr1{    ///<ADC analog watchdog 1 threshold          register
        using Addr = Register::Address<0x40022020,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Lhtr1{    ///<ADC analog watchdog 2 threshold          register
        using Addr = Register::Address<0x40022024,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr1{    ///<ADC group regular sequencer ranks register          1
        using Addr = Register::Address<0x40022030,0xe0820830,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr2{    ///<ADC group regular sequencer ranks register          2
        using Addr = Register::Address<0x40022034,0xe0820820,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr3{    ///<ADC group regular sequencer ranks register          3
        using Addr = Register::Address<0x40022038,0xe0820820,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr4{    ///<ADC group regular sequencer ranks register          4
        using Addr = Register::Address<0x4002203c,0xfffff820,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Dr{    ///<ADC group regular conversion data          register
        using Addr = Register::Address<0x40022040,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jsqr{    ///<ADC group injected sequencer          register
        using Addr = Register::Address<0x4002204c,0x04104000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ofr1{    ///<ADC offset number 1 register
        using Addr = Register::Address<0x40022060,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ofr2{    ///<ADC offset number 2 register
        using Addr = Register::Address<0x40022064,0x00000000,0x00000000,std::uint32_t>;
        ///ADC offset number 1 enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ssate{}; 
        ///ADC offset number 1 channel              selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,26),Register::ReadWriteAccess,unsigned> offset1Ch{}; 
    ...
    namespace Adc1Ofr3{    ///<ADC offset number 3 register
        using Addr = Register::Address<0x40022068,0x00000000,0x00000000,std::uint32_t>;
        ///ADC offset number 1 enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ssate{}; 
        ///ADC offset number 1 channel              selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,26),Register::ReadWriteAccess,unsigned> offset1Ch{}; 
    ...
    namespace Adc1Ofr4{    ///<ADC offset number 4 register
        using Addr = Register::Address<0x4002206c,0x00000000,0x00000000,std::uint32_t>;
        ///ADC offset number 1 enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ssate{}; 
        ///ADC offset number 1 channel              selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,26),Register::ReadWriteAccess,unsigned> offset1Ch{}; 
    ...
    namespace Adc1Jdr1{    ///<ADC group injected sequencer rank 1          register
        using Addr = Register::Address<0x40022080,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jdr2{    ///<ADC group injected sequencer rank 2          register
        using Addr = Register::Address<0x40022084,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jdr3{    ///<ADC group injected sequencer rank 3          register
        using Addr = Register::Address<0x40022088,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jdr4{    ///<ADC group injected sequencer rank 4          register
        using Addr = Register::Address<0x4002208c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Awd2cr{    ///<ADC analog watchdog 2 configuration          register
        using Addr = Register::Address<0x400220a0,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Awd3cr{    ///<ADC analog watchdog 3 configuration          register
        using Addr = Register::Address<0x400220a4,0xffe00001,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Difsel{    ///<ADC channel differential or single-ended          mode selection register
        using Addr = Register::Address<0x400220c0,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Calfact{    ///<ADC calibration factors          register
        using Addr = Register::Address<0x400220c4,0xf800f800,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ccr{    ///<ADC common control register
        using Addr = Register::Address<0x40022008,0xfe00ffff,0x00000000,std::uint32_t>;
        ///ADC clock mode
    ...
    namespace Adc1Pcsel{    ///<ADC pre channel selection          register
        using Addr = Register::Address<0x4002201c,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ltr2{    ///<ADC watchdog lower threshold register          2
        using Addr = Register::Address<0x400220b0,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Htr2{    ///<ADC watchdog higher threshold register          2
        using Addr = Register::Address<0x400220b4,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ltr3{    ///<ADC watchdog lower threshold register          3
        using Addr = Register::Address<0x400220b8,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Htr3{    ///<ADC watchdog higher threshold register          3
        using Addr = Register::Address<0x400220bc,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Calfact2{    ///<ADC Calibration Factor register          2
        using Addr = Register::Address<0x400220c8,0xc0000000,0x00000000,std::uint32_t>;
