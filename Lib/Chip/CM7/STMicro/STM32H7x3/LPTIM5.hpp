...
namespace Kvasir {
//Low power timer
    namespace Lptim5Isr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x58003000,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim5Icr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x58003004,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim5Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x58003008,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim5Cfgr{    ///<Configuration Register
        using Addr = Register::Address<0x5800300c,0xfe011120,0x00000000,std::uint32_t>;
        ///Encoder mode enable
    ...
    namespace Lptim5Cr{    ///<Control Register
        using Addr = Register::Address<0x58003010,0xffffffe0,0x00000000,std::uint32_t>;
        ///LPTIM Enable
    ...
    namespace Lptim5Cmp{    ///<Compare Register
        using Addr = Register::Address<0x58003014,0xffff0000,0x00000000,std::uint32_t>;
        ///Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cmp{}; 
    }
    namespace Lptim5Arr{    ///<Autoreload Register
        using Addr = Register::Address<0x58003018,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto reload value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> arr{}; 
    }
    namespace Lptim5Cnt{    ///<Counter Register
        using Addr = Register::Address<0x5800301c,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Lptim5LptimCfgr2{    ///<LPTIM configuration register 2
        using Addr = Register::Address<0x58003024,0xfffffffc,0x00000000,std::uint32_t>;
