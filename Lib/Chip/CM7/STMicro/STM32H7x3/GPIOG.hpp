...
namespace Kvasir {
//GPIO
    namespace GpiogGpioaModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x58021800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x58021804,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x58021808,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x5802180c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x58021810,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x58021814,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x58021818,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaLckr{    ///<This register is used to lock the          configuration of the port bits when a correct write          sequence is applied to bit 16 (LCKK). The value of bits          [15:0] is used to lock the configuration of the GPIO.          During the write sequence, the value of LCKR[15:0] must          not change. When the LOCK sequence has been applied on a          port bit, the value of this port bit can no longer be          modified until the next MCU reset or peripheral reset.A          specific write sequence is used to write to the          GPIOx_LCKR register. Only word access (32-bit long) is          allowed during this locking sequence.Each lock bit          freezes a specific configuration register (control and          alternate function registers).
        using Addr = Register::Address<0x5802181c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x58021820,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogGpioaAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x58021824,0x00000000,0x00000000,std::uint32_t>;
