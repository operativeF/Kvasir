...
//General purpose timers
    namespace Tim14Cr1{    ///<control register 1
        using Addr = Register::Address<0x40002000,0xfffff400,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Cr2{    ///<control register 2
        using Addr = Register::Address<0x40002004,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim14Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40002008,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim14Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000200c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Sr{    ///<status register
        using Addr = Register::Address<0x40002010,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Egr{    ///<event generation register
        using Addr = Register::Address<0x40002014,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim14Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40002018,0xfefe0000,0x00000000,std::uint32_t>;
        ///CC1S
    ...
    namespace Tim14Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40002018,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x4000201c,0xfefe0000,0x00000000,std::uint32_t>;
        ///Output Compare 2 mode - bit              3
    ...
    namespace Tim14Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x4000201c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40002020,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Cnt{    ///<counter
        using Addr = Register::Address<0x40002024,0x00000000,0x00000000,std::uint32_t>;
        ///low counter value
    ...
    namespace Tim14Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4000202c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40002034,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40002038,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4000203c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40002040,0x00000000,0x00000000,std::uint32_t>;
        ///High Capture/Compare value
    ...
    namespace Tim14Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40002048,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim14Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4000204c,0xffff0000,0x00000000,std::uint32_t>;
        ///DMA register for burst              accesses
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dmab{}; 
    }
    namespace Tim14Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40002060,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim14Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40002068,0xf0f0f0f0,0x00000000,std::uint32_t>;
