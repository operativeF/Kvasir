...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart7Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40007800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40007804,0x00000086,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007808,0x00010000,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4000780c,0xffff0000,0x00000000,std::uint32_t>;
        ///DIV_Mantissa
    ...
    namespace Uart7Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40007810,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
    ...
    namespace Uart7Rtor{    ///<Receiver timeout register
        using Addr = Register::Address<0x40007814,0x00000000,0x00000000,std::uint32_t>;
        ///Block Length
    ...
    namespace Uart7Rqr{    ///<Request register
        using Addr = Register::Address<0x40007818,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000781c,0xf0000000,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40007820,0xffedc400,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40007824,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rdr{}; 
    }
    namespace Uart7Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40007828,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> tdr{}; 
    }
    namespace Uart7Presc{    ///<USART prescaler register
        using Addr = Register::Address<0x4000782c,0xfffffff0,0x00000000,std::uint32_t>;
        ///Clock prescaler
