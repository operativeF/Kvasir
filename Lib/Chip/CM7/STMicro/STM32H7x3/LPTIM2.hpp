...
namespace Kvasir {
//Low power timer
    namespace Lptim2Isr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x58002400,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Icr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x58002404,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x58002408,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Cfgr{    ///<Configuration Register
        using Addr = Register::Address<0x5800240c,0xfe011120,0x00000000,std::uint32_t>;
        ///Encoder mode enable
    ...
    namespace Lptim2Cr{    ///<Control Register
        using Addr = Register::Address<0x58002410,0xffffffe0,0x00000000,std::uint32_t>;
        ///LPTIM Enable
        ...
        ///Counter reset
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> countrst{}; 
        ///Reset after read enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> rstare{}; 
    }
    namespace Lptim2Cmp{    ///<Compare Register
        using Addr = Register::Address<0x58002414,0xffff0000,0x00000000,std::uint32_t>;
        ///Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cmp{}; 
    }
    namespace Lptim2Arr{    ///<Autoreload Register
        using Addr = Register::Address<0x58002418,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto reload value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> arr{}; 
    }
    namespace Lptim2Cnt{    ///<Counter Register
        using Addr = Register::Address<0x5800241c,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Lptim2LptimCfgr2{    ///<LPTIM configuration register 2
        using Addr = Register::Address<0x58002424,0xffffffcc,0x00000000,std::uint32_t>;
        ///LPTIM Input 1 selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> in1sel{}; 
        ///LPTIM Input 2 selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> in2sel{}; 
    }
}
