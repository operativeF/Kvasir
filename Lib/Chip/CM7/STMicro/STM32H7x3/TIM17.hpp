...
//General-purpose-timers
    namespace Tim17Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014800,0xfffff470,0x00000000,std::uint32_t>;
        ///Counter enable
    ...
    namespace Tim17Cr2{    ///<control register 2
        using Addr = Register::Address<0x40014804,0xfffffcf2,0x00000000,std::uint32_t>;
        ///Output Idle state 1
    ...
    namespace Tim17Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001480c,0xffffdc5c,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Sr{    ///<status register
        using Addr = Register::Address<0x40014810,0xfffffd5c,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Egr{    ///<event generation register
        using Addr = Register::Address<0x40014814,0xffffff5c,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim17Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40014818,0xfffeff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40014820,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Cnt{    ///<counter
        using Addr = Register::Address<0x40014824,0x7fff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim17Rcr{    ///<repetition counter register
        using Addr = Register::Address<0x40014830,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40014844,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40014848,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim17Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4001484c,0xffff0000,0x00000000,std::uint32_t>;
        ///DMA register for burst              accesses
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dmab{}; 
    }
    namespace Tim17Tim17Af1{    ///<TIM17 alternate function register          1
        using Addr = Register::Address<0x40014860,0xfffff0f8,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Tim17Tisel{    ///<TIM17 input selection register
        using Addr = Register::Address<0x40014868,0xfffffff0,0x00000000,std::uint32_t>;
