...
//General-purpose-timers
    namespace Tim16Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014400,0xfffff470,0x00000000,std::uint32_t>;
        ///Counter enable
    ...
    namespace Tim16Cr2{    ///<control register 2
        using Addr = Register::Address<0x40014404,0xfffffcf2,0x00000000,std::uint32_t>;
        ///Output Idle state 1
    ...
    namespace Tim16Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001440c,0xffffdc5c,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Sr{    ///<status register
        using Addr = Register::Address<0x40014410,0xfffffd5c,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Egr{    ///<event generation register
        using Addr = Register::Address<0x40014414,0xffffff5c,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim16Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40014420,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Cnt{    ///<counter
        using Addr = Register::Address<0x40014424,0x7fff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim16Rcr{    ///<repetition counter register
        using Addr = Register::Address<0x40014430,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40014444,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40014448,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim16Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4001444c,0xffff0000,0x00000000,std::uint32_t>;
        ///DMA register for burst              accesses
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dmab{}; 
    }
    namespace Tim16Tim16Af1{    ///<TIM16 alternate function register          1
        using Addr = Register::Address<0x40014460,0xfffff0f8,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Tim16Tisel{    ///<TIM16 input selection register
        using Addr = Register::Address<0x40014468,0xfffffff0,0x00000000,std::uint32_t>;
