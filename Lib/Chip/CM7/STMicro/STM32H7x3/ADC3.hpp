...
//Analog to Digital Converter
    namespace Adc3Isr{    ///<ADC interrupt and status          register
        using Addr = Register::Address<0x58026000,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ier{    ///<ADC interrupt enable register
        using Addr = Register::Address<0x58026004,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Cr{    ///<ADC control register
        using Addr = Register::Address<0x58026008,0x003efec0,0x00000000,std::uint32_t>;
        ///ADC calibration
    ...
    namespace Adc3Cfgr{    ///<ADC configuration register 1
        using Addr = Register::Address<0x5802600c,0x00008010,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Cfgr2{    ///<ADC configuration register 2
        using Addr = Register::Address<0x58026010,0x0c00801c,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Smpr1{    ///<ADC sampling time register 1
        using Addr = Register::Address<0x58026014,0xc0000007,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Smpr2{    ///<ADC sampling time register 2
        using Addr = Register::Address<0x58026018,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ltr1{    ///<ADC analog watchdog 1 threshold          register
        using Addr = Register::Address<0x58026020,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Lhtr1{    ///<ADC analog watchdog 2 threshold          register
        using Addr = Register::Address<0x58026024,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Sqr1{    ///<ADC group regular sequencer ranks register          1
        using Addr = Register::Address<0x58026030,0xe0820830,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Sqr2{    ///<ADC group regular sequencer ranks register          2
        using Addr = Register::Address<0x58026034,0xe0820820,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Sqr3{    ///<ADC group regular sequencer ranks register          3
        using Addr = Register::Address<0x58026038,0xe0820820,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Sqr4{    ///<ADC group regular sequencer ranks register          4
        using Addr = Register::Address<0x5802603c,0xfffff820,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Dr{    ///<ADC group regular conversion data          register
        using Addr = Register::Address<0x58026040,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Jsqr{    ///<ADC group injected sequencer          register
        using Addr = Register::Address<0x5802604c,0x04104000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ofr1{    ///<ADC offset number 1 register
        using Addr = Register::Address<0x58026060,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ofr2{    ///<ADC offset number 2 register
        using Addr = Register::Address<0x58026064,0x00000000,0x00000000,std::uint32_t>;
        ///ADC offset number 1 enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ssate{}; 
        ///ADC offset number 1 channel              selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,26),Register::ReadWriteAccess,unsigned> offset1Ch{}; 
    ...
    namespace Adc3Ofr3{    ///<ADC offset number 3 register
        using Addr = Register::Address<0x58026068,0x00000000,0x00000000,std::uint32_t>;
        ///ADC offset number 1 enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ssate{}; 
        ///ADC offset number 1 channel              selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,26),Register::ReadWriteAccess,unsigned> offset1Ch{}; 
    ...
    namespace Adc3Ofr4{    ///<ADC offset number 4 register
        using Addr = Register::Address<0x5802606c,0x00000000,0x00000000,std::uint32_t>;
        ///ADC offset number 1 enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ssate{}; 
        ///ADC offset number 1 channel              selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,26),Register::ReadWriteAccess,unsigned> offset1Ch{}; 
    ...
    namespace Adc3Jdr1{    ///<ADC group injected sequencer rank 1          register
        using Addr = Register::Address<0x58026080,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Jdr2{    ///<ADC group injected sequencer rank 2          register
        using Addr = Register::Address<0x58026084,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Jdr3{    ///<ADC group injected sequencer rank 3          register
        using Addr = Register::Address<0x58026088,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Jdr4{    ///<ADC group injected sequencer rank 4          register
        using Addr = Register::Address<0x5802608c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Awd2cr{    ///<ADC analog watchdog 2 configuration          register
        using Addr = Register::Address<0x580260a0,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Awd3cr{    ///<ADC analog watchdog 3 configuration          register
        using Addr = Register::Address<0x580260a4,0xffe00001,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Difsel{    ///<ADC channel differential or single-ended          mode selection register
        using Addr = Register::Address<0x580260c0,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Calfact{    ///<ADC calibration factors          register
        using Addr = Register::Address<0x580260c4,0xf800f800,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ccr{    ///<ADC common control register
        using Addr = Register::Address<0x58026008,0xfe00ffff,0x00000000,std::uint32_t>;
        ///ADC clock mode
    ...
    namespace Adc3Pcsel{    ///<ADC pre channel selection          register
        using Addr = Register::Address<0x5802601c,0xfff00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ltr2{    ///<ADC watchdog lower threshold register          2
        using Addr = Register::Address<0x580260b0,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Htr2{    ///<ADC watchdog higher threshold register          2
        using Addr = Register::Address<0x580260b4,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Ltr3{    ///<ADC watchdog lower threshold register          3
        using Addr = Register::Address<0x580260b8,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Htr3{    ///<ADC watchdog higher threshold register          3
        using Addr = Register::Address<0x580260bc,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Calfact2{    ///<ADC Calibration Factor register          2
        using Addr = Register::Address<0x580260c8,0xc0000000,0x00000000,std::uint32_t>;
