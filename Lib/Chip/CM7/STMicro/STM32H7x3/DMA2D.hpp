...
//DMA2D
    namespace Dma2dDma2dCr{    ///<DMA2D control register
        using Addr = Register::Address<0x52001000,0xfffcc0f8,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dIsr{    ///<DMA2D Interrupt Status          Register
        using Addr = Register::Address<0x52001004,0xffffffc0,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dIfcr{    ///<DMA2D interrupt flag clear          register
        using Addr = Register::Address<0x52001008,0xffffffc0,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dFgmar{    ///<DMA2D foreground memory address          register
        using Addr = Register::Address<0x5200100c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dFgor{    ///<DMA2D foreground offset          register
        using Addr = Register::Address<0x52001010,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dBgmar{    ///<DMA2D background memory address          register
        using Addr = Register::Address<0x52001014,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dBgor{    ///<DMA2D background offset          register
        using Addr = Register::Address<0x52001018,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dFgpfccr{    ///<DMA2D foreground PFC control          register
        using Addr = Register::Address<0x5200101c,0x00c000c0,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dFgcolr{    ///<DMA2D foreground color          register
        using Addr = Register::Address<0x52001020,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dBgpfccr{    ///<DMA2D background PFC control          register
        using Addr = Register::Address<0x52001024,0x00cc00c0,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dBgcolr{    ///<DMA2D background color          register
        using Addr = Register::Address<0x52001028,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dFgcmar{    ///<DMA2D foreground CLUT memory address          register
        using Addr = Register::Address<0x5200102c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dBgcmar{    ///<DMA2D background CLUT memory address          register
        using Addr = Register::Address<0x52001030,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dOpfccr{    ///<DMA2D output PFC control          register
        using Addr = Register::Address<0x52001034,0xffcffff8,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dOcolr{    ///<DMA2D output color register
        using Addr = Register::Address<0x52001038,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dOmar{    ///<DMA2D output memory address          register
        using Addr = Register::Address<0x5200103c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dOor{    ///<DMA2D output offset register
        using Addr = Register::Address<0x52001040,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dNlr{    ///<DMA2D number of line register
        using Addr = Register::Address<0x52001044,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dLwr{    ///<DMA2D line watermark register
        using Addr = Register::Address<0x52001048,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Dma2dDma2dAmtcr{    ///<DMA2D AXI master timer configuration          register
        using Addr = Register::Address<0x5200104c,0xffff00fe,0x00000000,std::uint32_t>;
