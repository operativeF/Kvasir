...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011004,0x00000086,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011008,0x00010000,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4001100c,0xffff0000,0x00000000,std::uint32_t>;
        ///DIV_Mantissa
    ...
    namespace Usart1Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40011010,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
    ...
    namespace Usart1Rtor{    ///<Receiver timeout register
        using Addr = Register::Address<0x40011014,0x00000000,0x00000000,std::uint32_t>;
        ///Block Length
    ...
    namespace Usart1Rqr{    ///<Request register
        using Addr = Register::Address<0x40011018,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001101c,0xf0000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40011020,0xffedc400,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40011024,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
    ...
    namespace Usart1Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40011028,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> tdr{}; 
    }
    namespace Usart1Presc{    ///<USART prescaler register
        using Addr = Register::Address<0x4001102c,0xfffffff0,0x00000000,std::uint32_t>;
        ///Clock prescaler
