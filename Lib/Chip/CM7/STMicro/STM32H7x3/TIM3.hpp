...
//General purpose timers
    namespace Tim3Cr1{    ///<control register 1
        using Addr = Register::Address<0x40000400,0xfffff400,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000408,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim3Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40000418,0xfefe0000,0x00000000,std::uint32_t>;
        ///CC1S
    ...
    namespace Tim3Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x4000041c,0xfefe0000,0x00000000,std::uint32_t>;
        ///Output Compare 2 mode - bit              3
    ...
    namespace Tim3Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40000460,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim3Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40000468,0xf0f0f0f0,0x00000000,std::uint32_t>;
