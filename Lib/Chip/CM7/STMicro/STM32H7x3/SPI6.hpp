...
//Serial peripheral interface
    namespace Spi6Cr1{    ///<control register 1
        using Addr = Register::Address<0x58001400,0xfffe00fe,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Cr2{    ///<control register 2
        using Addr = Register::Address<0x58001404,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Cfg1{    ///<configuration register 1
        using Addr = Register::Address<0x58001408,0x8fa02000,0x00000000,std::uint32_t>;
        ///Master baud rate
    ...
    namespace Spi6Cfg2{    ///<configuration register 2
        using Addr = Register::Address<0x5800140c,0x08017f00,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x58001410,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Sr{    ///<Status Register
        using Addr = Register::Address<0x58001414,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Ifcr{    ///<Interrupt/Status Flags Clear          Register
        using Addr = Register::Address<0x58001418,0xfffff007,0x00000000,std::uint32_t>;
        ///SUSPend flag clear
    ...
    namespace Spi6Txdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x58001420,0x00000000,0x00000000,std::uint32_t>;
        ///Transmit data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> txdr{}; 
    }
    namespace Spi6Rxdr{    ///<Receive Data Register
        using Addr = Register::Address<0x58001430,0x00000000,0x00000000,std::uint32_t>;
        ///Receive data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rxdr{}; 
    }
    namespace Spi6Crcpoly{    ///<Polynomial Register
        using Addr = Register::Address<0x58001440,0x00000000,0x00000000,std::uint32_t>;
        ///CRC polynomial register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> crcpoly{}; 
    }
    namespace Spi6Txcrc{    ///<Transmitter CRC Register
        using Addr = Register::Address<0x58001444,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Rxcrc{    ///<Receiver CRC Register
        using Addr = Register::Address<0x58001448,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Udrdr{    ///<Underrun Data Register
        using Addr = Register::Address<0x5800144c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Cgfr{    ///<configuration register
        using Addr = Register::Address<0x58001450,0xfc008040,0x00000000,std::uint32_t>;
