...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart2Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40004400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004404,0x00000086,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004408,0x00010000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000441c,0xf0000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40004420,0xffedc400,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Presc{    ///<USART prescaler register
        using Addr = Register::Address<0x4000442c,0xfffffff0,0x00000000,std::uint32_t>;
        ///Clock prescaler
