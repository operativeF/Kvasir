...
//USB 1 on the go high speed
    namespace Otg2HsGlobalOtgHsGotgctl{    ///<OTG_HS control and status          register
        using Addr = Register::Address<0x40080000,0xfff0e0fc,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGotgint{    ///<OTG_HS interrupt register
        using Addr = Register::Address<0x40080004,0xffe1fcfb,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGahbcfg{    ///<OTG_HS AHB configuration          register
        using Addr = Register::Address<0x40080008,0xfffffe40,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGusbcfg{    ///<OTG_HS USB configuration          register
        using Addr = Register::Address<0x4008000c,0x9c0140b8,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGrstctl{    ///<OTG_HS reset register
        using Addr = Register::Address<0x40080010,0x3ffff808,0x00000000,std::uint32_t>;
        ///Core soft reset
    ...
    namespace Otg2HsGlobalOtgHsGintsts{    ///<OTG_HS core interrupt register
        using Addr = Register::Address<0x40080014,0x08830300,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGintmsk{    ///<OTG_HS interrupt mask register
        using Addr = Register::Address<0x40080018,0x00030301,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> rstde{}; 
        ///LPM interrupt mask
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> lpmintm{}; 
    }
    namespace Otg2HsGlobalOtgHsGrxstsrHost{    ///<OTG_HS Receive status debug read register          (host mode)
        using Addr = Register::Address<0x4008001c,0xffe00000,0x00000000,std::uint32_t>;
        ///Channel number
    ...
    namespace Otg2HsGlobalOtgHsGrxstspHost{    ///<OTG_HS status read and pop register (host          mode)
        using Addr = Register::Address<0x40080020,0xffe00000,0x00000000,std::uint32_t>;
        ///Channel number
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> chnum{}; 
        ///Byte count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,4),Register::ReadWriteAccess,unsigned> bcnt{}; 
    ...
    namespace Otg2HsGlobalOtgHsGrxfsiz{    ///<OTG_HS Receive FIFO size          register
        using Addr = Register::Address<0x40080024,0xffff0000,0x00000000,std::uint32_t>;
        ///RxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> rxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsHnptxfsizHost{    ///<OTG_HS nonperiodic transmit FIFO size          register (host mode)
        using Addr = Register::Address<0x40080028,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsDieptxf0Device{    ///<Endpoint 0 transmit FIFO size (peripheral          mode)
        using Addr = Register::Address<0x40080028,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGnptxsts{    ///<OTG_HS nonperiodic transmit FIFO/queue          status register
        using Addr = Register::Address<0x4008002c,0x80000000,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsGccfg{    ///<OTG_HS general core configuration          register
        using Addr = Register::Address<0x40080038,0xffc0fff0,0x00000000,std::uint32_t>;
        ///Power down
    ...
    namespace Otg2HsGlobalOtgHsCid{    ///<OTG_HS core ID register
        using Addr = Register::Address<0x4008003c,0x00000000,0x00000000,std::uint32_t>;
        ///Product ID field
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> productId{}; 
    }
    namespace Otg2HsGlobalOtgHsHptxfsiz{    ///<OTG_HS Host periodic transmit FIFO size          register
        using Addr = Register::Address<0x40080100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsDieptxf1{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40080104,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Otg2HsGlobalOtgHsDieptxf2{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40080108,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsDieptxf3{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x4008011c,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsDieptxf4{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40080120,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsDieptxf5{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40080124,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsDieptxf6{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x40080128,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsDieptxf7{    ///<OTG_HS device IN endpoint transmit FIFO size          register
        using Addr = Register::Address<0x4008012c,0x00000000,0x00000000,std::uint32_t>;
        ///IN endpoint FIFOx transmit RAM start              address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ineptxsa{}; 
        ///IN endpoint TxFIFO depth
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ineptxfd{}; 
    }
    namespace Otg2HsGlobalOtgHsGrxstsrDevice{    ///<OTG_HS Receive status debug read register          (peripheral mode mode)
        using Addr = Register::Address<0x4008001c,0xfe000000,0x00000000,std::uint32_t>;
        ///Endpoint number
    ...
    namespace Otg2HsGlobalOtgHsGrxstspDevice{    ///<OTG_HS status read and pop register          (peripheral mode)
        using Addr = Register::Address<0x40080020,0xfe000000,0x00000000,std::uint32_t>;
        ///Endpoint number
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> epnum{}; 
        ///Byte count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,4),Register::ReadWriteAccess,unsigned> bcnt{}; 
    ...
    namespace Otg2HsGlobalOtgHsGlpmcfg{    ///<OTG core LPM configuration          register
        using Addr = Register::Address<0x40080054,0xe0000000,0x00000000,std::uint32_t>;
        ///LPM support enable
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,2),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> besl{}; 
        ///bRemoteWake value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> remwake{}; 
