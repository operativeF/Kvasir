...
namespace Kvasir {
//DELAY_Block_SDMMC1
    namespace DelayBlockQuadspiCr{    ///<DLYB control register
        using Addr = Register::Address<0x52006000,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace DelayBlockQuadspiCfgr{    ///<DLYB configuration register
        using Addr = Register::Address<0x52006004,0x700080f0,0x00000000,std::uint32_t>;
