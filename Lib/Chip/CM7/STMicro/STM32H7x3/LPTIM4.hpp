...
namespace Kvasir {
//Low power timer
    namespace Lptim4Isr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x58002c00,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim4Icr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x58002c04,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim4Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x58002c08,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim4Cfgr{    ///<Configuration Register
        using Addr = Register::Address<0x58002c0c,0xfe011120,0x00000000,std::uint32_t>;
        ///Encoder mode enable
    ...
    namespace Lptim4Cr{    ///<Control Register
        using Addr = Register::Address<0x58002c10,0xffffffe0,0x00000000,std::uint32_t>;
        ///LPTIM Enable
    ...
    namespace Lptim4Cmp{    ///<Compare Register
        using Addr = Register::Address<0x58002c14,0xffff0000,0x00000000,std::uint32_t>;
        ///Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cmp{}; 
    }
    namespace Lptim4Arr{    ///<Autoreload Register
        using Addr = Register::Address<0x58002c18,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto reload value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> arr{}; 
    }
    namespace Lptim4Cnt{    ///<Counter Register
        using Addr = Register::Address<0x58002c1c,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Lptim4LptimCfgr2{    ///<LPTIM configuration register 2
        using Addr = Register::Address<0x58002c24,0xfffffffc,0x00000000,std::uint32_t>;
