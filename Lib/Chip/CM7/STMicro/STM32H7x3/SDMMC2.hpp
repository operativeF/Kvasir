...
namespace Kvasir {
//SDMMC1
    namespace Sdmmc2SdmmcPower{    ///<SDMMC power control register
        using Addr = Register::Address<0x48022400,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcClkcr{    ///<The SDMMC_CLKCR register controls the          SDMMC_CK output clock, the SDMMC_RX_CLK receive clock,          and the bus width.
        using Addr = Register::Address<0x48022404,0xffc02c00,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcArgr{    ///<The SDMMC_ARGR register contains a 32-bit          command argument, which is sent to a card as part of a          command message.
        using Addr = Register::Address<0x48022408,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcCmdr{    ///<The SDMMC_CMDR register contains the command          index and command type bits. The command index is sent to          a card as part of a command message. The command type          bits control the command path state machine          (CPSM).
        using Addr = Register::Address<0x4802240c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcResp1r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x48022414,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 432
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus1{}; 
    }
    namespace Sdmmc2SdmmcResp2r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x48022418,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus2{}; 
    }
    namespace Sdmmc2SdmmcResp3r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x4802241c,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus3{}; 
    }
    namespace Sdmmc2SdmmcResp4r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x48022420,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus4{}; 
    }
    namespace Sdmmc2SdmmcDtimer{    ///<The SDMMC_DTIMER register contains the data          timeout period, in card bus clock periods. A counter          loads the value from the SDMMC_DTIMER register, and          starts decrementing when the data path state machine          (DPSM) enters the Wait_R or Busy state. If the timer          reaches 0 while the DPSM is in either of these states,          the timeout status flag is set.
        using Addr = Register::Address<0x48022424,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcDlenr{    ///<The SDMMC_DLENR register contains the number          of data bytes to be transferred. The value is loaded into          the data counter when data transfer starts.
        using Addr = Register::Address<0x48022428,0xfe000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcDctrl{    ///<The SDMMC_DCTRL register control the data          path state machine (DPSM).
        using Addr = Register::Address<0x4802242c,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcDcntr{    ///<The SDMMC_DCNTR register loads the value          from the data length register (see SDMMC_DLENR) when the          DPSM moves from the Idle state to the Wait_R or Wait_S          state. As data is transferred, the counter decrements the          value until it reaches 0. The DPSM then moves to the Idle          state and when there has been no error, the data status          end flag (DATAEND) is set.
        using Addr = Register::Address<0x48022430,0xfe000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcStar{    ///<The SDMMC_STAR register is a read-only          register. It contains two types of flag:Static flags          (bits [29,21,11:0]): these bits remain asserted until          they are cleared by writing to the SDMMC interrupt Clear          register (see SDMMC_ICR)Dynamic flags (bits [20:12]):          these bits change state depending on the state of the          underlying logic (for example, FIFO full and empty flags          are asserted and de-asserted as data while written to the          FIFO)
        using Addr = Register::Address<0x48022434,0xe0000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcIcr{    ///<The SDMMC_ICR register is a write-only          register. Writing a bit with 1 clears the corresponding          bit in the SDMMC_STAR status register.
        using Addr = Register::Address<0x48022438,0xe01ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcMaskr{    ///<The interrupt mask register determines which          status flags generate an interrupt request by setting the          corresponding bit to 1.
        using Addr = Register::Address<0x4802243c,0xe8193000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcAcktimer{    ///<The SDMMC_ACKTIMER register contains the          acknowledgment timeout period, in SDMMC_CK bus clock          periods. A counter loads the value from the          SDMMC_ACKTIMER register, and starts decrementing when the          data path state machine (DPSM) enters the Wait_Ack state.          If the timer reaches 0 while the DPSM is in this states,          the acknowledgment timeout status flag is          set.
        using Addr = Register::Address<0x48022440,0xfe000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcIdmactrlr{    ///<The receive and transmit FIFOs can be read          or written as 32-bit wide registers. The FIFOs contain 32          entries on 32 sequential addresses. This allows the CPU          to use its load and store multiple operands to read          from/write to the FIFO.
        using Addr = Register::Address<0x48022450,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcIdmabsizer{    ///<The SDMMC_IDMABSIZER register contains the          buffers size when in double buffer          configuration.
        using Addr = Register::Address<0x48022454,0xffffe01f,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcIdmabase0r{    ///<The SDMMC_IDMABASE0R register contains the          memory buffer base address in single buffer configuration          and the buffer 0 base address in double buffer          configuration.
        using Addr = Register::Address<0x48022458,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcIdmabase1r{    ///<The SDMMC_IDMABASE1R register contains the          double buffer configuration second buffer memory base          address.
        using Addr = Register::Address<0x4802245c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcFifor{    ///<The receive and transmit FIFOs can be only          read or written as word (32-bit) wide registers. The          FIFOs contain 16 entries on sequential addresses. This          allows the CPU to use its load and store multiple          operands to read from/write to the FIFO.When accessing          SDMMC_FIFOR with half word or byte access an AHB bus          fault is generated.
        using Addr = Register::Address<0x48022480,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcVer{    ///<SDMMC IP version register
        using Addr = Register::Address<0x480227f4,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcId{    ///<SDMMC IP identification          register
        using Addr = Register::Address<0x480227f8,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc2SdmmcRespcmdr{    ///<SDMMC command response          register
        using Addr = Register::Address<0x48022410,0xffffffc0,0x00000000,std::uint32_t>;
