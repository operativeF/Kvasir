...
//Advanced-timers
    namespace Tim8Cr1{    ///<control register 1
        using Addr = Register::Address<0x40010400,0xfffff400,0x00000000,std::uint32_t>;
        ///Counter enable
    ...
    namespace Tim8Cr2{    ///<control register 2
        using Addr = Register::Address<0x40010404,0xff0a8002,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40010408,0xffce0008,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,unsigned> ts43{}; 
    }
    namespace Tim8Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001040c,0xffff8000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Sr{    ///<status register
        using Addr = Register::Address<0x40010410,0xfffcc000,0x00000000,std::uint32_t>;
        ///Compare 6 interrupt flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> cc6if{}; 
        ///Compare 5 interrupt flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> cc5if{}; 
        ///System Break interrupt              flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> sbif{}; 
    ...
    namespace Tim8Egr{    ///<event generation register
        using Addr = Register::Address<0x40010414,0xfffffe00,0x00000000,std::uint32_t>;
        ///Update generation
    ...
    namespace Tim8Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40010418,0xfefe0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40010418,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x4001041c,0xfefe0000,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> oc4m4{}; 
    }
    namespace Tim8Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x4001041c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40010420,0xffcc4000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Cnt{    ///<counter
        using Addr = Register::Address<0x40010424,0x7fff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim8Psc{    ///<prescaler
        using Addr = Register::Address<0x40010428,0xffff0000,0x00000000,std::uint32_t>;
        ///Prescaler value
    ...
    namespace Tim8Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4001042c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim8Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40010434,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40010438,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4001043c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40010440,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare value
    ...
    namespace Tim8Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40010448,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim8Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4001044c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Rcr{    ///<repetition counter register
        using Addr = Register::Address<0x40010430,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40010444,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccmr3Output{    ///<capture/compare mode register 3 (output          mode)
        using Addr = Register::Address<0x40010454,0xfefe0303,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccr5{    ///<capture/compare register 5
        using Addr = Register::Address<0x40010458,0x1fff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Crr6{    ///<capture/compare register 6
        using Addr = Register::Address<0x4001045c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Af1{    ///<TIM1 alternate function option register          1
        using Addr = Register::Address<0x40010460,0xfffc30f8,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> bkdf1bk0e{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim8Af2{    ///<TIM1 Alternate function odfsdm1_breakster          2
        using Addr = Register::Address<0x40010464,0xfffff0f8,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> bk2df1bk1e{}; 
    ...
    namespace Tim8Tisel{    ///<TIM1 timer input selection          register
        using Addr = Register::Address<0x40010468,0xf0f0f0f0,0x00000000,std::uint32_t>;
        ///selects TI1[0] to TI1[15]              input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ti1sel{}; 
        ///selects TI2[0] to TI2[15]              input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> ti2sel{}; 
        ///selects TI3[0] to TI3[15]              input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> ti3sel{}; 
        ///selects TI4[0] to TI4[15]              input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,24),Register::ReadWriteAccess,unsigned> ti4sel{}; 
    }
}
