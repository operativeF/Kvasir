...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart4Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40004c00,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Uart4Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004c04,0x00000086,0x00000000,std::uint32_t>;
    ...
    namespace Uart4Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004c08,0x00010000,0x00000000,std::uint32_t>;
    ...
    namespace Uart4Brr{    ///<Baud rate register
    ...
    namespace Uart4Gtpr{    ///<Guard time and prescaler          register
    ...
    namespace Uart4Rtor{    ///<Receiver timeout register
    ...
    namespace Uart4Rqr{    ///<Request register
    ...
    namespace Uart4Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x40004c1c,0xf0000000,0x00000000,std::uint32_t>;
    ...
    namespace Uart4Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40004c20,0xffedc400,0x00000000,std::uint32_t>;
    ...
    namespace Uart4Rdr{    ///<Receive data register
    ...
    namespace Uart4Tdr{    ///<Transmit data register
    ...
    namespace Uart4Presc{    ///<USART prescaler register
        using Addr = Register::Address<0x40004c2c,0xfffffff0,0x00000000,std::uint32_t>;
        ///Clock prescaler
