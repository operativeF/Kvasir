...
//General purpose timers
    namespace Tim12Cr1{    ///<control register 1
        using Addr = Register::Address<0x40001800,0xfffff400,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Cr2{    ///<control register 2
        using Addr = Register::Address<0x40001804,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim12Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40001808,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim12Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000180c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Sr{    ///<status register
        using Addr = Register::Address<0x40001810,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Egr{    ///<event generation register
        using Addr = Register::Address<0x40001814,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim12Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40001818,0xfefe0000,0x00000000,std::uint32_t>;
        ///CC1S
    ...
    namespace Tim12Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40001818,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x4000181c,0xfefe0000,0x00000000,std::uint32_t>;
        ///Output Compare 2 mode - bit              3
    ...
    namespace Tim12Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x4000181c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40001820,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Cnt{    ///<counter
        using Addr = Register::Address<0x40001824,0x00000000,0x00000000,std::uint32_t>;
        ///low counter value
    ...
    namespace Tim12Psc{    ///<prescaler
        using Addr = Register::Address<0x40001828,0xffff0000,0x00000000,std::uint32_t>;
        ///Prescaler value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> psc{}; 
    }
    namespace Tim12Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4000182c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40001834,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40001838,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4000183c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim12Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40001840,0x00000000,0x00000000,std::uint32_t>;
        ///High Capture/Compare value
    ...
    namespace Tim12Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40001848,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim12Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4000184c,0xffff0000,0x00000000,std::uint32_t>;
        ///DMA register for burst              accesses
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dmab{}; 
    }
    namespace Tim12Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40001860,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim12Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40001868,0xf0f0f0f0,0x00000000,std::uint32_t>;
