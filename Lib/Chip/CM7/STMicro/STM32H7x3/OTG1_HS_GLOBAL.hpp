...
//USB 1 on the go high speed
    namespace Otg1HsGlobalOtgHsGotgctl{    ///<OTG_HS control and status          register
        using Addr = Register::Address<0x40040000,0xfff0e0fc,0x00000000,std::uint32_t>;
    ...
    namespace Otg1HsGlobalOtgHsGotgint{    ///<OTG_HS interrupt register
        using Addr = Register::Address<0x40040004,0xffe1fcfb,0x00000000,std::uint32_t>;
    ...
    namespace Otg1HsGlobalOtgHsGahbcfg{    ///<OTG_HS AHB configuration          register
    ...
    namespace Otg1HsGlobalOtgHsGusbcfg{    ///<OTG_HS USB configuration          register
        using Addr = Register::Address<0x4004000c,0x9c0140b8,0x00000000,std::uint32_t>;
    ...
    namespace Otg1HsGlobalOtgHsGrstctl{    ///<OTG_HS reset register
    ...
    namespace Otg1HsGlobalOtgHsGintsts{    ///<OTG_HS core interrupt register
    ...
    namespace Otg1HsGlobalOtgHsGintmsk{    ///<OTG_HS interrupt mask register
        using Addr = Register::Address<0x40040018,0x00030301,0x00000000,std::uint32_t>;
    ...
    namespace Otg1HsGlobalOtgHsGrxstsrHost{    ///<OTG_HS Receive status debug read register          (host mode)
    ...
    namespace Otg1HsGlobalOtgHsGrxstspHost{    ///<OTG_HS status read and pop register (host          mode)
    ...
    namespace Otg1HsGlobalOtgHsGrxfsiz{    ///<OTG_HS Receive FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsHnptxfsizHost{    ///<OTG_HS nonperiodic transmit FIFO size          register (host mode)
    ...
    namespace Otg1HsGlobalOtgHsDieptxf0Device{    ///<Endpoint 0 transmit FIFO size (peripheral          mode)
        using Addr = Register::Address<0x40040028,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Otg1HsGlobalOtgHsGnptxsts{    ///<OTG_HS nonperiodic transmit FIFO/queue          status register
    ...
    namespace Otg1HsGlobalOtgHsGccfg{    ///<OTG_HS general core configuration          register
        using Addr = Register::Address<0x40040038,0xffc0fff0,0x00000000,std::uint32_t>;
        ///Power down
    ...
    namespace Otg1HsGlobalOtgHsCid{    ///<OTG_HS core ID register
    ...
    namespace Otg1HsGlobalOtgHsHptxfsiz{    ///<OTG_HS Host periodic transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf1{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf2{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf3{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf4{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf5{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf6{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsDieptxf7{    ///<OTG_HS device IN endpoint transmit FIFO size          register
    ...
    namespace Otg1HsGlobalOtgHsGrxstsrDevice{    ///<OTG_HS Receive status debug read register          (peripheral mode mode)
    ...
    namespace Otg1HsGlobalOtgHsGrxstspDevice{    ///<OTG_HS status read and pop register          (peripheral mode)
    ...
    namespace Otg1HsGlobalOtgHsGlpmcfg{    ///<OTG core LPM configuration          register
        using Addr = Register::Address<0x40040054,0xe0000000,0x00000000,std::uint32_t>;
        ///LPM support enable
