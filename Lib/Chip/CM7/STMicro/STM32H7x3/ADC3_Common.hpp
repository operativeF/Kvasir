...
//Analog-to-Digital Converter
    namespace Adc3CommonCsr{    ///<ADC Common status register
        using Addr = Register::Address<0x58026300,0xf800f800,0x00000000,std::uint32_t>;
        ///Master ADC ready
    ...
    namespace Adc3CommonCcr{    ///<ADC common control register
        using Addr = Register::Address<0x58026308,0xfe0030e0,0x00000000,std::uint32_t>;
    ...
    namespace Adc3CommonCdr{    ///<ADC common regular data register for dual          and triple modes
        using Addr = Register::Address<0x5802630c,0x00000000,0x00000000,std::uint32_t>;
