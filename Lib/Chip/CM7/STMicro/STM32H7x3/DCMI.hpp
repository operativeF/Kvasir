...
//Digital camera interface
    namespace DcmiCr{    ///<control register 1
        using Addr = Register::Address<0x48020000,0xffe0b000,0x00000000,std::uint32_t>;
    ...
    namespace DcmiSr{    ///<status register
        using Addr = Register::Address<0x48020004,0xfffffff8,0x00000000,std::uint32_t>;
        ///FIFO not empty
    ...
    namespace DcmiRis{    ///<raw interrupt status register
        using Addr = Register::Address<0x48020008,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace DcmiIer{    ///<interrupt enable register
        using Addr = Register::Address<0x4802000c,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace DcmiMis{    ///<masked interrupt status          register
        using Addr = Register::Address<0x48020010,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace DcmiIcr{    ///<interrupt clear register
        using Addr = Register::Address<0x48020014,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace DcmiEscr{    ///<embedded synchronization code          register
        using Addr = Register::Address<0x48020018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace DcmiEsur{    ///<embedded synchronization unmask          register
        using Addr = Register::Address<0x4802001c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace DcmiCwstrt{    ///<crop window start
        using Addr = Register::Address<0x48020020,0xe000c000,0x00000000,std::uint32_t>;
    ...
    namespace DcmiCwsize{    ///<crop window size
        using Addr = Register::Address<0x48020024,0xc000c000,0x00000000,std::uint32_t>;
        ///Vertical line count
    ...
    namespace DcmiDr{    ///<data register
        using Addr = Register::Address<0x48020028,0x00000000,0x00000000,std::uint32_t>;
        ///Data byte 3
