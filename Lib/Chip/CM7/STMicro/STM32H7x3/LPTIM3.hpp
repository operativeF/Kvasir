...
namespace Kvasir {
//Low power timer
    namespace Lptim3Isr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x58002800,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim3Icr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x58002804,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim3Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x58002808,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim3Cfgr{    ///<Configuration Register
        using Addr = Register::Address<0x5800280c,0xfe011120,0x00000000,std::uint32_t>;
        ///Encoder mode enable
    ...
    namespace Lptim3Cr{    ///<Control Register
        using Addr = Register::Address<0x58002810,0xffffffe0,0x00000000,std::uint32_t>;
        ///LPTIM Enable
    ...
    namespace Lptim3Cmp{    ///<Compare Register
        using Addr = Register::Address<0x58002814,0xffff0000,0x00000000,std::uint32_t>;
        ///Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cmp{}; 
    }
    namespace Lptim3Arr{    ///<Autoreload Register
        using Addr = Register::Address<0x58002818,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto reload value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> arr{}; 
    }
    namespace Lptim3Cnt{    ///<Counter Register
        using Addr = Register::Address<0x5800281c,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Lptim3LptimCfgr2{    ///<LPTIM configuration register 2
        using Addr = Register::Address<0x58002824,0xfffffffc,0x00000000,std::uint32_t>;
