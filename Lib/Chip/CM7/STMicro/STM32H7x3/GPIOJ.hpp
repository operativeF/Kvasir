...
namespace Kvasir {
//GPIO
    namespace GpiojGpioaModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x58022400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x58022404,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x58022408,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x5802240c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x58022410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x58022414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x58022418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaLckr{    ///<This register is used to lock the          configuration of the port bits when a correct write          sequence is applied to bit 16 (LCKK). The value of bits          [15:0] is used to lock the configuration of the GPIO.          During the write sequence, the value of LCKR[15:0] must          not change. When the LOCK sequence has been applied on a          port bit, the value of this port bit can no longer be          modified until the next MCU reset or peripheral reset.A          specific write sequence is used to write to the          GPIOx_LCKR register. Only word access (32-bit long) is          allowed during this locking sequence.Each lock bit          freezes a specific configuration register (control and          alternate function registers).
        using Addr = Register::Address<0x5802241c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x58022420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiojGpioaAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x58022424,0x00000000,0x00000000,std::uint32_t>;
