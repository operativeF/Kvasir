...
namespace Kvasir {
//GPIO
    namespace GpiodGpioaModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x58020c00,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x58020c04,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x58020c08,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x58020c0c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x58020c10,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x58020c14,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x58020c18,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaLckr{    ///<This register is used to lock the          configuration of the port bits when a correct write          sequence is applied to bit 16 (LCKK). The value of bits          [15:0] is used to lock the configuration of the GPIO.          During the write sequence, the value of LCKR[15:0] must          not change. When the LOCK sequence has been applied on a          port bit, the value of this port bit can no longer be          modified until the next MCU reset or peripheral reset.A          specific write sequence is used to write to the          GPIOx_LCKR register. Only word access (32-bit long) is          allowed during this locking sequence.Each lock bit          freezes a specific configuration register (control and          alternate function registers).
        using Addr = Register::Address<0x58020c1c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x58020c20,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodGpioaAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x58020c24,0x00000000,0x00000000,std::uint32_t>;
