...
//General purpose timers
    ...
    namespace Tim2Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000008,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim2Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40000060,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim2Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40000068,0xf0f0f0f0,0x00000000,std::uint32_t>;
