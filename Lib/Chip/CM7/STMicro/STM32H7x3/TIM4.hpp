...
//General purpose timers
    namespace Tim4Cr1{    ///<control register 1
        using Addr = Register::Address<0x40000800,0xfffff400,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000808,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim4Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40000818,0xfefe0000,0x00000000,std::uint32_t>;
        ///CC1S
    ...
    namespace Tim4Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x4000081c,0xfefe0000,0x00000000,std::uint32_t>;
        ///Output Compare 2 mode - bit              3
    ...
    namespace Tim4Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40000820,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Cnt{    ///<counter
        using Addr = Register::Address<0x40000824,0x00000000,0x00000000,std::uint32_t>;
        ///low counter value
    ...
    namespace Tim4Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000834,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40000838,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4000083c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40000840,0x00000000,0x00000000,std::uint32_t>;
        ///High Capture/Compare value
    ...
    namespace Tim4Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40000860,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim4Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40000868,0xf0f0f0f0,0x00000000,std::uint32_t>;
