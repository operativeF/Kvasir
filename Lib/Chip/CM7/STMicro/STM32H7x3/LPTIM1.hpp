...
//Low power timer
    ...
    namespace Lptim1Icr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x40002404,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40002408,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim1Cfgr{    ///<Configuration Register
        using Addr = Register::Address<0x4000240c,0xfe011120,0x00000000,std::uint32_t>;
        ///Encoder mode enable
    ...
    namespace Lptim1Cr{    ///<Control Register
        using Addr = Register::Address<0x40002410,0xffffffe0,0x00000000,std::uint32_t>;
        ///LPTIM Enable
    ...
    namespace Lptim1Cmp{    ///<Compare Register
        using Addr = Register::Address<0x40002414,0xffff0000,0x00000000,std::uint32_t>;
        ///Compare value
    ...
    namespace Lptim1Arr{    ///<Autoreload Register
        using Addr = Register::Address<0x40002418,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto reload value
    ...
    namespace Lptim1Cnt{    ///<Counter Register
        using Addr = Register::Address<0x4000241c,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Lptim1LptimCfgr2{    ///<LPTIM configuration register 2
        using Addr = Register::Address<0x40002424,0xffffffcc,0x00000000,std::uint32_t>;
