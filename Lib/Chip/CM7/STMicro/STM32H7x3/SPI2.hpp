...
//Serial peripheral interface
    namespace Spi2Cr1{    ///<control register 1
        using Addr = Register::Address<0x40003800,0xfffe00fe,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Cr2{    ///<control register 2
        using Addr = Register::Address<0x40003804,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Cfg1{    ///<configuration register 1
        using Addr = Register::Address<0x40003808,0x8fa02000,0x00000000,std::uint32_t>;
        ///Master baud rate
    ...
    namespace Spi2Cfg2{    ///<configuration register 2
        using Addr = Register::Address<0x4000380c,0x08017f00,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40003810,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Ifcr{    ///<Interrupt/Status Flags Clear          Register
        using Addr = Register::Address<0x40003818,0xfffff007,0x00000000,std::uint32_t>;
        ///SUSPend flag clear
    ...
    namespace Spi2Txdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40003820,0x00000000,0x00000000,std::uint32_t>;
        ///Transmit data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> txdr{}; 
    }
    namespace Spi2Rxdr{    ///<Receive Data Register
    ...
    namespace Spi2Crcpoly{    ///<Polynomial Register
        using Addr = Register::Address<0x40003840,0x00000000,0x00000000,std::uint32_t>;
        ///CRC polynomial register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> crcpoly{}; 
    }
    namespace Spi2Txcrc{    ///<Transmitter CRC Register
        using Addr = Register::Address<0x40003844,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Rxcrc{    ///<Receiver CRC Register
        using Addr = Register::Address<0x40003848,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Udrdr{    ///<Underrun Data Register
        using Addr = Register::Address<0x4000384c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi2Cgfr{    ///<configuration register
        using Addr = Register::Address<0x40003850,0xfc008040,0x00000000,std::uint32_t>;
