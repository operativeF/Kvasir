...
//Analog-to-Digital Converter
    namespace Adc12CommonCsr{    ///<ADC Common status register
        using Addr = Register::Address<0x40022300,0xf800f800,0x00000000,std::uint32_t>;
        ///Master ADC ready
    ...
    namespace Adc12CommonCcr{    ///<ADC common control register
        using Addr = Register::Address<0x40022308,0xfe0030e0,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> damdf{}; 
        ///ADC clock mode
    ...
    namespace Adc12CommonCdr{    ///<ADC common regular data register for dual          and triple modes
        using Addr = Register::Address<0x4002230c,0x00000000,0x00000000,std::uint32_t>;
