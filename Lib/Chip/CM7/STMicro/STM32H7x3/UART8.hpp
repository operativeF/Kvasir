...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart8Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40007c00,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40007c04,0x00000086,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007c08,0x00010000,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40007c0c,0xffff0000,0x00000000,std::uint32_t>;
        ///DIV_Mantissa
    ...
    namespace Uart8Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40007c10,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
    ...
    namespace Uart8Rtor{    ///<Receiver timeout register
    ...
    namespace Uart8Rqr{    ///<Request register
        using Addr = Register::Address<0x40007c18,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x40007c1c,0xf0000000,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40007c20,0xffedc400,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40007c24,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rdr{}; 
    }
    namespace Uart8Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40007c28,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> tdr{}; 
    }
    namespace Uart8Presc{    ///<USART prescaler register
        using Addr = Register::Address<0x40007c2c,0xfffffff0,0x00000000,std::uint32_t>;
        ///Clock prescaler
