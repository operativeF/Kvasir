...
//General purpose timers
    namespace Tim13Cr1{    ///<control register 1
        using Addr = Register::Address<0x40001c00,0xfffff400,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Cr2{    ///<control register 2
        using Addr = Register::Address<0x40001c04,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim13Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40001c08,0xffce0008,0x00000000,std::uint32_t>;
        ///Trigger selection
    ...
    namespace Tim13Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x40001c0c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Sr{    ///<status register
        using Addr = Register::Address<0x40001c10,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Egr{    ///<event generation register
        using Addr = Register::Address<0x40001c14,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim13Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40001c18,0xfefe0000,0x00000000,std::uint32_t>;
        ///CC1S
    ...
    namespace Tim13Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40001c18,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x40001c1c,0xfefe0000,0x00000000,std::uint32_t>;
        ///Output Compare 2 mode - bit              3
    ...
    namespace Tim13Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x40001c1c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40001c20,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Cnt{    ///<counter
        using Addr = Register::Address<0x40001c24,0x00000000,0x00000000,std::uint32_t>;
        ///low counter value
    ...
    namespace Tim13Arr{    ///<auto-reload register
        using Addr = Register::Address<0x40001c2c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40001c34,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40001c38,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x40001c3c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40001c40,0x00000000,0x00000000,std::uint32_t>;
        ///High Capture/Compare value
    ...
    namespace Tim13Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40001c48,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim13Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40001c4c,0xffff0000,0x00000000,std::uint32_t>;
        ///DMA register for burst              accesses
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dmab{}; 
    }
    namespace Tim13Af1{    ///<TIM alternate function option register          1
        using Addr = Register::Address<0x40001c60,0xfffc3fff,0x00000000,std::uint32_t>;
        ///ETR source selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Tim13Tisel{    ///<TIM timer input selection          register
        using Addr = Register::Address<0x40001c68,0xf0f0f0f0,0x00000000,std::uint32_t>;
