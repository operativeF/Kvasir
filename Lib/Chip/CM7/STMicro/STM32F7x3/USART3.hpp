...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart3Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40004800,0xe0000002,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart3Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004804,0x0000008f,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004808,0xfef10000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000481c,0xfdd82000,0x00000000,std::uint32_t>;
        ///TEACK
    ...
    namespace Usart3Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40004820,0xfffde420,0x00000000,std::uint32_t>;
