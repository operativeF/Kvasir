...
//General purpose timers
    ...
    namespace Tim2Or{    ///<TIM2 option register 1
        using Addr = Register::Address<0x40000050,0xfffff3ff,0x00000000,std::uint32_t>;
        ///Internal trigger 1 remap
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,unsigned> itr1Rmp{}; 
    }
}
