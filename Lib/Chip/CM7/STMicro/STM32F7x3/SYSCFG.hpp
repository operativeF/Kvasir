...
//System configuration controller
    namespace SyscfgMemrmp{    ///<memory remap register
        using Addr = Register::Address<0x40013800,0xfffff3fe,0x00000000,std::uint32_t>;
        ///Memory boot mapping
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> memBoot{}; 
    ...
    namespace SyscfgPmc{    ///<peripheral mode configuration          register
        using Addr = Register::Address<0x40013804,0xfff8ff08,0x00000000,std::uint32_t>;
        ...
        ///ADC3DC2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,16),Register::ReadWriteAccess,unsigned> adcdc2{}; 
        ///PB6_FMP Fast Mode
