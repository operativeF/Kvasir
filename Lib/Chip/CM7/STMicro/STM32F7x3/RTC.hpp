...
//Real-time clock
    ...
    namespace RtcCr{    ///<control register
        using Addr = Register::Address<0x40002808,0xfe000080,0x00000000,std::uint32_t>;
    ...
    namespace RtcIsr{    ///<initialization and status          register
        using Addr = Register::Address<0x4000280c,0xfffc0000,0x00000000,std::uint32_t>;
        ///Alarm A write flag
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> itsf{}; 
    }
    ...
    namespace RtcTampcr{    ///<tamper configuration register
        using Addr = Register::Address<0x40002840,0xfe000000,0x00000000,std::uint32_t>;
    ...
    namespace RtcOr{    ///<option register
        using Addr = Register::Address<0x4000284c,0xfffffff5,0x00000000,std::uint32_t>;
        ///RTC_ALARM on PC13 output              type
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> rtcAlarmType{}; 
        ///TIMESTAMP mapping
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> tsinsel{}; 
    }
