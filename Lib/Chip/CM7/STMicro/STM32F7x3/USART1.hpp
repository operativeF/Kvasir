...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011000,0xe0000002,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart1Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011004,0x0000008f,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011008,0xfef10000,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001101c,0xfdd82000,0x00000000,std::uint32_t>;
        ///TEACK
    ...
    namespace Usart1Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40011020,0xfffde420,0x00000000,std::uint32_t>;
