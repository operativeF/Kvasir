...
//General-purpose-timers
    namespace Tim14Cr1{    ///<control register 1
        using Addr = Register::Address<0x40002000,0xfffffc70,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim14Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40002018,0xfffeff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim14Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40002008,0x00000000,0x00000000,std::uint32_t>;
        ///Res.
    ...
    namespace Tim14Or{    ///<option register
        using Addr = Register::Address<0x40002050,0xfffffffc,0x00000000,std::uint32_t>;
