...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart5Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40005000,0xe0000002,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Uart5Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40005008,0xfef10000,0x00000000,std::uint32_t>;
    ...
    namespace Uart5Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000501c,0xfdd82000,0x00000000,std::uint32_t>;
        ///TEACK
    ...
    namespace Uart5Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40005020,0xfffde420,0x00000000,std::uint32_t>;
