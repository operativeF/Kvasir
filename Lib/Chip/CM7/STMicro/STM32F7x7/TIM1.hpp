...
//Advanced-timers
    namespace Tim1Cr1{    ///<control register 1
        using Addr = Register::Address<0x40010000,0xfffffc00,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim1Cr2{    ///<control register 2
        using Addr = Register::Address<0x40010004,0xffff8002,0x00000000,std::uint32_t>;
        ///Output Idle state 4
    ...
    namespace Tim1Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40010008,0xffff0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Sr{    ///<status register
        using Addr = Register::Address<0x40010010,0xffffe100,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Egr{    ///<event generation register
        using Addr = Register::Address<0x40010014,0xffffff00,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim1Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40010020,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Cnt{    ///<counter
        using Addr = Register::Address<0x40010024,0xffff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim1Af1{    ///<alternate function option register          1
        using Addr = Register::Address<0x40010060,0xfffffcfe,0x00000000,std::uint32_t>;
    ...
    namespace Tim1Af2{    ///<alternate function option register          2
        using Addr = Register::Address<0x40010064,0xfffffcfe,0x00000000,std::uint32_t>;
