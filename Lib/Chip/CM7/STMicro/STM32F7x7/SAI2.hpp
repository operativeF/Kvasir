...
//Serial audio interface
    namespace Sai2Bcr1{    ///<BConfiguration register 1
        using Addr = Register::Address<0x40015c24,0xff04c010,0x00000000,std::uint32_t>;
    ...
    namespace Sai2Bcr2{    ///<BConfiguration register 2
    ...
    namespace Sai2Bslotr{    ///<BSlot register
    ...
    namespace Sai2Bim{    ///<BInterrupt mask register2
    ...
    namespace Sai2Bsr{    ///<BStatus register
    ...
    namespace Sai2Bclrfr{    ///<BClear flag register
    ...
    namespace Sai2Bdr{    ///<BData register
        using Addr = Register::Address<0x40015c40,0x00000000,0x00000000,std::uint32_t>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace Sai2Acr1{    ///<AConfiguration register 1
        using Addr = Register::Address<0x40015c04,0xff04c010,0x00000000,std::uint32_t>;
        ///Master clock divider
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,20),Register::ReadWriteAccess,unsigned> mcjdiv{}; 
        ///No divider
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> nodiv{}; 
    ...
    namespace Sai2Acr2{    ///<AConfiguration register 2
    ...
    namespace Sai2Aslotr{    ///<ASlot register
    ...
    namespace Sai2Aim{    ///<AInterrupt mask register2
    ...
    namespace Sai2Asr{    ///<AStatus register
    ...
    namespace Sai2Aclrfr{    ///<AClear flag register
    ...
    namespace Sai2Adr{    ///<AData register
        using Addr = Register::Address<0x40015c20,0x00000000,0x00000000,std::uint32_t>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace Sai2Gcr{    ///<Global configuration register
