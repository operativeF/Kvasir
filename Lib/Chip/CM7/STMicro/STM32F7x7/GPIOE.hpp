...
//General-purpose I/Os
    namespace GpioeModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40021000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40021004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioeGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40021008,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioePupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002100c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioeIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40021010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40021014,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40021018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002101c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeAfrl{    ///<GPIO alternate function          lowregister
        using Addr = Register::Address<0x40021020,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40021024,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40021028,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
