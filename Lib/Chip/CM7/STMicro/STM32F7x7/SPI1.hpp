...
//Serial peripheral interface
    ...
    namespace Spi1Cr2{    ///<control register 2
        using Addr = Register::Address<0x40013004,0xffff8000,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Sr{    ///<status register
        using Addr = Register::Address<0x40013008,0xffffe000,0x00000000,std::uint32_t>;
        ///Frame format error
    ...
    namespace Spi1I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001301c,0xffffe040,0x00000000,std::uint32_t>;
        ///I2S mode selection
