...
//General-purpose I/Os
    ...
    namespace GpiohGpiobOspeedr{    ///<GPIO port output speed          register
    ...
    namespace GpiohAfrl{    ///<GPIO alternate function          lowregister
    ...
    namespace GpiohBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40021c28,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
