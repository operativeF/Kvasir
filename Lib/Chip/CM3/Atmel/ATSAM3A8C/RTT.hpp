...
//Real-time Timer
    namespace RttMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1a30,0xfff80000,0x00000000,std::uint32_t>;
    ...
    namespace RttAr{    ///<Alarm Register
        using Addr = Register::Address<0x400e1a34,0x00000000,0x00000000,std::uint32_t>;
        ///Alarm Value
    ...
    namespace RttVr{    ///<Value Register
        using Addr = Register::Address<0x400e1a38,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace RttSr{    ///<Status Register
        using Addr = Register::Address<0x400e1a3c,0xfffffffc,0x00000000,std::uint32_t>;
