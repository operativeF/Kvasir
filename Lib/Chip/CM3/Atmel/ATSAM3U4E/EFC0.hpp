...
//Embedded Flash Controller 0
    namespace Efc0Fmr{    ///<EEFC Flash Mode Register
        using Addr = Register::Address<0x400e0800,0xfefef0fe,0x00000000,std::uint32_t>;
    ...
    namespace Efc0Fcr{    ///<EEFC Flash Command Register
        using Addr = Register::Address<0x400e0804,0x00000000,0x00000000,std::uint32_t>;
        ///Flash Command
        enum class FcmdVal {
    ...
    namespace Efc0Fsr{    ///<EEFC Flash Status Register
        using Addr = Register::Address<0x400e0808,0xfffffff8,0x00000000,std::uint32_t>;
        ///Flash Ready Status
    ...
    namespace Efc0Frr{    ///<EEFC Flash Result Register
        using Addr = Register::Address<0x400e080c,0x00000000,0x00000000,std::uint32_t>;
        ///Flash Result Value
