...
//Real-time Clock
    ...
    namespace RtcMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1464,0xfffffffe,0x00000000,std::uint32_t>;
        ///12-/24-hour Mode
    ...
    namespace RtcSr{    ///<Status Register
        using Addr = Register::Address<0x400e1478,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcSccr{    ///<Status Clear Command Register
        using Addr = Register::Address<0x400e147c,0xffffffe0,0x00000000,std::uint32_t>;
        ///Acknowledge Clear
    ...
    namespace RtcIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x400e1480,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x400e1484,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcWpmr{    ///<Write Protect Mode Register
        using Addr = Register::Address<0x400e1544,0x000000fe,0x00000000,std::uint32_t>;
