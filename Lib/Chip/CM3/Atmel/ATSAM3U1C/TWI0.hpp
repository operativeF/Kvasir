...
//Two-wire Interface 0
    namespace Twi0Cr{    ///<Control Register
        using Addr = Register::Address<0x40084000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0x40084004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0x40084008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi0Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0x4008400c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi0Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0x40084010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi0Sr{    ///<Status Register
        using Addr = Register::Address<0x40084020,0xffff0080,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40084024,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x40084028,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4008402c,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0x40084030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0x40084034,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0x40084100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0x40084104,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0x40084108,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0x4008410c,0xffff0000,0x00000000,std::uint32_t>;
        ///Transmit Counter Register
    ...
    namespace Twi0Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0x40084110,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0x40084114,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0x40084118,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0x4008411c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0x40084120,0xfffffcfc,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0x40084124,0xfffffefe,0x00000000,std::uint32_t>;
        ///Receiver Transfer Enable
