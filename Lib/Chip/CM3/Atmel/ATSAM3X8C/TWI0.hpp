...
//Two-wire Interface 0
    namespace Twi0Cr{    ///<Control Register
        using Addr = Register::Address<0x4008c000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0x4008c004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0x4008c008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi0Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0x4008c00c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi0Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0x4008c010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi0Sr{    ///<Status Register
        using Addr = Register::Address<0x4008c020,0xffff0080,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x4008c024,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x4008c028,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4008c02c,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0x4008c030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0x4008c034,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0x4008c100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0x4008c104,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0x4008c110,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0x4008c114,0xffff0000,0x00000000,std::uint32_t>;
