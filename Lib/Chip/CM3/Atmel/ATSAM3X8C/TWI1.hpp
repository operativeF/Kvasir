...
//Two-wire Interface 1
    namespace Twi1Cr{    ///<Control Register
        using Addr = Register::Address<0x40090000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0x40090004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0x40090008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi1Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0x4009000c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi1Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0x40090010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi1Sr{    ///<Status Register
        using Addr = Register::Address<0x40090020,0xffff0080,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40090024,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x40090028,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4009002c,0xffff0088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0x40090030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0x40090034,0xffffff00,0x00000000,std::uint32_t>;
