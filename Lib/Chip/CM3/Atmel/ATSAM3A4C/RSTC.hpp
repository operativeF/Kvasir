...
//Reset Controller
    namespace RstcCr{    ///<Control Register
        using Addr = Register::Address<0x400e1a00,0x00fffff2,0x00000000,std::uint32_t>;
        ///Processor Reset
    ...
    namespace RstcSr{    ///<Status Register
        using Addr = Register::Address<0x400e1a04,0xfffcf8fe,0x00000000,std::uint32_t>;
        ///User Reset Status
    ...
    namespace RstcMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1a08,0x00fff0ee,0x00000000,std::uint32_t>;
        ///User Reset Enable
