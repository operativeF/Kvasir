...
//Real-time Clock
    namespace RtcCr{    ///<Control Register
        using Addr = Register::Address<0x400e1a60,0xfffcfcfc,0x00000000,std::uint32_t>;
    ...
    namespace RtcMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1a64,0xfffffffe,0x00000000,std::uint32_t>;
        ///12-/24-hour Mode
    ...
    namespace RtcTimr{    ///<Time Register
        using Addr = Register::Address<0x400e1a68,0xff808080,0x00000000,std::uint32_t>;
        ///Current Second
    ...
    namespace RtcCalr{    ///<Calendar Register
        using Addr = Register::Address<0x400e1a6c,0xc0000080,0x00000000,std::uint32_t>;
        ///Current Century
    ...
    namespace RtcTimalr{    ///<Time Alarm Register
        using Addr = Register::Address<0x400e1a70,0xff000000,0x00000000,std::uint32_t>;
        ///Second Alarm
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,0),Register::ReadWriteAccess,unsigned> sec{}; 
        ///Second Alarm Enable
    ...
    namespace RtcCalalr{    ///<Calendar Alarm Register
        using Addr = Register::Address<0x400e1a74,0x4060ffff,0x00000000,std::uint32_t>;
        ///Month Alarm
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,16),Register::ReadWriteAccess,unsigned> month{}; 
        ///Month Alarm Enable
    ...
    namespace RtcSr{    ///<Status Register
        using Addr = Register::Address<0x400e1a78,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcSccr{    ///<Status Clear Command Register
        using Addr = Register::Address<0x400e1a7c,0xffffffe0,0x00000000,std::uint32_t>;
        ///Acknowledge Clear
    ...
    namespace RtcIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x400e1a80,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x400e1a84,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x400e1a88,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace RtcVer{    ///<Valid Entry Register
        using Addr = Register::Address<0x400e1a8c,0xfffffff0,0x00000000,std::uint32_t>;
        ///Non-valid Time
    ...
    namespace RtcWpmr{    ///<Write Protect Mode Register
        using Addr = Register::Address<0x400e1b44,0x000000fe,0x00000000,std::uint32_t>;
