...
//Watchdog Timer
    namespace WdtCr{    ///<Control Register
        using Addr = Register::Address<0x400e1250,0x00fffffe,0x00000000,std::uint32_t>;
        ///Watchdog Restart
    ...
    namespace WdtMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1254,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace WdtSr{    ///<Status Register
        using Addr = Register::Address<0x400e1258,0xfffffffc,0x00000000,std::uint32_t>;
        ///Watchdog Underflow
