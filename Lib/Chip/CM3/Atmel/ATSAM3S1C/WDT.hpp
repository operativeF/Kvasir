...
//Watchdog Timer
    namespace WdtCr{    ///<Control Register
        using Addr = Register::Address<0x400e1450,0x00fffffe,0x00000000,std::uint32_t>;
        ///Watchdog Restart
    ...
    namespace WdtMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1454,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace WdtSr{    ///<Status Register
        using Addr = Register::Address<0x400e1458,0xfffffffc,0x00000000,std::uint32_t>;
        ///Watchdog Underflow
