...
//Synchronous Serial Controller
    ...
    namespace SscSr{    ///<Status Register
        using Addr = Register::Address<0x40004040,0xfffcf0cc,0x00000000,std::uint32_t>;
        ///Transmit Ready
    ...
    namespace SscIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40004044,0xfffff0cc,0x00000000,std::uint32_t>;
    ...
    namespace SscIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x40004048,0xfffff0cc,0x00000000,std::uint32_t>;
    ...
    namespace SscImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4000404c,0xfffff0cc,0x00000000,std::uint32_t>;
    ...
    namespace SscWpsr{    ///<Write Protect Status Register
        using Addr = Register::Address<0x400040e8,0xff0000fe,0x00000000,std::uint32_t>;
