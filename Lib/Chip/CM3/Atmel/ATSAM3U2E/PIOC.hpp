...
//Parallel Input/Output Controller C
    ...
    namespace PiocAbsr{    ///<Peripheral AB Select Register
    ...
    namespace PiocScifsr{    ///<System Clock Glitch Input Filter Select Register
    ...
    namespace PiocDifsr{    ///<Debouncing Input Filter Select Register
    ...
    namespace PiocIfdgsr{    ///<Glitch or Debouncing Input Filter Clock Selection Status Register
