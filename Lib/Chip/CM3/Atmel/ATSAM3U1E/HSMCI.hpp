...
//High Speed MultiMedia Card Interface
    ...
    namespace HsmciSr{    ///<Status Register
        using Addr = Register::Address<0x40000040,0x0000cec0,0x00000000,std::uint32_t>;
        ///Command Ready
    ...
    namespace HsmciIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40000044,0x0000cec0,0x00000000,std::uint32_t>;
    ...
    namespace HsmciIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x40000048,0x0000cec0,0x00000000,std::uint32_t>;
    ...
    namespace HsmciImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4000004c,0x0000cec0,0x00000000,std::uint32_t>;
