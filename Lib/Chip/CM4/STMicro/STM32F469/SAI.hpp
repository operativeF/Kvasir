...
//Serial audio interface
    ...
    namespace SaiGcr{    ///<Global configuration register
        using Addr = Register::Address<0x40015800,0xfffffffc,0x00000000,std::uint32_t>;
        ///Synchronization outputs
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> syncout{}; 
    }
}
