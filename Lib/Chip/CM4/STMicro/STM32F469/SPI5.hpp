...
//Serial peripheral interface
    namespace Spi5Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015000,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi5Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015004,0xffffff08,0x00000000,std::uint32_t>;
    ...
    namespace Spi5Sr{    ///<status register
        using Addr = Register::Address<0x40015008,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Spi5Dr{    ///<data register
        using Addr = Register::Address<0x4001500c,0xffff0000,0x00000000,std::uint32_t>;
        ///Data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dr{}; 
    }
    namespace Spi5Crcpr{    ///<CRC polynomial register
        using Addr = Register::Address<0x40015010,0xffff0000,0x00000000,std::uint32_t>;
        ///CRC polynomial register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> crcpoly{}; 
    }
    namespace Spi5Rxcrcr{    ///<RX CRC register
        using Addr = Register::Address<0x40015014,0xffff0000,0x00000000,std::uint32_t>;
        ///Rx CRC register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> rxcrc{}; 
    }
    namespace Spi5Txcrcr{    ///<TX CRC register
    ...
    namespace Spi5I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001501c,0xfffff040,0x00000000,std::uint32_t>;
        ///I2S mode selection
    ...
    namespace Spi5I2spr{    ///<I2S prescaler register
        using Addr = Register::Address<0x40015020,0xfffffc00,0x00000000,std::uint32_t>;
