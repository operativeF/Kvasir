...
//Analog-to-Digital Converter
    ...
    namespace Adc3Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5004020c,0x80000004,0x00000000,std::uint32_t>;
        ///AWDCH1CH
    ...
    namespace Adc3Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50040214,0xc0000007,0x00000000,std::uint32_t>;
        ///SMP9
    ...
    namespace Adc3Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500402a0,0xfff80001,0x00000000,std::uint32_t>;
        ///AWD2CH
    ...
    namespace Adc3Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500402a4,0xfff80001,0x00000000,std::uint32_t>;
        ///AWD3CH
    ...
    namespace Adc3Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500402b0,0xfff80001,0x00000000,std::uint32_t>;
