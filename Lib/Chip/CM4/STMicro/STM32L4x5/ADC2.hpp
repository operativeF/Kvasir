...
//Analog-to-Digital Converter
    ...
    namespace Adc2Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5004010c,0x80000004,0x00000000,std::uint32_t>;
        ///AWDCH1CH
    ...
    namespace Adc2Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50040114,0xc0000007,0x00000000,std::uint32_t>;
        ///SMP9
    ...
    namespace Adc2Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500401a0,0xfff80001,0x00000000,std::uint32_t>;
        ///AWD2CH
    ...
    namespace Adc2Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500401a4,0xfff80001,0x00000000,std::uint32_t>;
        ///AWD3CH
    ...
    namespace Adc2Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500401b0,0xfff80001,0x00000000,std::uint32_t>;
