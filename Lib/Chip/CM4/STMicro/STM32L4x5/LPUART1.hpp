...
//Universal synchronous asynchronous receiver      transmitter
    namespace Lpuart1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40008000,0xec008000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Lpuart1Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40008004,0x00f047ef,0x00000000,std::uint32_t>;
    ...
    namespace Lpuart1Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40008008,0xff8f0836,0x00000000,std::uint32_t>;
    ...
    namespace Lpuart1Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4000800c,0xfff00000,0x00000000,std::uint32_t>;
        ///BRR
    ...
    namespace Lpuart1Rqr{    ///<Request register
        using Addr = Register::Address<0x40008018,0xfffffff1,0x00000000,std::uint32_t>;
    ...
    namespace Lpuart1Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000801c,0xff80f900,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Lpuart1Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40008020,0xffedfda0,0x00000000,std::uint32_t>;
    ...
    namespace Lpuart1Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40008024,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
    ...
    namespace Lpuart1Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40008028,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
