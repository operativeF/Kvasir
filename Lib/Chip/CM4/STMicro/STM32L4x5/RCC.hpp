...
//Reset and clock control
    ...
    namespace RccPllcfgr{    ///<PLL configuration register
        using Addr = Register::Address<0x4002100c,0xf88c808c,0x00000000,std::uint32_t>;
    ...
    namespace RccPllsai1cfgr{    ///<PLLSAI1 configuration register
        using Addr = Register::Address<0x40021010,0xf88c80ff,0x00000000,std::uint32_t>;
    ...
    namespace RccPllsai2cfgr{    ///<PLLSAI2 configuration register
        using Addr = Register::Address<0x40021014,0xf8fc80ff,0x00000000,std::uint32_t>;
    ...
    namespace RccCier{    ///<Clock interrupt enable          register
        using Addr = Register::Address<0x40021018,0xfffffd00,0x00000000,std::uint32_t>;
    ...
    namespace RccCifr{    ///<Clock interrupt flag register
        using Addr = Register::Address<0x4002101c,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace RccCicr{    ///<Clock interrupt clear register
        using Addr = Register::Address<0x40021020,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace RccAhb2rstr{    ///<AHB2 peripheral reset register
        using Addr = Register::Address<0x4002102c,0xfffacf00,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1rstr1{    ///<APB1 peripheral reset register          1
        using Addr = Register::Address<0x40021038,0x0d013dc0,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1rstr2{    ///<APB1 peripheral reset register          2
        using Addr = Register::Address<0x4002103c,0xffffffda,0x00000000,std::uint32_t>;
    ...
    namespace RccAhb1enr{    ///<AHB1 peripheral clock enable          register
        using Addr = Register::Address<0x40021048,0xfffef6fc,0x00000000,std::uint32_t>;
    ...
    namespace RccAhb2enr{    ///<AHB2 peripheral clock enable          register
        using Addr = Register::Address<0x4002104c,0xfffacf00,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1enr1{    ///<APB1ENR1
        using Addr = Register::Address<0x40021058,0x0d0135c0,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1enr2{    ///<APB1 peripheral clock enable register          2
        using Addr = Register::Address<0x4002105c,0xffffffda,0x00000000,std::uint32_t>;
        ///LPTIM2EN
    ...
    namespace RccAhb1smenr{    ///<AHB1 peripheral clocks enable in Sleep and          Stop modes register
        using Addr = Register::Address<0x40021068,0xfffef4fc,0x00000000,std::uint32_t>;
    ...
    namespace RccAhb2smenr{    ///<AHB2 peripheral clocks enable in Sleep and          Stop modes register
        using Addr = Register::Address<0x4002106c,0xfffacd00,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1smenr1{    ///<APB1SMENR1
        using Addr = Register::Address<0x40021078,0x0d0135c0,0x00000000,std::uint32_t>;
