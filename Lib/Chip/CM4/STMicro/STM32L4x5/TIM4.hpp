...
//General-purpose-timers
    ...
    namespace Tim4Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000808,0xffff0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000080c,0xffff80a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Or{    ///<TIM2 option register
        using Addr = Register::Address<0x40000850,0xffffffe0,0x00000000,std::uint32_t>;
        ///Timer2 ETR remap
