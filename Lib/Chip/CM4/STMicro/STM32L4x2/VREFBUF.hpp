...
//Voltage reference buffer
    namespace VrefbufCsr{    ///<VREF control and status          register
        using Addr = Register::Address<0x40010030,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace VrefbufCcr{    ///<calibration control register
        using Addr = Register::Address<0x40010034,0xffffffc0,0x00000000,std::uint32_t>;
        ///Trimming code
