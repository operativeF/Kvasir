...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart3Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40004800,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart3Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004808,0xfe010000,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> ucesm{}; 
    ...
    namespace Usart3Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4000480c,0xfffff000,0x00000000,std::uint32_t>;
        ///USARTDIV
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> brr{}; 
    }
    ...
    namespace Usart3Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000481c,0xfd802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Usart3Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40004820,0xffede4a0,0x00000000,std::uint32_t>;
