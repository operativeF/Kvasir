...
//Low power timer
    namespace Lptim2Isr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x40009400,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Icr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x40009404,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40009408,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Cfgr{    ///<Configuration Register
        using Addr = Register::Address<0x4000940c,0xfe011120,0x00000000,std::uint32_t>;
        ///Encoder mode enable
    ...
    namespace Lptim2Cr{    ///<Control Register
        using Addr = Register::Address<0x40009410,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace Lptim2Cmp{    ///<Compare Register
        using Addr = Register::Address<0x40009414,0xffff0000,0x00000000,std::uint32_t>;
        ///Compare value
    ...
    namespace Lptim2Arr{    ///<Autoreload Register
        using Addr = Register::Address<0x40009418,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto reload value
