...
//Comparator
    namespace CompComp1Csr{    ///<Comparator 1 control and status          register
        using Addr = Register::Address<0x40010200,0x39207e02,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,7),Register::ReadWriteAccess,unsigned> comp1Inpsel{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(26,25),Register::ReadWriteAccess,unsigned> comp1Inmesel{}; 
    ...
    namespace CompComp2Csr{    ///<Comparator 2 control and status          register
        using Addr = Register::Address<0x40010204,0x39207c02,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,7),Register::ReadWriteAccess,unsigned> comp2Inpsel{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(26,25),Register::ReadWriteAccess,unsigned> comp2Inmesel{}; 
