...
//Inter-integrated circuit
    namespace I2c4Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40008400,0xff002000,0x00000000,std::uint32_t>;
        ///Peripheral enable
    ...
    namespace I2c4Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40008404,0xf8000000,0x00000000,std::uint32_t>;
    ...
    namespace I2c4Oar1{    ///<Own address register 1
        using Addr = Register::Address<0x40008408,0xffff7800,0x00000000,std::uint32_t>;
        ///Interface address
    ...
    namespace I2c4Oar2{    ///<Own address register 2
        using Addr = Register::Address<0x4000840c,0xffff7801,0x00000000,std::uint32_t>;
        ///Interface address
    ...
    namespace I2c4Timingr{    ///<Timing register
        using Addr = Register::Address<0x40008410,0x0f000000,0x00000000,std::uint32_t>;
    ...
    namespace I2c4Timeoutr{    ///<Status register 1
        using Addr = Register::Address<0x40008414,0x70006000,0x00000000,std::uint32_t>;
        ///Bus timeout A
    ...
    namespace I2c4Isr{    ///<Interrupt and Status register
        using Addr = Register::Address<0x40008418,0xff004000,0x00000000,std::uint32_t>;
    ...
    namespace I2c4Icr{    ///<Interrupt clear register
        using Addr = Register::Address<0x4000841c,0xffffc0c7,0x00000000,std::uint32_t>;
        ///Alert flag clear
    ...
    namespace I2c4Pecr{    ///<PEC register
        using Addr = Register::Address<0x40008420,0xffffff00,0x00000000,std::uint32_t>;
        ///Packet error checking              register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> pec{}; 
    }
    namespace I2c4Rxdr{    ///<Receive data register
        using Addr = Register::Address<0x40008424,0xffffff00,0x00000000,std::uint32_t>;
        ///8-bit receive data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> rxdata{}; 
    }
    namespace I2c4Txdr{    ///<Transmit data register
        using Addr = Register::Address<0x40008428,0xffffff00,0x00000000,std::uint32_t>;
        ///8-bit transmit data
