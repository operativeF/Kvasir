...
//HDMI-CEC controller
    namespace CecCr{    ///<control register
        using Addr = Register::Address<0x40007800,0xfffffff8,0x00000000,std::uint32_t>;
        ///Tx End Of Message
    ...
    namespace CecCfgr{    ///<configuration register
        using Addr = Register::Address<0x40007804,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace CecTxdr{    ///<Tx data register
        using Addr = Register::Address<0x40007808,0xffffff00,0x00000000,std::uint32_t>;
        ///Tx Data register
    ...
    namespace CecRxdr{    ///<Rx Data Register
        using Addr = Register::Address<0x4000780c,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace CecIsr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x40007810,0xffffe000,0x00000000,std::uint32_t>;
    ...
    namespace CecIer{    ///<interrupt enable register
        using Addr = Register::Address<0x40007814,0xffffe000,0x00000000,std::uint32_t>;
