...
//Flash
    namespace FlashAcr{    ///<Flash access control register
        using Addr = Register::Address<0x40022000,0xffffffc8,0x00000000,std::uint32_t>;
        ///LATENCY
    ...
    namespace FlashCr{    ///<Flash control register
        using Addr = Register::Address<0x40022010,0xffffc908,0x00000000,std::uint32_t>;
    ...
    namespace FlashObr{    ///<Option byte register
        using Addr = Register::Address<0x4002201c,0x000008f8,0x00000000,std::uint32_t>;
        ///Option byte error
        ...
        ///SDADC12_VDD_MONITOR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> sdadc12VddMonitor{}; 
        ///Data0
