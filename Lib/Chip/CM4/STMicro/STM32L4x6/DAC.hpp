...
//Digital-to-analog converter
    ...
    namespace DacCcr{    ///<calibration control register
    ...
    namespace DacMcr{    ///<mode control register
    ...
    namespace DacShsr1{    ///<Sample and Hold sample time register          1
    ...
    namespace DacShsr2{    ///<Sample and Hold sample time register          2
    ...
    namespace DacShhr{    ///<Sample and Hold hold time          register
    ...
    namespace DacShrr{    ///<Sample and Hold refresh time          register
