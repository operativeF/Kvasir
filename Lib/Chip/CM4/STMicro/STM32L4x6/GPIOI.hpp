...
//General-purpose I/Os
    namespace GpioiModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x48002000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x48002004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioiOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x48002008,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioiPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4800200c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioiIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x48002010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x48002014,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x48002018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4800201c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x48002020,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x48002024,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioiBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x48002028,0xffff0000,0x00000000,std::uint32_t>;
        ///Port Reset bit
