...
//General purpose timers
    ...
    namespace Tim17Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001480c,0xffff9c1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Sr{    ///<status register
        using Addr = Register::Address<0x40014810,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Egr{    ///<event generation register
        using Addr = Register::Address<0x40014814,0xffffff1c,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim17Or1{    ///<TIM16 option register 1
    ...
    namespace Tim17Or2{    ///<TIM17 option register 1
