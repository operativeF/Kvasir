...
//Debug support
    namespace DbgmcuIdcode{    ///<MCU Device ID Code Register
        using Addr = Register::Address<0xe0042000,0x00000000,0x00000000,std::uint32_t>;
        ///Device Identifier
    ...
    namespace DbgmcuApb1Fzr1{    ///<APB Low Freeze Register 1
        using Addr = Register::Address<0xe0042008,0x7d1fe3c0,0x00000000,std::uint32_t>;
    ...
    namespace DbgmcuApb2Fzr{    ///<APB High Freeze Register
        using Addr = Register::Address<0xe0042010,0xfff8d7ff,0x00000000,std::uint32_t>;
