...
//Analog-to-Digital Converter
    namespace AdcCommonCsr{    ///<ADC Common status register
        using Addr = Register::Address<0x50040300,0xf800f800,0x00000000,std::uint32_t>;
        ///ADDRDY_MST
    ...
    namespace AdcCommonCcr{    ///<ADC common control register
        using Addr = Register::Address<0x50040308,0xfe0010e0,0x00000000,std::uint32_t>;
        ...
        ///CH17 selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> ch17sel{}; 
        ///CH18 selection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> ch18sel{}; 
        ///ADC prescaler
    ...
    namespace AdcCommonCdr{    ///<ADC common regular data register for dual          and triple modes
        using Addr = Register::Address<0x5004030c,0x00000000,0x00000000,std::uint32_t>;
