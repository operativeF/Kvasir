...
//General-purpose I/Os
    namespace GpioeModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x48001000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x48001004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioeOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x48001008,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioePupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4800100c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioeIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x48001010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x48001014,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x48001018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4800101c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x48001020,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x48001024,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x48001028,0xffff0000,0x00000000,std::uint32_t>;
        ///Port Reset bit
    ...
    namespace GpioeAscr{    ///<GPIO port analog switch control          register
        using Addr = Register::Address<0x4800102c,0xffff0000,0x00000000,std::uint32_t>;
