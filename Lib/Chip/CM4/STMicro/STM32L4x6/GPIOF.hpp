...
//General-purpose I/Os
    namespace GpiofModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x48001400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x48001404,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x48001408,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4800140c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x48001410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x48001414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x48001418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4800141c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x48001420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x48001424,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x48001428,0xffff0000,0x00000000,std::uint32_t>;
        ///Port Reset bit
    ...
    namespace GpiofAscr{    ///<GPIO port analog switch control          register
        using Addr = Register::Address<0x4800142c,0xffff0000,0x00000000,std::uint32_t>;
