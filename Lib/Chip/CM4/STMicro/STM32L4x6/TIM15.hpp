...
//General purpose timers
    ...
    namespace Tim15Cr2{    ///<control register 2
        using Addr = Register::Address<0x40014004,0xfffffcf2,0x00000000,std::uint32_t>;
        ///Output Idle state 1
    ...
    namespace Tim15Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001400c,0xffff9c1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim15Sr{    ///<status register
        using Addr = Register::Address<0x40014010,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim15Egr{    ///<event generation register
        using Addr = Register::Address<0x40014014,0xffffff1c,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim15Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40014018,0xfffeff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim15Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40014018,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim15Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40014020,0xfffffff0,0x00000000,std::uint32_t>;
