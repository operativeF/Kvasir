...
//General-purpose I/Os
    namespace GpiocModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x48000800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x48000804,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x48000808,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4800080c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x48000810,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x48000814,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x48000818,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4800081c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x48000820,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x48000824,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x48000828,0xffff0000,0x00000000,std::uint32_t>;
        ///Port Reset bit
    ...
    namespace GpiocAscr{    ///<GPIO port analog switch control          register
        using Addr = Register::Address<0x4800082c,0xffff0000,0x00000000,std::uint32_t>;
