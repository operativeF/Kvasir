...
//Secure digital input/output      interface
    namespace Sdmmc1Power{    ///<power control register
        using Addr = Register::Address<0x40012800,0xfffffffc,0x00000000,std::uint32_t>;
        ///PWRCTRL
    ...
    namespace Sdmmc1Clkcr{    ///<SDI clock control register
        using Addr = Register::Address<0x40012804,0xffff8000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Arg{    ///<argument register
        using Addr = Register::Address<0x40012808,0x00000000,0x00000000,std::uint32_t>;
        ///Command argument
    ...
    namespace Sdmmc1Cmd{    ///<command register
        using Addr = Register::Address<0x4001280c,0xffff8000,0x00000000,std::uint32_t>;
        ///CE-ATA command
    ...
    namespace Sdmmc1Respcmd{    ///<command response register
        using Addr = Register::Address<0x40012810,0xffffffc0,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Resp1{    ///<response 1..4 register
        using Addr = Register::Address<0x40012814,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
    ...
    namespace Sdmmc1Resp2{    ///<response 1..4 register
        using Addr = Register::Address<0x40012818,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
    ...
    namespace Sdmmc1Resp3{    ///<response 1..4 register
        using Addr = Register::Address<0x4001281c,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
    ...
    namespace Sdmmc1Resp4{    ///<response 1..4 register
        using Addr = Register::Address<0x40012820,0x00000000,0x00000000,std::uint32_t>;
        ///see Table 132
    ...
    namespace Sdmmc1Dtimer{    ///<data timer register
        using Addr = Register::Address<0x40012824,0x00000000,0x00000000,std::uint32_t>;
        ///Data timeout period
    ...
    namespace Sdmmc1Dlen{    ///<data length register
        using Addr = Register::Address<0x40012828,0xfe000000,0x00000000,std::uint32_t>;
        ///Data length value
    ...
    namespace Sdmmc1Dctrl{    ///<data control register
        using Addr = Register::Address<0x4001282c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Dcount{    ///<data counter register
        using Addr = Register::Address<0x40012830,0xfe000000,0x00000000,std::uint32_t>;
        ///Data count value
    ...
    namespace Sdmmc1Sta{    ///<status register
        using Addr = Register::Address<0x40012834,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Icr{    ///<interrupt clear register
        using Addr = Register::Address<0x40012838,0xff3ff800,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Mask{    ///<mask register
        using Addr = Register::Address<0x4001283c,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Fifocnt{    ///<FIFO counter register
        using Addr = Register::Address<0x40012848,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdmmc1Fifo{    ///<data FIFO register
        using Addr = Register::Address<0x40012880,0x00000000,0x00000000,std::uint32_t>;
