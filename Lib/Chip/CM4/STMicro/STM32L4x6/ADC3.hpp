...
//Analog-to-Digital Converter
    namespace Adc3Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x50040200,0xfffff800,0x00000000,std::uint32_t>;
        ///JQOVF
    ...
    namespace Adc3Ier{    ///<interrupt enable register
        using Addr = Register::Address<0x50040204,0xfffff800,0x00000000,std::uint32_t>;
        ///JQOVFIE
    ...
    namespace Adc3Cr{    ///<control register
        using Addr = Register::Address<0x50040208,0x0fffffc0,0x00000000,std::uint32_t>;
        ///ADCAL
    ...
    namespace Adc3Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5004020c,0x00008000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Cfgr2{    ///<configuration register
        using Addr = Register::Address<0x50040210,0xfffff800,0x00000000,std::uint32_t>;
        ///EXTEN
    ...
    namespace Adc3Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50040214,0x40000000,0x00000000,std::uint32_t>;
        ///SMP9
    ...
    namespace Adc3Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50040218,0xf8000000,0x00000000,std::uint32_t>;
        ///SMP18
    ...
    namespace Adc3Tr1{    ///<watchdog threshold register 1
        using Addr = Register::Address<0x50040220,0xf000f000,0x00000000,std::uint32_t>;
        ///HT1
    ...
    namespace Adc3Tr2{    ///<watchdog threshold register
        using Addr = Register::Address<0x50040224,0xff00ff00,0x00000000,std::uint32_t>;
        ///HT2
    ...
    namespace Adc3Tr3{    ///<watchdog threshold register 3
        using Addr = Register::Address<0x50040228,0xff00ff00,0x00000000,std::uint32_t>;
        ///HT3
    ...
    namespace Adc3Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x50040230,0xe0820830,0x00000000,std::uint32_t>;
        ///SQ4
    ...
    namespace Adc3Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50040234,0xe0820820,0x00000000,std::uint32_t>;
        ///SQ9
    ...
    namespace Adc3Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50040238,0xe0820820,0x00000000,std::uint32_t>;
        ///SQ14
    ...
    namespace Adc3Sqr4{    ///<regular sequence register 4
        using Addr = Register::Address<0x5004023c,0xfffff820,0x00000000,std::uint32_t>;
        ///SQ16
    ...
    namespace Adc3Dr{    ///<regular Data Register
        using Addr = Register::Address<0x50040240,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x5004024c,0x82082000,0x00000000,std::uint32_t>;
        ///JSQ4
    ...
    namespace Adc3Ofr1{    ///<offset register 1
        using Addr = Register::Address<0x50040260,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET1_EN
    ...
    namespace Adc3Ofr2{    ///<offset register 2
        using Addr = Register::Address<0x50040264,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET2_EN
    ...
    namespace Adc3Ofr3{    ///<offset register 3
        using Addr = Register::Address<0x50040268,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET3_EN
    ...
    namespace Adc3Ofr4{    ///<offset register 4
        using Addr = Register::Address<0x5004026c,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET4_EN
    ...
    namespace Adc3Jdr1{    ///<injected data register 1
        using Addr = Register::Address<0x50040280,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA1
    ...
    namespace Adc3Jdr2{    ///<injected data register 2
        using Addr = Register::Address<0x50040284,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA2
    ...
    namespace Adc3Jdr3{    ///<injected data register 3
        using Addr = Register::Address<0x50040288,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA3
    ...
    namespace Adc3Jdr4{    ///<injected data register 4
        using Addr = Register::Address<0x5004028c,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA4
    ...
    namespace Adc3Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500402a0,0xfff80000,0x00000000,std::uint32_t>;
        ///AWD2CH
    ...
    namespace Adc3Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500402a4,0xfff80000,0x00000000,std::uint32_t>;
        ///AWD3CH
    ...
    namespace Adc3Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500402b0,0xfff80000,0x00000000,std::uint32_t>;
    ...
    namespace Adc3Calfact{    ///<Calibration Factors
        using Addr = Register::Address<0x500402b4,0xff80ff80,0x00000000,std::uint32_t>;
        ///CALFACT_D
