...
//Analog-to-Digital Converter
    namespace Adc2Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x50040100,0xfffff800,0x00000000,std::uint32_t>;
        ///JQOVF
    ...
    namespace Adc2Ier{    ///<interrupt enable register
        using Addr = Register::Address<0x50040104,0xfffff800,0x00000000,std::uint32_t>;
        ///JQOVFIE
    ...
    namespace Adc2Cr{    ///<control register
        using Addr = Register::Address<0x50040108,0x0fffffc0,0x00000000,std::uint32_t>;
        ///ADCAL
    ...
    namespace Adc2Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5004010c,0x00008000,0x00000000,std::uint32_t>;
        ...
        ///DFSDMCFG
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> dfsdmcfg{}; 
        ///DMACFG
    ...
    namespace Adc2Cfgr2{    ///<configuration register
        using Addr = Register::Address<0x50040110,0xfffff800,0x00000000,std::uint32_t>;
        ///EXTEN
    ...
    namespace Adc2Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50040114,0x40000000,0x00000000,std::uint32_t>;
        ///SMP9
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> smpplus{}; 
        ///SMP0
    ...
    namespace Adc2Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50040118,0xf8000000,0x00000000,std::uint32_t>;
        ///SMP18
    ...
    namespace Adc2Tr1{    ///<watchdog threshold register 1
        using Addr = Register::Address<0x50040120,0xf000f000,0x00000000,std::uint32_t>;
        ///HT1
    ...
    namespace Adc2Tr2{    ///<watchdog threshold register
        using Addr = Register::Address<0x50040124,0xff00ff00,0x00000000,std::uint32_t>;
        ///HT2
    ...
    namespace Adc2Tr3{    ///<watchdog threshold register 3
        using Addr = Register::Address<0x50040128,0xff00ff00,0x00000000,std::uint32_t>;
        ///HT3
    ...
    namespace Adc2Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x50040130,0xe0820830,0x00000000,std::uint32_t>;
        ///SQ4
    ...
    namespace Adc2Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50040134,0xe0820820,0x00000000,std::uint32_t>;
        ///SQ9
    ...
    namespace Adc2Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50040138,0xe0820820,0x00000000,std::uint32_t>;
        ///SQ14
    ...
    namespace Adc2Sqr4{    ///<regular sequence register 4
        using Addr = Register::Address<0x5004013c,0xfffff820,0x00000000,std::uint32_t>;
        ///SQ16
    ...
    namespace Adc2Dr{    ///<regular Data Register
        using Addr = Register::Address<0x50040140,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x5004014c,0x82082000,0x00000000,std::uint32_t>;
        ///JSQ4
    ...
    namespace Adc2Ofr1{    ///<offset register 1
        using Addr = Register::Address<0x50040160,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET1_EN
    ...
    namespace Adc2Ofr2{    ///<offset register 2
        using Addr = Register::Address<0x50040164,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET2_EN
    ...
    namespace Adc2Ofr3{    ///<offset register 3
        using Addr = Register::Address<0x50040168,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET3_EN
    ...
    namespace Adc2Ofr4{    ///<offset register 4
        using Addr = Register::Address<0x5004016c,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET4_EN
    ...
    namespace Adc2Jdr1{    ///<injected data register 1
        using Addr = Register::Address<0x50040180,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata1{}; 
    }
    namespace Adc2Jdr2{    ///<injected data register 2
        using Addr = Register::Address<0x50040184,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata2{}; 
    }
    namespace Adc2Jdr3{    ///<injected data register 3
        using Addr = Register::Address<0x50040188,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata3{}; 
    }
    namespace Adc2Jdr4{    ///<injected data register 4
        using Addr = Register::Address<0x5004018c,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata4{}; 
    }
    namespace Adc2Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500401a0,0xfff80000,0x00000000,std::uint32_t>;
        ///AWD2CH
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,0),Register::ReadWriteAccess,unsigned> awd2ch{}; 
    }
    namespace Adc2Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500401a4,0xfff80000,0x00000000,std::uint32_t>;
        ///AWD3CH
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,0),Register::ReadWriteAccess,unsigned> awd3ch{}; 
    }
    namespace Adc2Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500401b0,0xfff80000,0x00000000,std::uint32_t>;
        ///Differential mode for channels              0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> difsel0{}; 
    ...
    namespace Adc2Calfact{    ///<Calibration Factors
        using Addr = Register::Address<0x500401b4,0xff80ff80,0x00000000,std::uint32_t>;
        ///CALFACT_D
