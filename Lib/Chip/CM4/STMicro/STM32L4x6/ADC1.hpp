...
//Analog-to-Digital Converter
    ...
    namespace Adc1Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5004000c,0x00008000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50040014,0x40000000,0x00000000,std::uint32_t>;
        ///SMP9
    ...
    namespace Adc1Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500400a0,0xfff80000,0x00000000,std::uint32_t>;
        ///AWD2CH
    ...
    namespace Adc1Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500400a4,0xfff80000,0x00000000,std::uint32_t>;
        ///AWD3CH
    ...
    namespace Adc1Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500400b0,0xfff80000,0x00000000,std::uint32_t>;
