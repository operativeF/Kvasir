...
//Power control
    namespace PwrCr1{    ///<Power control register 1
        using Addr = Register::Address<0x40007000,0xffffb8f8,0x00000000,std::uint32_t>;
        ///Low-power run
    ...
    namespace PwrCr2{    ///<Power control register 2
        using Addr = Register::Address<0x40007004,0xfffff900,0x00000000,std::uint32_t>;
    ...
    namespace PwrCr3{    ///<Power control register 3
        using Addr = Register::Address<0x40007008,0xffff7ae0,0x00000000,std::uint32_t>;
    ...
    namespace PwrCr4{    ///<Power control register 4
        using Addr = Register::Address<0x4000700c,0xfffffce0,0x00000000,std::uint32_t>;
    ...
    namespace PwrSr1{    ///<Power status register 1
        using Addr = Register::Address<0x40007010,0xffff7ee0,0x00000000,std::uint32_t>;
    ...
    namespace PwrSr2{    ///<Power status register 2
        using Addr = Register::Address<0x40007014,0xffff00ff,0x00000000,std::uint32_t>;
    ...
    namespace PwrScr{    ///<Power status clear register
        using Addr = Register::Address<0x40007018,0xfffffee0,0x00000000,std::uint32_t>;
        ///Clear standby flag
    ...
    namespace PwrPucra{    ///<Power Port A pull-up control          register
        using Addr = Register::Address<0x40007020,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcra{    ///<Power Port A pull-down control          register
        using Addr = Register::Address<0x40007024,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucrb{    ///<Power Port B pull-up control          register
        using Addr = Register::Address<0x40007028,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcrb{    ///<Power Port B pull-down control          register
        using Addr = Register::Address<0x4000702c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucrc{    ///<Power Port C pull-up control          register
        using Addr = Register::Address<0x40007030,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcrc{    ///<Power Port C pull-down control          register
        using Addr = Register::Address<0x40007034,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucrd{    ///<Power Port D pull-up control          register
        using Addr = Register::Address<0x40007038,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcrd{    ///<Power Port D pull-down control          register
        using Addr = Register::Address<0x4000703c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucre{    ///<Power Port E pull-up control          register
        using Addr = Register::Address<0x40007040,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcre{    ///<Power Port E pull-down control          register
        using Addr = Register::Address<0x40007044,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucrf{    ///<Power Port F pull-up control          register
        using Addr = Register::Address<0x40007048,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcrf{    ///<Power Port F pull-down control          register
        using Addr = Register::Address<0x4000704c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucrg{    ///<Power Port G pull-up control          register
        using Addr = Register::Address<0x40007050,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcrg{    ///<Power Port G pull-down control          register
        using Addr = Register::Address<0x40007054,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace PwrPucrh{    ///<Power Port H pull-up control          register
        using Addr = Register::Address<0x40007058,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace PwrPdcrh{    ///<Power Port H pull-down control          register
        using Addr = Register::Address<0x4000705c,0xfffffffc,0x00000000,std::uint32_t>;
