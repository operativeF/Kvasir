...
//Universal serial bus full-speed device      interface
    namespace UsbFsEp0r{    ///<endpoint 0 register
        using Addr = Register::Address<0x40006800,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
    ...
    namespace UsbFsEp1r{    ///<endpoint 1 register
        using Addr = Register::Address<0x40006804,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsEp2r{    ///<endpoint 2 register
        using Addr = Register::Address<0x40006808,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsEp3r{    ///<endpoint 3 register
        using Addr = Register::Address<0x4000680c,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsEp4r{    ///<endpoint 4 register
        using Addr = Register::Address<0x40006810,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsEp5r{    ///<endpoint 5 register
        using Addr = Register::Address<0x40006814,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsEp6r{    ///<endpoint 6 register
        using Addr = Register::Address<0x40006818,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsEp7r{    ///<endpoint 7 register
        using Addr = Register::Address<0x4000681c,0xffff0000,0x00000000,std::uint32_t>;
        ///Endpoint address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ea{}; 
        ///Status bits, for transmission              transfers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> statTx{}; 
    ...
    namespace UsbFsCntr{    ///<control register
        using Addr = Register::Address<0x40006840,0xffff0040,0x00000000,std::uint32_t>;
        ///Force USB Reset
    ...
    namespace UsbFsIstr{    ///<interrupt status register
        using Addr = Register::Address<0x40006844,0xffff0060,0x00000000,std::uint32_t>;
        ///Endpoint Identifier
    ...
    namespace UsbFsFnr{    ///<frame number register
        using Addr = Register::Address<0x40006848,0xffff0000,0x00000000,std::uint32_t>;
        ///Frame number
    ...
    namespace UsbFsDaddr{    ///<device address
        using Addr = Register::Address<0x4000684c,0xffffff00,0x00000000,std::uint32_t>;
        ///Device address
    ...
    namespace UsbFsBtable{    ///<Buffer table address
        using Addr = Register::Address<0x40006850,0xffff0007,0x00000000,std::uint32_t>;
        ///Buffer table
    ...
    namespace UsbFsLpmcsr{    ///<LPM control and status          register
        using Addr = Register::Address<0x40006854,0xffffff04,0x00000000,std::uint32_t>;
        ///LPM support enable
    ...
    namespace UsbFsBcdr{    ///<Battery charging detector
        using Addr = Register::Address<0x40006858,0xffff7f00,0x00000000,std::uint32_t>;
