...
namespace Kvasir {
//SDMMC
    namespace SdmmcSdmmcPower{    ///<SDMMC power control register
        using Addr = Register::Address<0x40012c00,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcClkcr{    ///<The SDMMC_CLKCR register controls the          SDMMC_CK output clock, the SDMMC_RX_CLK receive clock,          and the bus width.
        using Addr = Register::Address<0x40012c04,0xffc02c00,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcArgr{    ///<The SDMMC_ARGR register contains a 32-bit          command argument, which is sent to a card as part of a          command message.
        using Addr = Register::Address<0x40012c08,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcCmdr{    ///<The SDMMC_CMDR register contains the command          index and command type bits. The command index is sent to          a card as part of a command message. The command type          bits control the command path state machine          (CPSM).
        using Addr = Register::Address<0x40012c0c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcResp1r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x40012c10,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus1{}; 
    }
    namespace SdmmcSdmmcResp2r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x40012c14,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus2{}; 
    }
    namespace SdmmcSdmmcResp3r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x40012c18,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus3{}; 
    }
    namespace SdmmcSdmmcResp4r{    ///<The SDMMC_RESP1/2/3/4R registers contain the          status of a card, which is part of the received          response.
        using Addr = Register::Address<0x40012c1c,0x00000000,0x00000000,std::uint32_t>;
        ///see Table404.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cardstatus4{}; 
    }
    namespace SdmmcSdmmcDtimer{    ///<The SDMMC_DTIMER register contains the data          timeout period, in card bus clock periods. A counter          loads the value from the SDMMC_DTIMER register, and          starts decrementing when the data path state machine          (DPSM) enters the Wait_R or Busy state. If the timer          reaches 0 while the DPSM is in either of these states,          the timeout status flag is set.
        using Addr = Register::Address<0x40012c24,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcDlenr{    ///<The SDMMC_DLENR register contains the number          of data bytes to be transferred. The value is loaded into          the data counter when data transfer starts.
        using Addr = Register::Address<0x40012c28,0xfe000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcDctrl{    ///<The SDMMC_DCTRL register control the data          path state machine (DPSM).
        using Addr = Register::Address<0x40012c2c,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcDcntr{    ///<The SDMMC_DCNTR register loads the value          from the data length register (see SDMMC_DLENR) when the          DPSM moves from the Idle state to the Wait_R or Wait_S          state. As data is transferred, the counter decrements the          value until it reaches 0. The DPSM then moves to the Idle          state and when there has been no error, the data status          end flag (DATAEND) is set.
        using Addr = Register::Address<0x40012c30,0xf8000000,0x00000000,std::uint32_t>;
        ///Data count value When read, the number              of remaining data bytes to be transferred is              returned. Write has no effect.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(26,0),Register::ReadWriteAccess,unsigned> datacount{}; 
    }
    namespace SdmmcSdmmcStar{    ///<The SDMMC_STAR register is a read-only          register. It contains two types of flag:Static flags          (bits [29,21,11:0]): these bits remain asserted until          they are cleared by writing to the SDMMC interrupt Clear          register (see SDMMC_ICR)Dynamic flags (bits [20:12]):          these bits change state depending on the state of the          underlying logic (for example, FIFO full and empty flags          are asserted and de-asserted as data while written to the          FIFO)
        using Addr = Register::Address<0x40012c34,0xe0000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcIcr{    ///<The SDMMC_ICR register is a write-only          register. Writing a bit with 1 clears the corresponding          bit in the SDMMC_STAR status register.
        using Addr = Register::Address<0x40012c38,0xe01ff000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcMaskr{    ///<The interrupt mask register determines which          status flags generate an interrupt request by setting the          corresponding bit to 1.
        using Addr = Register::Address<0x40012c3c,0xe8193000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcAcktimer{    ///<The SDMMC_ACKTIMER register contains the          acknowledgment timeout period, in SDMMC_CK bus clock          periods. A counter loads the value from the          SDMMC_ACKTIMER register, and starts decrementing when the          data path state machine (DPSM) enters the Wait_Ack state.          If the timer reaches 0 while the DPSM is in this states,          the acknowledgment timeout status flag is          set.
        using Addr = Register::Address<0x40012c40,0xfe000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcIdmactrlr{    ///<The receive and transmit FIFOs can be read          or written as 32-bit wide registers. The FIFOs contain 32          entries on 32 sequential addresses. This allows the CPU          to use its load and store multiple operands to read          from/write to the FIFO.
        using Addr = Register::Address<0x40012c50,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcIdmabsizer{    ///<The SDMMC_IDMABSIZER register contains the          buffers size when in double buffer          configuration.
        using Addr = Register::Address<0x40012c54,0xffffe01f,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcIdmabase0r{    ///<The SDMMC_IDMABASE0R register contains the          memory buffer base address in single buffer configuration          and the buffer 0 base address in double buffer          configuration.
        using Addr = Register::Address<0x40012c58,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcIdmabase1r{    ///<The SDMMC_IDMABASE1R register contains the          double buffer configuration second buffer memory base          address.
        using Addr = Register::Address<0x40012c5c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcFifor{    ///<The receive and transmit FIFOs can be only          read or written as word (32-bit) wide registers. The          FIFOs contain 16 entries on sequential addresses. This          allows the CPU to use its load and store multiple          operands to read from/write to the FIFO.When accessing          SDMMC_FIFOR with half word or byte access an AHB bus          fault is generated.
        using Addr = Register::Address<0x40012c80,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcVer{    ///<SDMMC IP version register
        using Addr = Register::Address<0x40012ff4,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace SdmmcSdmmcId{    ///<SDMMC IP identification          register
        using Addr = Register::Address<0x40012ff8,0x00000000,0x00000000,std::uint32_t>;
