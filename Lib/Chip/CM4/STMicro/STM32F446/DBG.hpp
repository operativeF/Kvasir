...
//Debug support
    ...
    namespace DbgDbgmcuApb1Fz{    ///<Debug MCU APB1 Freeze registe
        using Addr = Register::Address<0xe0042008,0xf81fe200,0x00000000,std::uint32_t>;
        ///DBG_TIM2_STOP
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> dbgI2cfmpSmbusTimeout{}; 
        ///DBG_CAN1_STOP
