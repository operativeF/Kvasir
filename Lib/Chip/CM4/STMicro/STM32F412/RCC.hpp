...
//Reset and clock control
    ...
    namespace RccAhb2rstr{    ///<AHB2 peripheral reset register
        using Addr = Register::Address<0x40023814,0xffffff3f,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register
        using Addr = Register::Address<0x40023820,0xe8193600,0x00000000,std::uint32_t>;
        ///TIM2 reset
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register
        using Addr = Register::Address<0x40023824,0xfef8a6cc,0x00000000,std::uint32_t>;
        ///TIM1 reset
    ...
    namespace RccAhb2enr{    ///<AHB2 peripheral clock enable          register
        using Addr = Register::Address<0x40023834,0xffffff3f,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable          register
        using Addr = Register::Address<0x40023840,0xe8193600,0x00000000,std::uint32_t>;
        ///TIM2 clock enable
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable          register
        using Addr = Register::Address<0x40023844,0xfef886cc,0x00000000,std::uint32_t>;
        ///TIM1 clock enable
    ...
    namespace RccAhb1lpenr{    ///<AHB1 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023850,0xff9e6f00,0x00000000,std::uint32_t>;
    ...
    namespace RccAhb2lpenr{    ///<AHB2 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023854,0xffffff3f,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1lpenr{    ///<APB1 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023860,0xe8193600,0x00000000,std::uint32_t>;
    ...
    namespace RccApb2lpenr{    ///<APB2 peripheral clock enabled in low power          mode register
        using Addr = Register::Address<0x40023864,0xfef886cc,0x00000000,std::uint32_t>;
