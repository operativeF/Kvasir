...
//Inter-integrated circuit
    namespace I2c4Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40006000,0xff002000,0x00000000,std::uint32_t>;
        ///Peripheral enable
    ...
    namespace I2c4Timeoutr{    ///<Timeout register
    ...
    namespace I2c4Icr{    ///<Interrupt clear register
        ...
        ///ALERTC
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> alertc{}; 
    }
