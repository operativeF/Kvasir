...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart8Sr{    ///<Status register
        using Addr = Register::Address<0x40007c00,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Dr{    ///<Data register
        using Addr = Register::Address<0x40007c04,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
    ...
    namespace Uart8Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40007c08,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Uart8Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40007c0c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Uart8Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40007c10,0xffff8f90,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart8Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007c14,0xfffff730,0x00000000,std::uint32_t>;
