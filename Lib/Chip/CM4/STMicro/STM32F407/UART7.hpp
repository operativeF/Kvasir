...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart7Sr{    ///<Status register
        using Addr = Register::Address<0x40007800,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Uart7Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40007810,0xffff8f90,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart7Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007814,0xfffff730,0x00000000,std::uint32_t>;
