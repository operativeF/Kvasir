...
//Sigma-delta analog-to-digital      converter
    namespace Sdadc3Cr1{    ///<control register 1
        using Addr = Register::Address<0x40016800,0x7ffc20e0,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Cr2{    ///<control register 2
        using Addr = Register::Address<0x40016804,0xfe301088,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x40016808,0x7fff0fe0,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Clrisr{    ///<interrupt and status clear          register
        using Addr = Register::Address<0x4001680c,0xffffffea,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Jchgr{    ///<injected channel group selection          register
        using Addr = Register::Address<0x40016814,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Conf0r{    ///<configuration 0 register
        using Addr = Register::Address<0x40016820,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Conf1r{    ///<configuration 1 register
        using Addr = Register::Address<0x40016824,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Conf2r{    ///<configuration 2 register
        using Addr = Register::Address<0x40016828,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Confchr1{    ///<channel configuration register          1
        using Addr = Register::Address<0x40016840,0xcccccccc,0x00000000,std::uint32_t>;
        ///CONFCH7
    ...
    namespace Sdadc3Confchr2{    ///<channel configuration register          2
        using Addr = Register::Address<0x40016844,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Jdatar{    ///<data register for injected          group
        using Addr = Register::Address<0x40016860,0xe1ff0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Rdatar{    ///<data register for the regular          channel
        using Addr = Register::Address<0x40016864,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Jdata12r{    ///<SDADC1 and SDADC2 injected data          register
        using Addr = Register::Address<0x40016870,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Rdata12r{    ///<SDADC1 and SDADC2 regular data          register
        using Addr = Register::Address<0x40016874,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Jdata13r{    ///<SDADC1 and SDADC3 injected data          register
        using Addr = Register::Address<0x40016878,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc3Rdata13r{    ///<SDADC1 and SDADC3 regular data          register
        using Addr = Register::Address<0x4001687c,0x00000000,0x00000000,std::uint32_t>;
