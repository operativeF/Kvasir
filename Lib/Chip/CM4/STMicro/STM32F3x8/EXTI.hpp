...
//External interrupt/event      controller
    namespace ExtiImr{    ///<Interrupt mask register          (EXTI_IMR)
        using Addr = Register::Address<0x40010400,0xe0000000,0x00000000,std::uint32_t>;
    ...
    namespace ExtiEmr{    ///<Event mask register (EXTI_EMR)
        using Addr = Register::Address<0x40010404,0xe0000000,0x00000000,std::uint32_t>;
    ...
    namespace ExtiRtsr{    ///<Rising Trigger selection register          (EXTI_RTSR)
        using Addr = Register::Address<0x40010408,0xfff40000,0x00000000,std::uint32_t>;
    ...
    namespace ExtiFtsr{    ///<Falling Trigger selection register          (EXTI_FTSR)
        using Addr = Register::Address<0x4001040c,0xfff40000,0x00000000,std::uint32_t>;
    ...
    namespace ExtiSwier{    ///<Software interrupt event register          (EXTI_SWIER)
        using Addr = Register::Address<0x40010410,0xfff40000,0x00000000,std::uint32_t>;
    ...
    namespace ExtiPr{    ///<Pending register (EXTI_PR)
        using Addr = Register::Address<0x40010414,0xfff40000,0x00000000,std::uint32_t>;
        ///Pending bit 0
