...
//Analog-to-Digital Converter
    namespace Adc2Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x50000400,0xfffff800,0x00000000,std::uint32_t>;
        ///JQOVF
    ...
    namespace Adc2Ier{    ///<interrupt enable register
        using Addr = Register::Address<0x50000404,0xfffff800,0x00000000,std::uint32_t>;
        ///JQOVFIE
    ...
    namespace Adc2Cr{    ///<control register
        using Addr = Register::Address<0x50000408,0x0fffffc0,0x00000000,std::uint32_t>;
        ///ADCAL
    ...
    namespace Adc2Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5000040c,0x80000004,0x00000000,std::uint32_t>;
        ///AWDCH1CH
    ...
    namespace Adc2Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50000414,0xc0000007,0x00000000,std::uint32_t>;
        ///SMP9
    ...
    namespace Adc2Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50000418,0xf8000000,0x00000000,std::uint32_t>;
        ///SMP18
    ...
    namespace Adc2Tr1{    ///<watchdog threshold register 1
        using Addr = Register::Address<0x50000420,0xf000f000,0x00000000,std::uint32_t>;
        ///HT1
    ...
    namespace Adc2Tr2{    ///<watchdog threshold register
        using Addr = Register::Address<0x50000424,0xff00ff00,0x00000000,std::uint32_t>;
        ///HT2
    ...
    namespace Adc2Tr3{    ///<watchdog threshold register 3
        using Addr = Register::Address<0x50000428,0xff00ff00,0x00000000,std::uint32_t>;
        ///HT3
    ...
    namespace Adc2Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x50000430,0xe0820830,0x00000000,std::uint32_t>;
        ///SQ4
    ...
    namespace Adc2Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50000434,0xe0820820,0x00000000,std::uint32_t>;
        ///SQ9
    ...
    namespace Adc2Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50000438,0xe0820820,0x00000000,std::uint32_t>;
        ///SQ14
    ...
    namespace Adc2Sqr4{    ///<regular sequence register 4
        using Addr = Register::Address<0x5000043c,0xfffff820,0x00000000,std::uint32_t>;
        ///SQ16
    ...
    namespace Adc2Dr{    ///<regular Data Register
        using Addr = Register::Address<0x50000440,0xffff0000,0x00000000,std::uint32_t>;
        ///regularDATA
    ...
    namespace Adc2Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x5000044c,0x82082000,0x00000000,std::uint32_t>;
        ///JSQ4
    ...
    namespace Adc2Ofr1{    ///<offset register 1
        using Addr = Register::Address<0x50000460,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET1_EN
    ...
    namespace Adc2Ofr2{    ///<offset register 2
        using Addr = Register::Address<0x50000464,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET2_EN
    ...
    namespace Adc2Ofr3{    ///<offset register 3
        using Addr = Register::Address<0x50000468,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET3_EN
    ...
    namespace Adc2Ofr4{    ///<offset register 4
        using Addr = Register::Address<0x5000046c,0x03fff000,0x00000000,std::uint32_t>;
        ///OFFSET4_EN
    ...
    namespace Adc2Jdr1{    ///<injected data register 1
        using Addr = Register::Address<0x50000480,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA1
    ...
    namespace Adc2Jdr2{    ///<injected data register 2
        using Addr = Register::Address<0x50000484,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA2
    ...
    namespace Adc2Jdr3{    ///<injected data register 3
        using Addr = Register::Address<0x50000488,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA3
    ...
    namespace Adc2Jdr4{    ///<injected data register 4
        using Addr = Register::Address<0x5000048c,0xffff0000,0x00000000,std::uint32_t>;
        ///JDATA4
    ...
    namespace Adc2Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500004a0,0xfff80001,0x00000000,std::uint32_t>;
        ///AWD2CH
    ...
    namespace Adc2Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500004a4,0xfff80001,0x00000000,std::uint32_t>;
        ///AWD3CH
    ...
    namespace Adc2Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500004b0,0xfff80001,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Calfact{    ///<Calibration Factors
        using Addr = Register::Address<0x500004b4,0xff80ff80,0x00000000,std::uint32_t>;
        ///CALFACT_D
