...
//Analog to digital converter
    namespace Adc1Sr{    ///<status register
        using Addr = Register::Address<0x50000000,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Cr1{    ///<control register 1
        using Addr = Register::Address<0x50000004,0xff3f0000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Cr2{    ///<control register 2
        using Addr = Register::Address<0x50000008,0xff0106f0,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x5000000c,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50000010,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jofr1{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x50000014,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jofr2{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x50000018,0xfffff000,0x00000000,std::uint32_t>;
        ///Data offset for injected channel              x
    ...
    namespace Adc1Jofr3{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x5000001c,0xfffff000,0x00000000,std::uint32_t>;
        ///Data offset for injected channel              x
    ...
    namespace Adc1Jofr4{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x50000020,0xfffff000,0x00000000,std::uint32_t>;
        ///Data offset for injected channel              x
    ...
    namespace Adc1Htr{    ///<watchdog higher threshold          register
        using Addr = Register::Address<0x50000024,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Ltr{    ///<watchdog lower threshold          register
        using Addr = Register::Address<0x50000028,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x5000002c,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50000030,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50000034,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x50000038,0xffc00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc1Jdr1{    ///<injected data register x
        using Addr = Register::Address<0x5000003c,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
    ...
    namespace Adc1Jdr3{    ///<injected data register x
        using Addr = Register::Address<0x50000044,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc1Jdr4{    ///<injected data register x
        using Addr = Register::Address<0x50000048,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc1Dr{    ///<regular data register
        using Addr = Register::Address<0x5000004c,0xffff0000,0x00000000,std::uint32_t>;
        ///Regular data
