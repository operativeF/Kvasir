...
//General-purpose-timers
    namespace Tim20Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015000,0xfffffc70,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim20Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015004,0xfffffcf2,0x00000000,std::uint32_t>;
        ///Output Idle state 1
    ...
    namespace Tim20Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001500c,0xffffbc1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim20Sr{    ///<status register
        using Addr = Register::Address<0x40015010,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim20Egr{    ///<event generation register
        using Addr = Register::Address<0x40015014,0xffffff1c,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim20Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40015018,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim20Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40015018,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim20Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40015020,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace Tim20Cnt{    ///<counter
        using Addr = Register::Address<0x40015024,0xffff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim20Rcr{    ///<repetition counter register
        using Addr = Register::Address<0x40015030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim20Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40015044,0xffff0000,0x00000000,std::uint32_t>;
        ///Main output enable
