...
//Digital-to-analog converter
    namespace Dac2Cr{    ///<control register
        using Addr = Register::Address<0x40009800,0xffffc000,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Swtrigr{    ///<software trigger register
        using Addr = Register::Address<0x40009804,0xfffffffe,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Sr{    ///<DAC status register
        using Addr = Register::Address<0x40009834,0xffffdfff,0x00000000,std::uint32_t>;
