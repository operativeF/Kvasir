...
//Sigma-delta analog-to-digital      converter
    namespace Sdadc2Cr1{    ///<control register 1
        using Addr = Register::Address<0x40016400,0x7ffc20e0,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Cr2{    ///<control register 2
        using Addr = Register::Address<0x40016404,0xfe301088,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x40016408,0x7fff0fe0,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Clrisr{    ///<interrupt and status clear          register
        using Addr = Register::Address<0x4001640c,0xffffffea,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Jchgr{    ///<injected channel group selection          register
        using Addr = Register::Address<0x40016414,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Conf0r{    ///<configuration 0 register
        using Addr = Register::Address<0x40016420,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Conf1r{    ///<configuration 1 register
        using Addr = Register::Address<0x40016424,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Conf2r{    ///<configuration 2 register
        using Addr = Register::Address<0x40016428,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Confchr1{    ///<channel configuration register          1
        using Addr = Register::Address<0x40016440,0xcccccccc,0x00000000,std::uint32_t>;
        ///CONFCH7
    ...
    namespace Sdadc2Confchr2{    ///<channel configuration register          2
        using Addr = Register::Address<0x40016444,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Jdatar{    ///<data register for injected          group
        using Addr = Register::Address<0x40016460,0xe1ff0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Rdatar{    ///<data register for the regular          channel
        using Addr = Register::Address<0x40016464,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Jdata12r{    ///<SDADC1 and SDADC2 injected data          register
    ...
    namespace Sdadc2Rdata12r{    ///<SDADC1 and SDADC2 regular data          register
        using Addr = Register::Address<0x40016474,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Jdata13r{    ///<SDADC1 and SDADC3 injected data          register
        using Addr = Register::Address<0x40016478,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc2Rdata13r{    ///<SDADC1 and SDADC3 regular data          register
        using Addr = Register::Address<0x4001647c,0x00000000,0x00000000,std::uint32_t>;
