...
//General purpose timer
    namespace Tim19Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015c00,0xfffffc00,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim19Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015c04,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim19Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40015c08,0xffff0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x40015c0c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Sr{    ///<status register
        using Addr = Register::Address<0x40015c10,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Egr{    ///<event generation register
        using Addr = Register::Address<0x40015c14,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim19Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40015c18,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40015c18,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x40015c1c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x40015c1c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40015c20,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim19Cnt{    ///<counter
        using Addr = Register::Address<0x40015c24,0xffff0000,0x00000000,std::uint32_t>;
        ///counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim19Psc{    ///<prescaler
    ...
    namespace Tim19Arr{    ///<auto-reload register
        using Addr = Register::Address<0x40015c2c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> arr{}; 
    }
    namespace Tim19Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40015c34,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim19Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40015c38,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 2 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr2{}; 
    }
    namespace Tim19Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x40015c3c,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr3{}; 
    }
    namespace Tim19Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40015c40,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr4{}; 
    }
    namespace Tim19Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40015c48,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim19Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40015c4c,0xffff0000,0x00000000,std::uint32_t>;
