...
//General purpose timer
    namespace Tim2Cr1{    ///<control register 1
        using Addr = Register::Address<0x40000000,0xffffe400,0x00000000,std::uint32_t>;
        ///UIF status bit remapping
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,11),Register::ReadWriteAccess,unsigned> uifremap{}; 
        ///Clock division
