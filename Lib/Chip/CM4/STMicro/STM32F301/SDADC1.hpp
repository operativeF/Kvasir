...
//Sigma-delta analog-to-digital      converter
    namespace Sdadc1Cr1{    ///<control register 1
        using Addr = Register::Address<0x40016000,0x7ffc20e0,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Cr2{    ///<control register 2
        using Addr = Register::Address<0x40016004,0xfe301088,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x40016008,0x7fff0fe0,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Clrisr{    ///<interrupt and status clear          register
        using Addr = Register::Address<0x4001600c,0xffffffea,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Jchgr{    ///<injected channel group selection          register
        using Addr = Register::Address<0x40016014,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Conf0r{    ///<configuration 0 register
        using Addr = Register::Address<0x40016020,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Conf1r{    ///<configuration 1 register
        using Addr = Register::Address<0x40016024,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Conf2r{    ///<configuration 2 register
        using Addr = Register::Address<0x40016028,0x338ff000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Confchr1{    ///<channel configuration register          1
        using Addr = Register::Address<0x40016040,0xcccccccc,0x00000000,std::uint32_t>;
        ///CONFCH7
    ...
    namespace Sdadc1Confchr2{    ///<channel configuration register          2
        using Addr = Register::Address<0x40016044,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Jdatar{    ///<data register for injected          group
        using Addr = Register::Address<0x40016060,0xe1ff0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Rdatar{    ///<data register for the regular          channel
        using Addr = Register::Address<0x40016064,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Rdata12r{    ///<SDADC1 and SDADC2 regular data          register
        using Addr = Register::Address<0x40016074,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Jdata13r{    ///<SDADC1 and SDADC3 injected data          register
        using Addr = Register::Address<0x40016078,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Sdadc1Rdata13r{    ///<SDADC1 and SDADC3 regular data          register
        using Addr = Register::Address<0x4001607c,0x00000000,0x00000000,std::uint32_t>;
