...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart8Sr{    ///<Status register
        using Addr = Register::Address<0x40007c00,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Uart8Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40007c10,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart8Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40007c14,0xfffff000,0x00000000,std::uint32_t>;
