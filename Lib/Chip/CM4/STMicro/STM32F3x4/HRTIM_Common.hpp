...
//High Resolution Timer: Common      functions
    ...
    namespace HrtimCommonOdisr{    ///<DISR
    ...
    namespace HrtimCommonBmtrgr{    ///<BMTRGR
        using Addr = Register::Address<0x400177a4,0x00000000,0x00000000,std::uint32_t>;
        ///OCHPEV
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ochpev{}; 
        ///EEV8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> eev8{}; 
        ///EEV7
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> eev7{}; 
        ///TDEEV8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> tdeev8{}; 
        ///TAEEV7
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> taeev7{}; 
        ///TECMP2
    ...
    namespace HrtimCommonBmcmpr{    ///<BMCMPR
    ...
    namespace HrtimCommonEecr3{    ///<Timer External Event Control Register          3
        using Addr = Register::Address<0x400177b8,0x30c30c30,0x00000000,std::uint32_t>;
        ///EEVSD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,30),Register::ReadWriteAccess,unsigned> eevsd{}; 
        ///EE10F
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,24),Register::ReadWriteAccess,unsigned> ee10f{}; 
        ///EE9F
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(21,18),Register::ReadWriteAccess,unsigned> ee9f{}; 
        ///EE8F
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> ee8f{}; 
        ///EE7F
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,6),Register::ReadWriteAccess,unsigned> ee7f{}; 
        ///EE6F
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ee6f{}; 
    }
    ...
    namespace HrtimCommonBdtaupr{    ///<Burst DMA Timerx update          Register
    ...
    namespace HrtimCommonBdtbupr{    ///<Burst DMA Timerx update          Register
        using Addr = Register::Address<0x400177e0,0xffe00000,0x00000000,std::uint32_t>;
        ///HRTIM_FLTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> timxfltr{}; 
        ///HRTIM_OUTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> timxoutr{}; 
    ...
    namespace HrtimCommonBdtcupr{    ///<Burst DMA Timerx update          Register
        using Addr = Register::Address<0x400177e4,0xffe00000,0x00000000,std::uint32_t>;
        ///HRTIM_FLTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> timxfltr{}; 
        ///HRTIM_OUTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> timxoutr{}; 
    ...
    namespace HrtimCommonBdtdupr{    ///<Burst DMA Timerx update          Register
        using Addr = Register::Address<0x400177e8,0xffe00000,0x00000000,std::uint32_t>;
        ///HRTIM_FLTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> timxfltr{}; 
        ///HRTIM_OUTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> timxoutr{}; 
    ...
    namespace HrtimCommonBdteupr{    ///<Burst DMA Timerx update          Register
        using Addr = Register::Address<0x400177ec,0xffe00000,0x00000000,std::uint32_t>;
        ///HRTIM_FLTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> timxfltr{}; 
        ///HRTIM_OUTxR register update              enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> timxoutr{}; 
    ...
    namespace HrtimCommonBdmadr{    ///<Burst DMA Data Register
        using Addr = Register::Address<0x400177f0,0x00000000,0x00000000,std::uint32_t>;
