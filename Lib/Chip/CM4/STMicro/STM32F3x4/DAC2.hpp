...
//Digital-to-analog converter
    namespace Dac2Cr{    ///<control register
        using Addr = Register::Address<0x40009800,0xc000c000,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Swtrigr{    ///<software trigger register
        using Addr = Register::Address<0x40009804,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr12r1{    ///<channel1 12-bit right-aligned data holding          register
        using Addr = Register::Address<0x40009808,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr12l1{    ///<channel1 12-bit left aligned data holding          register
        using Addr = Register::Address<0x4000980c,0xffff000f,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr8r1{    ///<channel1 8-bit right aligned data holding          register
        using Addr = Register::Address<0x40009810,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr12r2{    ///<channel2 12-bit right aligned data holding          register
        using Addr = Register::Address<0x40009814,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr12l2{    ///<channel2 12-bit left aligned data holding          register
        using Addr = Register::Address<0x40009818,0xffff000f,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr8r2{    ///<channel2 8-bit right-aligned data holding          register
        using Addr = Register::Address<0x4000981c,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dhr12rd{    ///<Dual DAC 12-bit right-aligned data holding          register
        using Addr = Register::Address<0x40009820,0xf000f000,0x00000000,std::uint32_t>;
        ///DAC channel2 12-bit right-aligned              data
    ...
    namespace Dac2Dhr12ld{    ///<DUAL DAC 12-bit left aligned data holding          register
        using Addr = Register::Address<0x40009824,0x000f000f,0x00000000,std::uint32_t>;
        ///DAC channel2 12-bit left-aligned              data
    ...
    namespace Dac2Dhr8rd{    ///<DUAL DAC 8-bit right aligned data holding          register
        using Addr = Register::Address<0x40009828,0xffff0000,0x00000000,std::uint32_t>;
        ///DAC channel2 8-bit right-aligned              data
    ...
    namespace Dac2Dor1{    ///<channel1 data output register
        using Addr = Register::Address<0x4000982c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Dor2{    ///<channel2 data output register
        using Addr = Register::Address<0x40009830,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Dac2Sr{    ///<status register
        using Addr = Register::Address<0x40009834,0xdfffdfff,0x00000000,std::uint32_t>;
