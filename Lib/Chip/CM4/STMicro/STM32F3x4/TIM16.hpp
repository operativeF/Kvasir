...
//General-purpose-timers
    ...
    namespace Tim16Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001440c,0xffff9c1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Sr{    ///<status register
        using Addr = Register::Address<0x40014410,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Egr{    ///<event generation register
        using Addr = Register::Address<0x40014414,0xffffff1c,0x00000000,std::uint32_t>;
        ///Break generation
    ...
    namespace Tim16Or{    ///<option register
        using Addr = Register::Address<0x40014450,0xffffffff,0x00000000,std::uint32_t>;
    }
}
