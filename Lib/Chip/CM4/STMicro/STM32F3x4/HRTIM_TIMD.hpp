...
//High Resolution Timer: TIMD
    namespace HrtimTimdTimdcr{    ///<Timerx Control Register
        using Addr = Register::Address<0x40017600,0x00090380,0x00000000,std::uint32_t>;
        ///Update Gating
    ...
    namespace HrtimTimdTimdisr{    ///<Timerx Interrupt Status          Register
        using Addr = Register::Address<0x40017604,0xffc08020,0x00000000,std::uint32_t>;
        ///Output 2 Copy
    ...
    namespace HrtimTimdTimdicr{    ///<Timerx Interrupt Clear          Register
        using Addr = Register::Address<0x40017608,0xffff8020,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdTimddier5{    ///<TIMxDIER5
        using Addr = Register::Address<0x4001760c,0x80208020,0x00000000,std::uint32_t>;
        ///DLYPRTDE
    ...
    namespace HrtimTimdCntdr{    ///<Timerx Counter Register
        using Addr = Register::Address<0x40017610,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdPerdr{    ///<Timerx Period Register
        using Addr = Register::Address<0x40017614,0xffff0000,0x00000000,std::uint32_t>;
        ///Timerx Period value
    ...
    namespace HrtimTimdRepdr{    ///<Timerx Repetition Register
        using Addr = Register::Address<0x40017618,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCmp1dr{    ///<Timerx Compare 1 Register
        using Addr = Register::Address<0x4001761c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCmp1cdr{    ///<Timerx Compare 1 Compound          Register
        using Addr = Register::Address<0x40017620,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCmp2dr{    ///<Timerx Compare 2 Register
        using Addr = Register::Address<0x40017624,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCmp3dr{    ///<Timerx Compare 3 Register
        using Addr = Register::Address<0x40017628,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCmp4dr{    ///<Timerx Compare 4 Register
        using Addr = Register::Address<0x4001762c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCpt1dr{    ///<Timerx Capture 1 Register
        using Addr = Register::Address<0x40017630,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdCpt2dr{    ///<Timerx Capture 2 Register
        using Addr = Register::Address<0x40017634,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdDtdr{    ///<Timerx Deadtime Register
        using Addr = Register::Address<0x40017638,0x3c002000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdSetd1r{    ///<Timerx Output1 Set Register
        using Addr = Register::Address<0x4001763c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdRstd1r{    ///<Timerx Output1 Reset Register
        using Addr = Register::Address<0x40017640,0x00000000,0x00000000,std::uint32_t>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimdSetd2r{    ///<Timerx Output2 Set Register
        using Addr = Register::Address<0x40017644,0x00000000,0x00000000,std::uint32_t>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimdRstd2r{    ///<Timerx Output2 Reset Register
        using Addr = Register::Address<0x40017648,0x00000000,0x00000000,std::uint32_t>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimdEefdr1{    ///<Timerx External Event Filtering Register          1
        using Addr = Register::Address<0x4001764c,0xe0820820,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdEefdr2{    ///<Timerx External Event Filtering Register          2
        using Addr = Register::Address<0x40017650,0xe0820820,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdRstdr{    ///<TimerA Reset Register
        using Addr = Register::Address<0x40017654,0x80000001,0x00000000,std::uint32_t>;
        ///Timer E Compare 4
    ...
    namespace HrtimTimdChpdr{    ///<Timerx Chopper Register
        using Addr = Register::Address<0x40017658,0xfffff800,0x00000000,std::uint32_t>;
        ///STRTPW
    ...
    namespace HrtimTimdCpt1dcr{    ///<Timerx Capture 2 Control          Register
        using Addr = Register::Address<0x4001765c,0x0f000000,0x00000000,std::uint32_t>;
        ///Timer E Compare 2
    ...
    namespace HrtimTimdCpt2dcr{    ///<CPT2xCR
        using Addr = Register::Address<0x40017660,0x0f000000,0x00000000,std::uint32_t>;
        ///Timer E Compare 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> tecmp2{}; 
        ///Timer E Compare 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> tecmp1{}; 
    ...
    namespace HrtimTimdOutdr{    ///<Timerx Output Register
        using Addr = Register::Address<0x40017664,0xff01e001,0x00000000,std::uint32_t>;
    ...
    namespace HrtimTimdFltdr{    ///<Timerx Fault Register
        using Addr = Register::Address<0x40017668,0x7fffffe0,0x00000000,std::uint32_t>;
        ///Fault sources Lock
