...
//Advanced-timers
    namespace Tim8Cr1{    ///<control register 1
        using Addr = Register::Address<0x40013400,0xfffff400,0x00000000,std::uint32_t>;
        ///Counter enable
    ...
    namespace Tim8Cr2{    ///<control register 2
        using Addr = Register::Address<0x40013404,0xff0a8002,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40013408,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Sr{    ///<status register
        using Addr = Register::Address<0x40013410,0xfffce000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Egr{    ///<event generation register
        using Addr = Register::Address<0x40013414,0xfffffe00,0x00000000,std::uint32_t>;
        ///Update generation
    ...
    namespace Tim8Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40013418,0xfefe0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccmr2Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x4001341c,0xfefe0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40013420,0xffcc4000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Cnt{    ///<counter
        using Addr = Register::Address<0x40013424,0x7fff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim8Rcr{    ///<repetition counter register
        using Addr = Register::Address<0x40013430,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40013444,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Ccmr3Output{    ///<capture/compare mode register 3 (output          mode)
        using Addr = Register::Address<0x40013454,0xfefe0303,0x00000000,std::uint32_t>;
    ...
    namespace Tim8Or{    ///<option registers
        using Addr = Register::Address<0x40013460,0xfffffff0,0x00000000,std::uint32_t>;
