...
//Reset and clock control
    ...
    namespace RccApb1rstr1{    ///<APB1 peripheral reset register          1
        using Addr = Register::Address<0x40021038,0x0d013dce,0x00000000,std::uint32_t>;
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register
        using Addr = Register::Address<0x40021040,0xffdca3fe,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1enr1{    ///<APB1ENR1
        using Addr = Register::Address<0x40021058,0x081931ce,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1smenr1{    ///<APB1SMENR1
        using Addr = Register::Address<0x40021078,0x091931ce,0x00000000,std::uint32_t>;
    ...
    namespace RccCcipr{    ///<CCIPR
        using Addr = Register::Address<0x40021088,0x830003c0,0x00000000,std::uint32_t>;
