...
//Clock recovery system
    namespace CrsCr{    ///<control register
        using Addr = Register::Address<0x40006000,0xffffc010,0x00000000,std::uint32_t>;
    ...
    namespace CrsCfgr{    ///<configuration register
        using Addr = Register::Address<0x40006004,0x48000000,0x00000000,std::uint32_t>;
    ...
    namespace CrsIsr{    ///<interrupt and status register
        using Addr = Register::Address<0x40006008,0x000078f0,0x00000000,std::uint32_t>;
    ...
    namespace CrsIcr{    ///<interrupt flag clear register
        using Addr = Register::Address<0x4000600c,0xfffffff0,0x00000000,std::uint32_t>;
