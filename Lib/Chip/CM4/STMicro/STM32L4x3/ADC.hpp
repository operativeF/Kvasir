...
//Analog-to-Digital Converter
    ...
    namespace AdcCfgr{    ///<configuration register
    ...
    namespace AdcCfgr2{    ///<configuration register
    ...
    namespace AdcTr1{    ///<watchdog threshold register 1
    ...
    namespace AdcTr2{    ///<watchdog threshold register
    ...
    namespace AdcTr3{    ///<watchdog threshold register 3
    ...
    namespace AdcOfr1{    ///<offset register 1
    ...
    namespace AdcOfr2{    ///<offset register 2
    ...
    namespace AdcOfr3{    ///<offset register 3
    ...
    namespace AdcOfr4{    ///<offset register 4
    ...
    namespace AdcJdr1{    ///<injected data register 1
    ...
    namespace AdcJdr2{    ///<injected data register 2
    ...
    namespace AdcJdr3{    ///<injected data register 3
    ...
    namespace AdcJdr4{    ///<injected data register 4
    ...
    namespace AdcAwd2cr{    ///<Analog Watchdog 2 Configuration          Register
    ...
    namespace AdcAwd3cr{    ///<Analog Watchdog 3 Configuration          Register
    ...
    namespace AdcDifsel{    ///<Differential Mode Selection Register          2
    ...
    namespace AdcCalfact{    ///<Calibration Factors
