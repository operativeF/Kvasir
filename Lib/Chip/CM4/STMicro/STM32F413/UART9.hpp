...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart9Sr{    ///<Status register
        using Addr = Register::Address<0x40011800,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Uart9Dr{    ///<Data register
        using Addr = Register::Address<0x40011804,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> dr{}; 
    }
    namespace Uart9Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40011808,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Uart9Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4001180c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Uart9Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011810,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart9Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011814,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Uart9Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40011818,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
