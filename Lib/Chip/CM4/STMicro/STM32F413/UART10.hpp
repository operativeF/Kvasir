...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart10Sr{    ///<Status register
        using Addr = Register::Address<0x40011c00,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Uart10Dr{    ///<Data register
        using Addr = Register::Address<0x40011c04,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> dr{}; 
    }
    namespace Uart10Brr{    ///<Baud rate register
    ...
    namespace Uart10Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011c0c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Uart10Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011c10,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart10Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011c14,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Uart10Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40011c18,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
