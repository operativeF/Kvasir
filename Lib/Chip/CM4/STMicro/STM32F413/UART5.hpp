...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart5Sr{    ///<Status register
        using Addr = Register::Address<0x40005000,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Uart5Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40005010,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart5Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40005014,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Uart5Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40005018,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
