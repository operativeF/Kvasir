...
//System configuration controller
    ...
    namespace SyscfgI2cBufout{    ///<I2C_BUFOUT
        using Addr = Register::Address<0x4001382c,0xfffffffc,0x00000000,std::uint32_t>;
        ///I2C4SCL
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> i2c4scl{}; 
        ///I2C4SDA
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> i2c4sda{}; 
    }
}
