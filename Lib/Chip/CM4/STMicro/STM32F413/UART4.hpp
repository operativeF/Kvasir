...
//Universal synchronous asynchronous receiver      transmitter
    namespace Uart4Sr{    ///<Status register
        using Addr = Register::Address<0x40004c00,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Uart4Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40004c0c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Uart4Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004c10,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Uart4Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004c14,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Uart4Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40004c18,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
