...
//FLASH
    ...
    namespace FlashOptcr{    ///<Flash option control register
        using Addr = Register::Address<0x40023c14,0x7fe00010,0x00000000,std::uint32_t>;
        ///Option lock
        ...
        ///Not write protect
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,16),Register::ReadWriteAccess,unsigned> nwrp{}; 
        ///SPRMOD
