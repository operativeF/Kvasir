...
//Low power timer
    ...
    namespace Lptim1Cr{    ///<Control Register
        using Addr = Register::Address<0x40002410,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace Lptim1Optr{    ///<Option Register
        using Addr = Register::Address<0x40002420,0xfffffffc,0x00000000,std::uint32_t>;
        ///OR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> or_{}; 
    }
}
