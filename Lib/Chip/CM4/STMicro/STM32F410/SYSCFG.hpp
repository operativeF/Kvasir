...
//System configuration controller
    ...
    namespace SyscfgPmc{    ///<peripheral mode configuration          register
        using Addr = Register::Address<0x40013804,0xfffeffff,0x00000000,std::uint32_t>;
        ///ADC1DC2
    ...
    namespace SyscfgCmpcr{    ///<Compensation cell control          register
        using Addr = Register::Address<0x40013820,0xfffffefe,0x00000000,std::uint32_t>;
        ///READY
    ...
    namespace SyscfgCfgr{    ///<Configuration register
        using Addr = Register::Address<0x4001382c,0xfffffffc,0x00000000,std::uint32_t>;
        ///FMPI2C1_SCL
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> fmpi2c1Scl{}; 
        ///FMPI2C1_SDA
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> fmpi2c1Sda{}; 
    }
}
