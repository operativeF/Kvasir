...
//Generation 2008 Watchdog Timer
    namespace WdogStctrlh{    ///<Watchdog Status and Control Register High
        using Addr = Register::Address<0x40052000,0xffff8300,0x00000000,std::uint16_t>;
        ...
        ///Enables updates to watchdog write once registers, after initial configuration window (WCT) closes, through unlock sequence
    ...
    namespace WdogStctrll{    ///<Watchdog Status and Control Register Low
        using Addr = Register::Address<0x40052002,0xffff7fff,0x00000000,std::uint16_t>;
        ///Interrupt flag
    ...
    namespace WdogUnlock{    ///<Watchdog Unlock Register
        ...
        ///You can write the unlock sequence values to this register to make the watchdog write once registers writable again
    ...
    namespace WdogPresc{    ///<Watchdog Prescaler Register
        using Addr = Register::Address<0x40052016,0xfffff8ff,0x00000000,std::uint16_t>;
