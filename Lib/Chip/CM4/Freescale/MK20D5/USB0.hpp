...
//Universal Serial Bus, OTG Capable Controller
    ...
    namespace Usb0Otgstat{    ///<OTG Status Register
        ...
        ///This bit indicates that the internal signals that control the LINE_STATE_CHG bit (bit 5) of the OTGISTAT register have been stable for at least 1 millisecond
    ...
    namespace Usb0Istat{    ///<Interrupt Status Register
        ...
        ///This bit is set when any of the error conditions within the ERRSTAT register occur
    ...
    namespace Usb0Ctl{    ///<Control Register
        ...
        ///When the USB Module is in Host mode TOKEN_BUSY is set when the USB Module is busy executing a USB token and no more token commands should be written to the Token Register
    ...
    namespace Usb0Bdtpage2{    ///<BDT Page Register 2
        ...
        ///This 8 bit field provides address bits 23 through 16 of the BDT base address, which defines where the Buffer Descriptor Table resides in system memory
    ...
    namespace Usb0Bdtpage3{    ///<BDT Page Register 3
        ...
        ///This 8 bit field provides address bits 31 through 24 of the BDT base address, which defines where the Buffer Descriptor Table resides in system memory
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> bdtba{}; 
    }
