...
//FlexTimer Module
    ...
    namespace Ftm0C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003800c,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
        ...
        enum class IcrstVal {
            v0=0x00000000,     ///<FTM counter is not reset when the selected channel (n) input event is detected.
            v1=0x00000001,     ///<FTM counter is reset when the selected channel (n) input event is detected.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,IcrstVal> icrst{}; 
        namespace IcrstValC{
            constexpr Register::FieldValue<decltype(icrst)::Type,IcrstVal::v0> v0{};
            constexpr Register::FieldValue<decltype(icrst)::Type,IcrstVal::v1> v1{};
        }
    ...
    namespace Ftm0C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40038014,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003801c,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40038024,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003802c,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40038034,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
