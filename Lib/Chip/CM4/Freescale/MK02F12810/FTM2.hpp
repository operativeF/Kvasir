...
//FlexTimer Module
    namespace Ftm2Sc{    ///<Status And Control
        using Addr = Register::Address<0x4003a000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Cnt{    ///<Counter
        using Addr = Register::Address<0x4003a004,0xffff0000,0x00000000,std::uint32_t>;
        ///Counter Value
    ...
    namespace Ftm2Mod{    ///<Modulo
        using Addr = Register::Address<0x4003a008,0xffff0000,0x00000000,std::uint32_t>;
        ///Modulo Value
    ...
    namespace Ftm2Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4003a04c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x4003a050,0xffffff00,0x00000000,std::uint32_t>;
        ///Channel 0 Flag
        enum class Ch0fVal {
    ...
    namespace Ftm2Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x4003a054,0xffffff00,0x00000000,std::uint32_t>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm2Sync{    ///<Synchronization
        using Addr = Register::Address<0x4003a058,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4003a05c,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Outmask{    ///<Output Mask
        using Addr = Register::Address<0x4003a060,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x4003a064,0x80808080,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x4003a068,0xffffff00,0x00000000,std::uint32_t>;
        ///Deadtime Value
    ...
    namespace Ftm2Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4003a06c,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x4003a070,0xffffff00,0x00000000,std::uint32_t>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm2Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x4003a074,0xffffff10,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x4003a078,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4003a07c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x4003a080,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Conf{    ///<Configuration
        using Addr = Register::Address<0x4003a084,0xfffff920,0x00000000,std::uint32_t>;
        ///TOF Frequency
    ...
    namespace Ftm2Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x4003a088,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4003a08c,0xffe0e04a,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x4003a090,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x4003a094,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm2Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x4003a098,0xfffffd00,0x00000000,std::uint32_t>;
        ///Channel 0 Select
    ...
    namespace Ftm2C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a00c,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
    ...
    namespace Ftm2C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a014,0xffffff00,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm2C0v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4003a010,0xffff0000,0x00000000,std::uint32_t>;
        ///Channel Value
    ...
    namespace Ftm2C1v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4003a018,0xffff0000,0x00000000,std::uint32_t>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
}
