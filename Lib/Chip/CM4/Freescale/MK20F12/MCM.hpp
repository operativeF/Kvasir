...
//Core Platform Miscellaneous Control Module
    ...
    namespace McmIscr{    ///<Interrupt Status and control Register
        using Addr = Register::Address<0xe0080010,0x60ef60e1,0x00000000,std::uint32_t>;
    ...
    namespace McmFadr{    ///<Fault address register
        using Addr = Register::Address<0xe0080020,0x00000000,0x00000000,std::uint32_t>;
        ///Fault address
    ...
    namespace McmFatr{    ///<Fault attributes register
        using Addr = Register::Address<0xe0080024,0x7ffff04c,0x00000000,std::uint32_t>;
    ...
    namespace McmFdr{    ///<Fault data register
        using Addr = Register::Address<0xe0080028,0x00000000,0x00000000,std::uint32_t>;
        ///Fault data
    ...
    namespace McmPid{    ///<Process ID register
        using Addr = Register::Address<0xe0080030,0xffffff00,0x00000000,std::uint32_t>;
