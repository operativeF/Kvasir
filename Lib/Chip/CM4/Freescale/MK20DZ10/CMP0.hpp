...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    ...
    namespace Cmp0Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x40073003,0xffffff80,0x00000000,std::uint8_t>;
        ...
        namespace SmelbValC{
            constexpr Register::FieldValue<decltype(smelb)::Type,SmelbVal::v0> v0{};
            constexpr Register::FieldValue<decltype(smelb)::Type,SmelbVal::v1> v1{};
        }
        ///DMA Enable Control
        enum class DmaenVal {
    ...
    namespace Cmp0Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x40073005,0xffffff00,0x00000000,std::uint8_t>;
        ...
        namespace PenValC{
            constexpr Register::FieldValue<decltype(pen)::Type,PenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(pen)::Type,PenVal::v1> v1{};
        }
    }
}
