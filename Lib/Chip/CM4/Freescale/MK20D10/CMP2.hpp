...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    ...
    namespace Cmp2Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x40073015,0xffffff80,0x00000000,std::uint8_t>;
        ...
        enum class PstmVal {
            ...
            v1=0x00000001,     ///<Pass Through Mode is enabled.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,PstmVal> pstm{}; 
        namespace PstmValC{
