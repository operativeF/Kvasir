...
//Programmable Delay Block
    ...
    namespace Pdb0Dacintc0{    ///<DAC Interval Trigger n Control Register
        ...
        enum class ExtVal {
            v0=0x00000000,     ///<DAC external trigger input disabled. DAC interval counter is reset and counting starts when a rising edge is detected on selected trigger input source or software trigger is selected and SWTRIG is written with 1.
