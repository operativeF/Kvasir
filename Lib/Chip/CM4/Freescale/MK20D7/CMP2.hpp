...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    namespace Cmp2Cr0{    ///<CMP Control Register 0
        using Addr = Register::Address<0x40073010,0xffffff8c,0x00000000,std::uint8_t>;
    ...
    namespace Cmp2Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40073011,0xffffff20,0x00000000,std::uint8_t>;
        ...
        enum class OpeVal {
            v0=0x00000000,     ///<The comparator output (CMPO) is not available on the associated CMPO output pin. Instead, the INV bit is driven if the comparator owns the pin (usually a result of properly setting pin mux controls at the SoC level). If the comparator does not own the pin, this bit has no effect.
            v1=0x00000001,     ///<The comparator output (CMPO) is available on the associated CMPO output pin. The comparator output (CMPO) is driven out on the associated CMPO output pin if the comparator owns the pin. If the comparator does not own the pin, this bit has no effect.
        };
    ...
    namespace Cmp2Fpr{    ///<CMP Filter Period Register
        using Addr = Register::Address<0x40073012,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace Cmp2Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x40073013,0xffffffa0,0x00000000,std::uint8_t>;
    ...
    namespace Cmp2Daccr{    ///<DAC Control Register
        using Addr = Register::Address<0x40073014,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace Cmp2Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x40073015,0xffffffc0,0x00000000,std::uint8_t>;
