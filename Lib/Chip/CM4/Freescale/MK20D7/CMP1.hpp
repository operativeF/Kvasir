...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    namespace Cmp1Cr0{    ///<CMP Control Register 0
        using Addr = Register::Address<0x40073008,0xffffff8c,0x00000000,std::uint8_t>;
    ...
    namespace Cmp1Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40073009,0xffffff20,0x00000000,std::uint8_t>;
    ...
    namespace Cmp1Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x4007300b,0xffffffa0,0x00000000,std::uint8_t>;
    ...
    namespace Cmp1Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x4007300d,0xffffffc0,0x00000000,std::uint8_t>;
