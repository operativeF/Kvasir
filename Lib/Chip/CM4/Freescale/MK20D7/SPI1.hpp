...
//Deserial Serial Peripheral Interface
    namespace Spi1Mcr{    ///<DSPI Module Configuration Register
        using Addr = Register::Address<0x4002d000,0x00c000fe,0x00000000,std::uint32_t>;
        ///Halt
        enum class HaltVal {
    ...
    namespace Spi1Tcr{    ///<DSPI Transfer Count Register
        using Addr = Register::Address<0x4002d008,0x0000ffff,0x00000000,std::uint32_t>;
    ...
    namespace Spi1CtarSlave{    ///<DSPI Clock and Transfer Attributes Register (In Slave Mode)
        using Addr = Register::Address<0x4002d00c,0x01ffffff,0x00000000,std::uint32_t>;
        ///Clock Phase
        enum class CphaVal {
    ...
    namespace Spi1Sr{    ///<DSPI Status Register
        using Addr = Register::Address<0x4002d02c,0x25f50000,0x00000000,std::uint32_t>;
        ///Pop Next Pointer
    ...
    namespace Spi1Rser{    ///<DSPI DMA/Interrupt Request Select and Enable Register
        using Addr = Register::Address<0x4002d030,0x64f4ffff,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Pushr{    ///<DSPI PUSH TX FIFO Register In Master Mode
        using Addr = Register::Address<0x4002d034,0x03c00000,0x00000000,std::uint32_t>;
        ///Transmit Data
    ...
    namespace Spi1PushrSlave{    ///<DSPI PUSH TX FIFO Register In Slave Mode
    ...
    namespace Spi1Popr{    ///<DSPI POP RX FIFO Register
    ...
    namespace Spi1Ctar0{    ///<DSPI Clock and Transfer Attributes Register (In Master Mode)
    ...
    namespace Spi1Ctar1{    ///<DSPI Clock and Transfer Attributes Register (In Master Mode)
