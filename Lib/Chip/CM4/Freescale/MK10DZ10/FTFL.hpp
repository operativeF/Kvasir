...
//Flash Memory Interface
    ...
    namespace FtflFcnfg{    ///<Flash Configuration Register
        ...
        ///FTFL configuration
        enum class PflshVal {
            v0=0x00000000,     ///<For devices with FlexNVM: FTFL configured for FlexMemory that supports data flash and/or EEPROM For devices with program flash only: Reserved
            v1=0x00000001,     ///<For devices with FlexNVM: Reserved For devices with program flash only: FTFL configured for program flash only, without support for data flash and/or EEPROM
        };
