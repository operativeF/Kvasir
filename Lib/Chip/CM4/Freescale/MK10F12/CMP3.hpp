...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    namespace Cmp3Cr0{    ///<CMP Control Register 0
        using Addr = Register::Address<0x40073018,0xffffff8c,0x00000000,std::uint8_t>;
    ...
    namespace Cmp3Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40073019,0xffffff20,0x00000000,std::uint8_t>;
    ...
    namespace Cmp3Fpr{    ///<CMP Filter Period Register
        using Addr = Register::Address<0x4007301a,0xffffff00,0x00000000,std::uint8_t>;
        ///Filter Sample Period
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> filtPer{}; 
    }
    namespace Cmp3Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x4007301b,0xffffffa0,0x00000000,std::uint8_t>;
    ...
    namespace Cmp3Daccr{    ///<DAC Control Register
        using Addr = Register::Address<0x4007301c,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace Cmp3Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x4007301d,0xffffffc0,0x00000000,std::uint8_t>;
