...
//Flash Memory Interface
    ...
    namespace FtfeFcnfg{    ///<Flash Configuration Register
        ...
        ///Swap
        enum class SwapVal {
            v0=0x00000000,     ///<For devices with FlexNVM: Logical program flash 0 block is located at relative address 0x0000 For devices with program flash only: Logical program flash 0/1 blocks are located at relative address 0x0000
            v1=0x00000001,     ///<For devices with FlexNVM: Logical program flash 1 block is located at relative address 0x0000 For devices with program flash only: Logical program flash 2/3 blocks are located at relative address 0x0000
        };
