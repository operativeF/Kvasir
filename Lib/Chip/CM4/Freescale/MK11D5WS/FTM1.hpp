...
//FlexTimer Module
    namespace Ftm1Sc{    ///<Status And Control
        using Addr = Register::Address<0x40039000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Cnt{    ///<Counter
        using Addr = Register::Address<0x40039004,0x00000000,0x00000000,std::uint32_t>;
        ///Counter Value
    ...
    namespace Ftm1Mod{    ///<Modulo
        using Addr = Register::Address<0x40039008,0x00000000,0x00000000,std::uint32_t>;
        ///no description available
    ...
    namespace Ftm1Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4003904c,0x00000000,0x00000000,std::uint32_t>;
        ///no description available
    ...
    namespace Ftm1Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x40039050,0x00000000,0x00000000,std::uint32_t>;
        ///Channel 0 Flag
        enum class Ch0fVal {
    ...
    namespace Ftm1Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x40039054,0x00000000,0x00000000,std::uint32_t>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm1Sync{    ///<Synchronization
        using Addr = Register::Address<0x40039058,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4003905c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Outmask{    ///<Output Mask
        using Addr = Register::Address<0x40039060,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x40039064,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x40039068,0x00000000,0x00000000,std::uint32_t>;
        ///Deadtime Value
    ...
    namespace Ftm1Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4003906c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x40039070,0x00000000,0x00000000,std::uint32_t>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm1Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x40039074,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x40039078,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4003907c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x40039080,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Conf{    ///<Configuration
        using Addr = Register::Address<0x40039084,0x00000000,0x00000000,std::uint32_t>;
        ///TOF Frequency
    ...
    namespace Ftm1Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x40039088,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4003908c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x40039090,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x40039094,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ftm1Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x40039098,0x00000000,0x00000000,std::uint32_t>;
        ///Channel 0 Select
    ...
    namespace Ftm1C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003900c,0x00000000,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
    ...
    namespace Ftm1C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40039014,0x00000000,0x00000000,std::uint32_t>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm1C0v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40039010,0x00000000,0x00000000,std::uint32_t>;
        ///Channel Value
    ...
    namespace Ftm1C1v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40039018,0x00000000,0x00000000,std::uint32_t>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
