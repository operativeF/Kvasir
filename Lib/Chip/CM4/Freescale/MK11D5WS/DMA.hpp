...
//Enhanced direct memory access controller
    namespace DmaCr{    ///<Control Register
        using Addr = Register::Address<0x40008000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace DmaEs{    ///<Error Status Register
        ...
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,17),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///no description available
        enum class VldVal {
    ...
    namespace DmaCeei{    ///<Clear Enable Error Interrupt Register
        using Addr = Register::Address<0x40008018,0xffffff00,0x00000000,std::uint8_t>;
        ...
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace DmaSeei{    ///<Set Enable Error Interrupt Register
        using Addr = Register::Address<0x40008019,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace DmaCerq{    ///<Clear Enable Request Register
        using Addr = Register::Address<0x4000801a,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace DmaSerq{    ///<Set Enable Request Register
        using Addr = Register::Address<0x4000801b,0xffffff00,0x00000000,std::uint8_t>;
        ///Set enable request
    ...
    namespace DmaCdne{    ///<Clear DONE Status Bit Register
        using Addr = Register::Address<0x4000801c,0xffffff00,0x00000000,std::uint8_t>;
        ///Clear DONE Bit
    ...
    namespace DmaSsrt{    ///<Set START Bit Register
        using Addr = Register::Address<0x4000801d,0xffffff00,0x00000000,std::uint8_t>;
        ///Set START Bit
    ...
    namespace DmaCerr{    ///<Clear Error Register
        using Addr = Register::Address<0x4000801e,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace DmaCint{    ///<Clear Interrupt Request Register
        using Addr = Register::Address<0x4000801f,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace DmaTcd0Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000901c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
    ...
    namespace DmaTcd1Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000903c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd2Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000905c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd3Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000907c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd4Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000909c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd5Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x400090bc,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd6Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x400090dc,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd7Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x400090fc,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd8Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000911c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd9Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000913c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd10Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000915c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd11Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000917c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd12Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x4000919c,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd13Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x400091bc,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd14Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x400091dc,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
    ...
    namespace DmaTcd15Csr{    ///<TCD Control and Status
        using Addr = Register::Address<0x400091fc,0xffff0000,0x00000000,std::uint16_t>;
        ///Channel Start
        enum class StartVal {
            v0=0x00000000,     ///<The channel is not explicitly started
            v1=0x00000001,     ///<The channel is explicitly started via a software initiated service request
