...
//Inter-Integrated Circuit
    namespace I2c0A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x40066000,0xffffff00,0x00000000,std::uint8_t>;
    ...
    namespace I2c0Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x40066007,0xffffff00,0x00000000,std::uint8_t>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///Range Slave Address
    ...
    namespace I2c0A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x40066009,0xffffff00,0x00000000,std::uint8_t>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///SMBus Address
