...
//Control Area Network 1
    namespace Can1Crel{    ///<Core Release
        using Addr = Register::Address<0x42000400,0x000fffff,0x00000000,std::uint32_t>;
    ...
    namespace Can1Endn{    ///<Endian
        using Addr = Register::Address<0x42000404,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Mrcfg{    ///<Message RAM Configuration
        using Addr = Register::Address<0x42000408,0xfffffffc,0x00000000,std::uint32_t>;
        ///Quality of Service
        enum class QosVal {
    ...
    namespace Can1Dbtp{    ///<Fast Bit Timing and Prescaler
        using Addr = Register::Address<0x4200040c,0xff60e000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Test{    ///<Test
        using Addr = Register::Address<0x42000410,0xffffff0f,0x00000000,std::uint32_t>;
        ///Loop Back Mode
    ...
    namespace Can1Rwd{    ///<RAM Watchdog
        using Addr = Register::Address<0x42000414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Cccr{    ///<CC Control
        using Addr = Register::Address<0x42000418,0xffff0c00,0x00000000,std::uint32_t>;
        ///Initialization
    ...
    namespace Can1Nbtp{    ///<Nominal Bit Timing and Prescaler
        using Addr = Register::Address<0x4200041c,0x00000080,0x00000000,std::uint32_t>;
    ...
    namespace Can1Tscc{    ///<Timestamp Counter Configuration
        using Addr = Register::Address<0x42000420,0xfff0fffc,0x00000000,std::uint32_t>;
        ///Timestamp Select
        enum class TssVal {
    ...
    namespace Can1Tscv{    ///<Timestamp Counter Value
        using Addr = Register::Address<0x42000424,0xffff0000,0x00000000,std::uint32_t>;
        ///Timestamp Counter
    ...
    namespace Can1Tocc{    ///<Timeout Counter Configuration
        using Addr = Register::Address<0x42000428,0x0000fff8,0x00000000,std::uint32_t>;
    ...
    namespace Can1Tocv{    ///<Timeout Counter Value
        using Addr = Register::Address<0x4200042c,0xffff0000,0x00000000,std::uint32_t>;
        ///Timeout Counter
    ...
    namespace Can1Ecr{    ///<Error Counter
        using Addr = Register::Address<0x42000440,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Psr{    ///<Protocol Status
        using Addr = Register::Address<0x42000444,0xff808000,0x00000000,std::uint32_t>;
        ///Last Error Code
        enum class LecVal {
    ...
    namespace Can1Tdcr{    ///<Extended ID Filter Configuration
        using Addr = Register::Address<0x42000448,0xffff8080,0x00000000,std::uint32_t>;
    ...
    namespace Can1Ir{    ///<Interrupt
        using Addr = Register::Address<0x42000450,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Ie{    ///<Interrupt Enable
        using Addr = Register::Address<0x42000454,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Ils{    ///<Interrupt Line Select
        using Addr = Register::Address<0x42000458,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Ile{    ///<Interrupt Line Enable
        using Addr = Register::Address<0x4200045c,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Can1Gfc{    ///<Global Filter Configuration
        using Addr = Register::Address<0x42000480,0xffffffc0,0x00000000,std::uint32_t>;
    ...
    namespace Can1Sidfc{    ///<Standard ID Filter Configuration
        using Addr = Register::Address<0x42000484,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Xidfc{    ///<Extended ID Filter Configuration
        using Addr = Register::Address<0x42000488,0xff800000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Xidam{    ///<Extended ID AND Mask
        using Addr = Register::Address<0x42000490,0xe0000000,0x00000000,std::uint32_t>;
        ///Extended ID Mask
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(28,0),Register::ReadWriteAccess,unsigned> eidm{}; 
    }
    namespace Can1Hpms{    ///<High Priority Message Status
        using Addr = Register::Address<0x42000494,0xffff0000,0x00000000,std::uint32_t>;
        ///Buffer Index
    ...
    namespace Can1Ndat1{    ///<New Data 1
        using Addr = Register::Address<0x42000498,0x00000000,0x00000000,std::uint32_t>;
        ///New Data 0
    ...
    namespace Can1Ndat2{    ///<New Data 2
        using Addr = Register::Address<0x4200049c,0x00000000,0x00000000,std::uint32_t>;
        ///New Data 32
    ...
    namespace Can1Rxf0c{    ///<Rx FIFO 0 Configuration
        using Addr = Register::Address<0x420004a0,0x00800000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Rxf0s{    ///<Rx FIFO 0 Status
        using Addr = Register::Address<0x420004a4,0xfcc0c080,0x00000000,std::uint32_t>;
    ...
    namespace Can1Rxf0a{    ///<Rx FIFO 0 Acknowledge
        using Addr = Register::Address<0x420004a8,0xffffffc0,0x00000000,std::uint32_t>;
    ...
    namespace Can1Rxbc{    ///<Rx Buffer Configuration
        using Addr = Register::Address<0x420004ac,0xffff0000,0x00000000,std::uint32_t>;
        ///Rx Buffer Start Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> rbsa{}; 
    }
    namespace Can1Rxf1c{    ///<Rx FIFO 1 Configuration
        using Addr = Register::Address<0x420004b0,0x00800000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Rxf1s{    ///<Rx FIFO 1 Status
        using Addr = Register::Address<0x420004b4,0x3cc0c080,0x00000000,std::uint32_t>;
    ...
    namespace Can1Rxf1a{    ///<Rx FIFO 1 Acknowledge
        using Addr = Register::Address<0x420004b8,0xffffffc0,0x00000000,std::uint32_t>;
    ...
    namespace Can1Rxesc{    ///<Rx Buffer / FIFO Element Size Configuration
        using Addr = Register::Address<0x420004bc,0xfffff888,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbc{    ///<Tx Buffer Configuration
        using Addr = Register::Address<0x420004c0,0x80c00000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txfqs{    ///<Tx FIFO / Queue Status
        using Addr = Register::Address<0x420004c4,0xffc0e0c0,0x00000000,std::uint32_t>;
        ///Tx FIFO Free Level
    ...
    namespace Can1Txesc{    ///<Tx Buffer Element Size Configuration
        using Addr = Register::Address<0x420004c8,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbrp{    ///<Tx Buffer Request Pending
        using Addr = Register::Address<0x420004cc,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbar{    ///<Tx Buffer Add Request
        using Addr = Register::Address<0x420004d0,0x00000000,0x00000000,std::uint32_t>;
        ///Add Request 0
    ...
    namespace Can1Txbcr{    ///<Tx Buffer Cancellation Request
        using Addr = Register::Address<0x420004d4,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbto{    ///<Tx Buffer Transmission Occurred
        using Addr = Register::Address<0x420004d8,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbcf{    ///<Tx Buffer Cancellation Finished
        using Addr = Register::Address<0x420004dc,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbtie{    ///<Tx Buffer Transmission Interrupt Enable
        using Addr = Register::Address<0x420004e0,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txbcie{    ///<Tx Buffer Cancellation Finished Interrupt Enable
        using Addr = Register::Address<0x420004e4,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txefc{    ///<Tx Event FIFO Configuration
        using Addr = Register::Address<0x420004f0,0xc0c00000,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txefs{    ///<Tx Event FIFO Status
        using Addr = Register::Address<0x420004f4,0xfce0e0c0,0x00000000,std::uint32_t>;
    ...
    namespace Can1Txefa{    ///<Tx Event FIFO Acknowledge
        using Addr = Register::Address<0x420004f8,0xffffffe0,0x00000000,std::uint32_t>;
