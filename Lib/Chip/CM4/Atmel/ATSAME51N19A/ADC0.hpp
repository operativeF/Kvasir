...
//Analog Digital Converter 0
    namespace Adc0Ctrla{    ///<Control A
        using Addr = Register::Address<0x43001c00,0xffff7804,0x00000000,std::uint16_t>;
        ///Software Reset
    ...
    namespace Adc0Evctrl{    ///<Event Control
        using Addr = Register::Address<0x43001c02,0xffffffc0,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Dbgctrl{    ///<Debug Control
        using Addr = Register::Address<0x43001c03,0xfffffffe,0x00000000,std::uint8_t>;
        ///Debug Run
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> dbgrun{}; 
    }
    namespace Adc0Inputctrl{    ///<Input Control
        using Addr = Register::Address<0x43001c04,0xffff6060,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Ctrlb{    ///<Control B
        using Addr = Register::Address<0x43001c06,0xfffff0e0,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Refctrl{    ///<Reference Control
        using Addr = Register::Address<0x43001c08,0xffffff70,0x00000000,std::uint8_t>;
        ///Reference Selection
    ...
    namespace Adc0Avgctrl{    ///<Average Control
        using Addr = Register::Address<0x43001c0a,0xffffff80,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Sampctrl{    ///<Sample Time Control
        using Addr = Register::Address<0x43001c0b,0xffffff40,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Winlt{    ///<Window Monitor Lower Threshold
        using Addr = Register::Address<0x43001c0c,0xffff0000,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Winut{    ///<Window Monitor Upper Threshold
        using Addr = Register::Address<0x43001c0e,0xffff0000,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Gaincorr{    ///<Gain Correction
        using Addr = Register::Address<0x43001c10,0xfffff000,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Offsetcorr{    ///<Offset Correction
        using Addr = Register::Address<0x43001c12,0xfffff000,0x00000000,std::uint16_t>;
        ///Offset Correction Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> offsetcorr{}; 
    }
    namespace Adc0Swtrig{    ///<Software Trigger
        using Addr = Register::Address<0x43001c14,0xfffffffc,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Intenclr{    ///<Interrupt Enable Clear
        using Addr = Register::Address<0x43001c2c,0xfffffff8,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Intenset{    ///<Interrupt Enable Set
        using Addr = Register::Address<0x43001c2d,0xfffffff8,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Intflag{    ///<Interrupt Flag Status and Clear
        using Addr = Register::Address<0x43001c2e,0xfffffff8,0x00000000,std::uint8_t>;
    ...
    namespace Adc0Status{    ///<Status
        using Addr = Register::Address<0x43001c2f,0xffffff02,0x00000000,std::uint8_t>;
        ///ADC Busy Status
    ...
    namespace Adc0Syncbusy{    ///<Synchronization Busy
        using Addr = Register::Address<0x43001c30,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc0Dseqdata{    ///<DMA Sequencial Data
        using Addr = Register::Address<0x43001c34,0x00000000,0x00000000,std::uint32_t>;
        ///DMA Sequential Data
    ...
    namespace Adc0Dseqctrl{    ///<DMA Sequential Control
        using Addr = Register::Address<0x43001c38,0x7ffffe00,0x00000000,std::uint32_t>;
        ///Input Control
    ...
    namespace Adc0Dseqstat{    ///<DMA Sequencial Status
        using Addr = Register::Address<0x43001c3c,0x7ffffe00,0x00000000,std::uint32_t>;
        ///Input Control
    ...
    namespace Adc0Result{    ///<Result Conversion Value
        using Addr = Register::Address<0x43001c40,0xffff0000,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Ress{    ///<Last Sample Result
        using Addr = Register::Address<0x43001c44,0xffff0000,0x00000000,std::uint16_t>;
    ...
    namespace Adc0Calib{    ///<Calibration
        using Addr = Register::Address<0x43001c48,0xfffff888,0x00000000,std::uint16_t>;
