...
//Special Function Registers
    namespace SfrOhciicr{    ///<OHCI Interrupt Configuration Register
        using Addr = Register::Address<0xf0038010,0xff7fffc8,0x00000000,std::uint32_t>;
        ///USB PORTx RESET
    ...
    namespace SfrOhciisr{    ///<OHCI Interrupt Status Register
        using Addr = Register::Address<0xf0038014,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace SfrAhb{    ///<AHB Configuration Register
        using Addr = Register::Address<0xf0038020,0x83ff83ff,0x00000000,std::uint32_t>;
    ...
    namespace SfrBridge{    ///<Bridge Configuration Register
        using Addr = Register::Address<0xf0038024,0xfffffefe,0x00000000,std::uint32_t>;
    ...
    namespace SfrSecure{    ///<Security Configuration Register
        using Addr = Register::Address<0xf0038028,0xfffffefe,0x00000000,std::uint32_t>;
    ...
    namespace SfrUtmicktrim{    ///<UTMI Clock Trimming Register
        using Addr = Register::Address<0xf0038030,0xfff0fffc,0x00000000,std::uint32_t>;
    ...
    namespace SfrUtmihstrim{    ///<UTMI High Speed Trimming Register
        using Addr = Register::Address<0xf0038034,0xfff88888,0x00000000,std::uint32_t>;
    ...
    namespace SfrUtmifstrim{    ///<UTMI Full Speed Trimming Register
        using Addr = Register::Address<0xf0038038,0xff88fc88,0x00000000,std::uint32_t>;
    ...
    namespace SfrUtmiswap{    ///<UTMI DP/DM Pin Swapping Register
        using Addr = Register::Address<0xf003803c,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace SfrEbicfg{    ///<EBI Configuration Register
        using Addr = Register::Address<0xf0038040,0xfffee0e0,0x00000000,std::uint32_t>;
