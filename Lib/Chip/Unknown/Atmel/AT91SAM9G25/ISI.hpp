...
//Image Sensor Interface
    namespace IsiCfg1{    ///<ISI Configuration 1 Register
        using Addr = Register::Address<0xf8048000,0x00008023,0x00000000,std::uint32_t>;
    ...
    namespace IsiCfg2{    ///<ISI Configuration 2 Register
        using Addr = Register::Address<0xf8048004,0x08000000,0x00000000,std::uint32_t>;
    ...
    namespace IsiPsize{    ///<ISI Preview Size Register
        using Addr = Register::Address<0xf8048008,0xfc00fc00,0x00000000,std::uint32_t>;
    ...
    namespace IsiPdecf{    ///<ISI Preview Decimation Factor Register
        using Addr = Register::Address<0xf804800c,0xffffff00,0x00000000,std::uint32_t>;
        ///Decimation Factor
    ...
    namespace IsiY2rSet0{    ///<ISI CSC YCrCb To RGB Set 0 Register
        using Addr = Register::Address<0xf8048010,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace IsiY2rSet1{    ///<ISI CSC YCrCb To RGB Set 1 Register
        using Addr = Register::Address<0xf8048014,0xffff8e00,0x00000000,std::uint32_t>;
    ...
    namespace IsiR2ySet0{    ///<ISI CSC RGB To YCrCb Set 0 Register
        using Addr = Register::Address<0xf8048018,0xfe808080,0x00000000,std::uint32_t>;
        ///Color Space Conversion Matrix Coefficient C0
    ...
    namespace IsiR2ySet1{    ///<ISI CSC RGB To YCrCb Set 1 Register
        using Addr = Register::Address<0xf804801c,0xfe808080,0x00000000,std::uint32_t>;
        ///Color Space Conversion Matrix Coefficient C3
    ...
    namespace IsiR2ySet2{    ///<ISI CSC RGB To YCrCb Set 2 Register
        using Addr = Register::Address<0xf8048020,0xfe808080,0x00000000,std::uint32_t>;
    ...
    namespace IsiCr{    ///<ISI Control Register
        using Addr = Register::Address<0xf8048024,0xfffffef8,0x00000000,std::uint32_t>;
    ...
    namespace IsiSr{    ///<ISI Status Register
        using Addr = Register::Address<0xf8048028,0xf0f4faf8,0x00000000,std::uint32_t>;
        ///
    ...
    namespace IsiIer{    ///<ISI Interrupt Enable Register
        using Addr = Register::Address<0xf804802c,0xf0fcfbf9,0x00000000,std::uint32_t>;
    ...
    namespace IsiIdr{    ///<ISI Interrupt Disable Register
        using Addr = Register::Address<0xf8048030,0xf0fcfbf9,0x00000000,std::uint32_t>;
    ...
    namespace IsiImr{    ///<ISI Interrupt Mask Register
        using Addr = Register::Address<0xf8048034,0xf0fcfbf9,0x00000000,std::uint32_t>;
    ...
    namespace IsiDmaCher{    ///<DMA Channel Enable Register
        using Addr = Register::Address<0xf8048038,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace IsiDmaChdr{    ///<DMA Channel Disable Register
        using Addr = Register::Address<0xf804803c,0xfffffffc,0x00000000,std::uint32_t>;
        ///
    ...
    namespace IsiDmaChsr{    ///<DMA Channel Status Register
        using Addr = Register::Address<0xf8048040,0xfffffffc,0x00000000,std::uint32_t>;
        ///
    ...
    namespace IsiDmaPAddr{    ///<DMA Preview Base Address Register
        using Addr = Register::Address<0xf8048044,0x00000003,0x00000000,std::uint32_t>;
    ...
    namespace IsiDmaPCtrl{    ///<DMA Preview Control Register
        using Addr = Register::Address<0xf8048048,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace IsiDmaPDscr{    ///<DMA Preview Descriptor Address Register
        using Addr = Register::Address<0xf804804c,0x00000003,0x00000000,std::uint32_t>;
    ...
    namespace IsiDmaCAddr{    ///<DMA Codec Base Address Register
        using Addr = Register::Address<0xf8048050,0x00000003,0x00000000,std::uint32_t>;
    ...
    namespace IsiDmaCCtrl{    ///<DMA Codec Control Register
        using Addr = Register::Address<0xf8048054,0xfffffff0,0x00000000,std::uint32_t>;
        ///Descriptor Fetch Control Field
    ...
    namespace IsiDmaCDscr{    ///<DMA Codec Descriptor Address Register
        using Addr = Register::Address<0xf8048058,0x00000003,0x00000000,std::uint32_t>;
    ...
    namespace IsiWpcr{    ///<Write Protection Control Register
        using Addr = Register::Address<0xf80480e4,0x000000fe,0x00000000,std::uint32_t>;
    ...
    namespace IsiWpsr{    ///<Write Protection Status Register
        using Addr = Register::Address<0xf80480e8,0xff0000f0,0x00000000,std::uint32_t>;
