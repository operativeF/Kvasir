...
//Universal Synchronous Asynchronous Receiver Transmitter 0
    namespace Usart0Cr{    ///<Control Register
        using Addr = Register::Address<0xfffb0000,0xfff30003,0x00000000,std::uint32_t>;
        ///Reset Receiver
    ...
    namespace Usart0Mr{    ///<Mode Register
        using Addr = Register::Address<0xfffb0004,0x08800000,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffb0008,0xfff7c000,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffb000c,0xfff7c000,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffb0010,0xfff7c000,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfffb0014,0xfe77c000,0x00000000,std::uint32_t>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> txrdy{}; 
    ...
    namespace Usart0Rhr{    ///<Receiver Holding Register
        using Addr = Register::Address<0xfffb0018,0xffff7e00,0x00000000,std::uint32_t>;
        ///Received Character
    ...
    namespace Usart0Thr{    ///<Transmitter Holding Register
        using Addr = Register::Address<0xfffb001c,0xffff7e00,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xfffb0020,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Divider
    ...
    namespace Usart0Rtor{    ///<Receiver Time-out Register
        using Addr = Register::Address<0xfffb0024,0xffff0000,0x00000000,std::uint32_t>;
        ///Time-out Value
    ...
    namespace Usart0Ttgr{    ///<Transmitter Timeguard Register
        using Addr = Register::Address<0xfffb0028,0xffffff00,0x00000000,std::uint32_t>;
        ///Timeguard Value
    ...
    namespace Usart0Fidi{    ///<FI DI Ratio Register
        using Addr = Register::Address<0xfffb0040,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Ner{    ///<Number of Errors Register
        using Addr = Register::Address<0xfffb0044,0xffffff00,0x00000000,std::uint32_t>;
        ///Number of Errors
    ...
    namespace Usart0If{    ///<IrDA Filter Register
        using Addr = Register::Address<0xfffb004c,0xffffff00,0x00000000,std::uint32_t>;
        ///IrDA Filter
    ...
    namespace Usart0Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0xfffb0050,0x8cf0ecf0,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfffb0108,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfffb010c,0xffff0000,0x00000000,std::uint32_t>;
        ///Transmit Counter Register
    ...
    namespace Usart0Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfffb0118,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart0Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfffb011c,0xffff0000,0x00000000,std::uint32_t>;
