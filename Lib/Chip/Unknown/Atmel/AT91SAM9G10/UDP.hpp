...
//USB Device Port
    ...
    namespace UdpTxvc{    ///<Transceiver Control Register
        using Addr = Register::Address<0xfffa4074,0xfffffeff,0x00000000,std::uint32_t>;
        ///Transceiver Disable
    ...
    namespace UdpCsr0{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa402c,0xf8007000,0x00000000,std::uint32_t>;
    ...
    namespace UdpFdr0{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa404c,0xffffff00,0x00000000,std::uint32_t>;
        ///FIFO Data Value
