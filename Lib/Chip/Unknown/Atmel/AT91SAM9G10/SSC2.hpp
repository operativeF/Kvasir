...
//Synchronous Serial Controller 2
    namespace Ssc2Cr{    ///<Control Register
        using Addr = Register::Address<0xfffc4000,0xffff7cfc,0x00000000,std::uint32_t>;
        ///Receive Enable
    ...
    namespace Ssc2Cmr{    ///<Clock Mode Register
        using Addr = Register::Address<0xfffc4004,0xfffff000,0x00000000,std::uint32_t>;
        ///Clock Divider
    ...
    namespace Ssc2Rcmr{    ///<Receive Clock Mode Register
        using Addr = Register::Address<0xfffc4010,0x0000e000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc2Rfmr{    ///<Receive Frame Mode Register
        using Addr = Register::Address<0xfffc4014,0xfe80f040,0x00000000,std::uint32_t>;
        ///Data Length
    ...
    namespace Ssc2Tcmr{    ///<Transmit Clock Mode Register
        using Addr = Register::Address<0xfffc4018,0x0000f000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc2Tfmr{    ///<Transmit Frame Mode Register
        using Addr = Register::Address<0xfffc401c,0xfe00f040,0x00000000,std::uint32_t>;
        ///Data Length
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> datlen{}; 
        ///Data Default Value
    ...
    namespace Ssc2Rshr{    ///<Receive Sync. Holding Register
        using Addr = Register::Address<0xfffc4030,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc2Tshr{    ///<Transmit Sync. Holding Register
        using Addr = Register::Address<0xfffc4034,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc2Sr{    ///<Status Register
        using Addr = Register::Address<0xfffc4040,0xfffcf000,0x00000000,std::uint32_t>;
        ///Transmit Ready
    ...
    namespace Ssc2Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffc4044,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc2Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffc4048,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc2Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffc404c,0xfffff000,0x00000000,std::uint32_t>;
