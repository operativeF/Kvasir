...
//Timer Counter 0
    ...
    namespace Tc0Cv0{    ///<Counter Value (channel = 0)
        using Addr = Register::Address<0xfffa0010,0x00000000,0x00000000,std::uint32_t>;
        ///Counter Value
    ...
    namespace Tc0Ra0{    ///<Register A (channel = 0)
        using Addr = Register::Address<0xfffa0014,0x00000000,0x00000000,std::uint32_t>;
        ///Register A
    ...
    namespace Tc0Rb0{    ///<Register B (channel = 0)
        using Addr = Register::Address<0xfffa0018,0x00000000,0x00000000,std::uint32_t>;
        ///Register B
    ...
    namespace Tc0Rc0{    ///<Register C (channel = 0)
        using Addr = Register::Address<0xfffa001c,0x00000000,0x00000000,std::uint32_t>;
        ///Register C
    ...
    namespace Tc0Cv1{    ///<Counter Value (channel = 1)
        using Addr = Register::Address<0xfffa0050,0x00000000,0x00000000,std::uint32_t>;
        ///Counter Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cv{}; 
    }
    namespace Tc0Ra1{    ///<Register A (channel = 1)
        using Addr = Register::Address<0xfffa0054,0x00000000,0x00000000,std::uint32_t>;
        ///Register A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc0Rb1{    ///<Register B (channel = 1)
        using Addr = Register::Address<0xfffa0058,0x00000000,0x00000000,std::uint32_t>;
        ///Register B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc0Rc1{    ///<Register C (channel = 1)
        using Addr = Register::Address<0xfffa005c,0x00000000,0x00000000,std::uint32_t>;
        ///Register C
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    ...
    namespace Tc0Cv2{    ///<Counter Value (channel = 2)
        using Addr = Register::Address<0xfffa0090,0x00000000,0x00000000,std::uint32_t>;
        ///Counter Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cv{}; 
    }
    namespace Tc0Ra2{    ///<Register A (channel = 2)
        using Addr = Register::Address<0xfffa0094,0x00000000,0x00000000,std::uint32_t>;
        ///Register A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc0Rb2{    ///<Register B (channel = 2)
        using Addr = Register::Address<0xfffa0098,0x00000000,0x00000000,std::uint32_t>;
        ///Register B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc0Rc2{    ///<Register C (channel = 2)
        using Addr = Register::Address<0xfffa009c,0x00000000,0x00000000,std::uint32_t>;
        ///Register C
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
