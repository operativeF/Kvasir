...
//Synchronous Serial Controller 1
    namespace Ssc1Cr{    ///<Control Register
        using Addr = Register::Address<0xfffc0000,0xffff7cfc,0x00000000,std::uint32_t>;
        ///Receive Enable
    ...
    namespace Ssc1Cmr{    ///<Clock Mode Register
        using Addr = Register::Address<0xfffc0004,0xfffff000,0x00000000,std::uint32_t>;
        ///Clock Divider
    ...
    namespace Ssc1Rcmr{    ///<Receive Clock Mode Register
        using Addr = Register::Address<0xfffc0010,0x0000e000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Rfmr{    ///<Receive Frame Mode Register
        using Addr = Register::Address<0xfffc0014,0xfe80f040,0x00000000,std::uint32_t>;
        ///Data Length
    ...
    namespace Ssc1Tcmr{    ///<Transmit Clock Mode Register
        using Addr = Register::Address<0xfffc0018,0x0000f000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Tfmr{    ///<Transmit Frame Mode Register
        using Addr = Register::Address<0xfffc001c,0xfe00f040,0x00000000,std::uint32_t>;
        ///Data Length
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> datlen{}; 
        ///Data Default Value
    ...
    namespace Ssc1Rshr{    ///<Receive Sync. Holding Register
        using Addr = Register::Address<0xfffc0030,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Tshr{    ///<Transmit Sync. Holding Register
        using Addr = Register::Address<0xfffc0034,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Rc0r{    ///<Receive Compare 0 Register
        using Addr = Register::Address<0xfffc0038,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Rc1r{    ///<Receive Compare 1 Register
        using Addr = Register::Address<0xfffc003c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Sr{    ///<Status Register
        using Addr = Register::Address<0xfffc0040,0xfffcf000,0x00000000,std::uint32_t>;
        ///Transmit Ready
    ...
    namespace Ssc1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffc0044,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffc0048,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffc004c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfffc0100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfffc0104,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfffc0108,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfffc010c,0xffff0000,0x00000000,std::uint32_t>;
        ///Transmit Counter Register
    ...
    namespace Ssc1Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfffc0110,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfffc0114,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfffc0118,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfffc011c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfffc0120,0xfffffcfc,0x00000000,std::uint32_t>;
    ...
    namespace Ssc1Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfffc0124,0xfffffefe,0x00000000,std::uint32_t>;
        ///Receiver Transfer Enable
