...
//Serial Peripheral Interface 0
    ...
    namespace Spi0Sr{    ///<Status Register
        using Addr = Register::Address<0xfffc8010,0xfffefc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffc8014,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffc8018,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffc801c,0xfffffc00,0x00000000,std::uint32_t>;
