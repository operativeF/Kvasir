...
//Universal Asynchronous Receiver Transmitter 1
    namespace Uart1Cr{    ///<Control Register
        using Addr = Register::Address<0xf8044000,0xfffffe03,0x00000000,std::uint32_t>;
        ///Reset Receiver
    ...
    namespace Uart1Mr{    ///<Mode Register
        using Addr = Register::Address<0xf8044004,0xffff31ff,0x00000000,std::uint32_t>;
        ///Parity Type
        enum class ParVal {
    ...
    namespace Uart1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf8044008,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Uart1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf804400c,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Uart1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf8044010,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Uart1Sr{    ///<Status Register
        using Addr = Register::Address<0xf8044014,0xfffffd1c,0x00000000,std::uint32_t>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> txrdy{}; 
    ...
    namespace Uart1Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf8044018,0xffffff00,0x00000000,std::uint32_t>;
        ///Received Character
    ...
    namespace Uart1Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf804401c,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Uart1Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xf8044020,0xffff0000,0x00000000,std::uint32_t>;
        ///Clock Divisor
