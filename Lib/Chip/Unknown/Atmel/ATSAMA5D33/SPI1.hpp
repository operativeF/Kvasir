...
//Serial Peripheral Interface 1
    namespace Spi1Cr{    ///<Control Register
        using Addr = Register::Address<0xf8008000,0xfeffff7c,0x00000000,std::uint32_t>;
        ///SPI Enable
    ...
    namespace Spi1Mr{    ///<Mode Register
        using Addr = Register::Address<0xf8008004,0x00f0ff48,0x00000000,std::uint32_t>;
        ///Master/Slave Mode
    ...
    namespace Spi1Rdr{    ///<Receive Data Register
        using Addr = Register::Address<0xf8008008,0xfff00000,0x00000000,std::uint32_t>;
        ///Receive Data
    ...
    namespace Spi1Tdr{    ///<Transmit Data Register
        using Addr = Register::Address<0xf800800c,0xfef00000,0x00000000,std::uint32_t>;
        ///Transmit Data
    ...
    namespace Spi1Sr{    ///<Status Register
        using Addr = Register::Address<0xf8008010,0xfffef8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf8008014,0xfffff8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf8008018,0xfffff8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf800801c,0xfffff8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Wpmr{    ///<Write Protection Control Register
        using Addr = Register::Address<0xf80080e4,0x000000fe,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Wpsr{    ///<Write Protection Status Register
        using Addr = Register::Address<0xf80080e8,0xffff00fe,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Csr0{    ///<Chip Select Register
        using Addr = Register::Address<0xf8008030,0x00000000,0x00000000,std::uint32_t>;
        ///Clock Polarity
    ...
    namespace Spi1Csr1{    ///<Chip Select Register
        using Addr = Register::Address<0xf8008034,0x00000000,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr2{    ///<Chip Select Register
        using Addr = Register::Address<0xf8008038,0x00000000,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr3{    ///<Chip Select Register
        using Addr = Register::Address<0xf800803c,0x00000000,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
