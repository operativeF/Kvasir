...
//Two-wire Interface 2
    namespace Twi2Cr{    ///<Control Register
        using Addr = Register::Address<0xf801c000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0xf801c004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0xf801c008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi2Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0xf801c00c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi2Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0xf801c010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi2Sr{    ///<Status Register
        using Addr = Register::Address<0xf801c020,0xfffff080,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf801c024,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf801c028,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf801c02c,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf801c030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi2Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf801c034,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi2WprotStatus{    ///<Protection Status Register
        using Addr = Register::Address<0xf801c0e8,0x000000fe,0x00000000,std::uint32_t>;
