...
//Shutdown Controller
    namespace ShdwcCr{    ///<Shutdown Control Register
        using Addr = Register::Address<0xfffffe10,0x00fffffe,0x00000000,std::uint32_t>;
        ///Shutdown Command
    ...
    namespace ShdwcMr{    ///<Shutdown Mode Register
        using Addr = Register::Address<0xfffffe14,0xfffdff0c,0x00000000,std::uint32_t>;
        ///Wake-up Mode 0
    ...
    namespace ShdwcSr{    ///<Shutdown Status Register
        using Addr = Register::Address<0xfffffe18,0xfffdfffe,0x00000000,std::uint32_t>;
        ///Wake-up 0 Status
