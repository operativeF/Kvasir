...
//Power Management Controller
    namespace PmcPmcScer{    ///<System Clock Enable Register
        using Addr = Register::Address<0xfffffc00,0xfffffc33,0x00000000,std::uint32_t>;
        ///DDR Clock Enable
    ...
    namespace PmcPmcScdr{    ///<System Clock Disable Register
        using Addr = Register::Address<0xfffffc04,0xfffffc32,0x00000000,std::uint32_t>;
    ...
    namespace PmcPmcScsr{    ///<System Clock Status Register
        using Addr = Register::Address<0xfffffc08,0xfffffc32,0x00000000,std::uint32_t>;
    ...
    namespace PmcCkgrMcfr{    ///<Main Clock Frequency Register
        using Addr = Register::Address<0xfffffc24,0xffee0000,0x00000000,std::uint32_t>;
    ...
    namespace PmcCkgrPllbr{    ///<PLLB Register
        using Addr = Register::Address<0xfffffc2c,0xf8000000,0x00000000,std::uint32_t>;
        ///Divider B
    ...
    namespace PmcPmcIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffffc60,0xfff8fcf0,0x00000000,std::uint32_t>;
    ...
    namespace PmcPmcIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffffc64,0xfff8fcf0,0x00000000,std::uint32_t>;
    ...
    namespace PmcPmcSr{    ///<Status Register
        using Addr = Register::Address<0xfffffc68,0xffe0fc70,0x00000000,std::uint32_t>;
    ...
    namespace PmcPmcImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffffc6c,0xfff8fcf0,0x00000000,std::uint32_t>;
