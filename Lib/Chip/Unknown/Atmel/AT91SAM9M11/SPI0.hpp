...
//Serial Peripheral Interface 0
    namespace Spi0Cr{    ///<Control Register
        using Addr = Register::Address<0xfffa4000,0xfeffff7c,0x00000000,std::uint32_t>;
        ///SPI Enable
    ...
    namespace Spi0Mr{    ///<Mode Register
        using Addr = Register::Address<0xfffa4004,0x00f0ff48,0x00000000,std::uint32_t>;
        ///Master/Slave Mode
    ...
    namespace Spi0Rdr{    ///<Receive Data Register
        using Addr = Register::Address<0xfffa4008,0xfff00000,0x00000000,std::uint32_t>;
        ///Receive Data
    ...
    namespace Spi0Tdr{    ///<Transmit Data Register
        using Addr = Register::Address<0xfffa400c,0xfef00000,0x00000000,std::uint32_t>;
        ///Transmit Data
    ...
    namespace Spi0Sr{    ///<Status Register
        using Addr = Register::Address<0xfffa4010,0xfffefc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffa4014,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffa4018,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffa401c,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfffa4100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfffa4104,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfffa4108,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfffa410c,0xffff0000,0x00000000,std::uint32_t>;
        ///Transmit Counter Register
    ...
    namespace Spi0Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfffa4110,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfffa4114,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfffa4118,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfffa411c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfffa4120,0xfffffcfc,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfffa4124,0xfffffefe,0x00000000,std::uint32_t>;
        ///Receiver Transfer Enable
    ...
    namespace Spi0Csr0{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa4030,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
    ...
    namespace Spi0Csr1{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa4034,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi0Csr2{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa4038,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi0Csr3{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa403c,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
