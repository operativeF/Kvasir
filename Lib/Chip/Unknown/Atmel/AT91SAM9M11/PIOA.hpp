...
//Parallel Input/Output Controller A
    ...
    namespace PioaAsr{    ///<Peripheral A Select Register
    ...
    namespace PioaBsr{    ///<Peripheral B Select Register
    ...
    namespace PioaAbsr{    ///<AB Status Register
        using Addr = Register::Address<0xfffff278,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace PioaDelayr0{    ///<I/O Delay Register
    ...
    namespace PioaDelayr1{    ///<I/O Delay Register
    ...
    namespace PioaDelayr2{    ///<I/O Delay Register
    ...
    namespace PioaDelayr3{    ///<I/O Delay Register
        using Addr = Register::Address<0xfffff2cc,0x00000000,0x00000000,std::uint32_t>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> delay0{}; 
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> delay1{}; 
