...
//DDR_SDR SDRAM Controller 1
    namespace Ddrsdrc1Mr{    ///<DDRSDRC Mode Register
        using Addr = Register::Address<0xffffe400,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Rtr{    ///<DDRSDRC Refresh Timer Register
        using Addr = Register::Address<0xffffe404,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Cr{    ///<DDRSDRC Configuration Register
        using Addr = Register::Address<0xffffe408,0xfffa8c00,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Tpr0{    ///<DDRSDRC Timing Parameter 0 Register
        using Addr = Register::Address<0xffffe40c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Tpr1{    ///<DDRSDRC Timing Parameter 1 Register
        using Addr = Register::Address<0xffffe410,0xf00000e0,0x00000000,std::uint32_t>;
        ///Row Cycle Delay
    ...
    namespace Ddrsdrc1Tpr2{    ///<DDRSDRC Timing Parameter 2 Register
        using Addr = Register::Address<0xffffe414,0xffff8000,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Lpr{    ///<DDRSDRC Low-power Register
        using Addr = Register::Address<0xffffe41c,0xffcec088,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Md{    ///<DDRSDRC Memory Device Register
        using Addr = Register::Address<0xffffe420,0xffffffe8,0x00000000,std::uint32_t>;
        ///Memory Device
    ...
    namespace Ddrsdrc1Dll{    ///<DDRSDRC DLL Information Register
        using Addr = Register::Address<0xffffe424,0xffff00f8,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Hs{    ///<DDRSDRC High Speed Register
        using Addr = Register::Address<0xffffe42c,0xfffffffb,0x00000000,std::uint32_t>;
        ///Anticip Read Access
    ...
    namespace Ddrsdrc1Wpmr{    ///<DDRSDRC Write Protect Mode Register
        using Addr = Register::Address<0xffffe4e4,0x000000fe,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Wpsr{    ///<DDRSDRC Write Protect Status Register
        using Addr = Register::Address<0xffffe4e8,0xff0000fe,0x00000000,std::uint32_t>;
    ...
    namespace Ddrsdrc1Delay0{    ///<DDRSDRC Delay I/O Register
        using Addr = Register::Address<0xffffe440,0x00000000,0x00000000,std::uint32_t>;
        ///Delay1..Delay8
    ...
    namespace Ddrsdrc1Delay1{    ///<DDRSDRC Delay I/O Register
        using Addr = Register::Address<0xffffe444,0x00000000,0x00000000,std::uint32_t>;
        ///Delay1..Delay8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> delay1{}; 
        ///Delay1..Delay8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> delay2{}; 
    ...
    namespace Ddrsdrc1Delay2{    ///<DDRSDRC Delay I/O Register
        using Addr = Register::Address<0xffffe448,0x00000000,0x00000000,std::uint32_t>;
        ///Delay1..Delay8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> delay1{}; 
        ///Delay1..Delay8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> delay2{}; 
    ...
    namespace Ddrsdrc1Delay3{    ///<DDRSDRC Delay I/O Register
        using Addr = Register::Address<0xffffe44c,0x00000000,0x00000000,std::uint32_t>;
        ///Delay1..Delay8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> delay1{}; 
        ///Delay1..Delay8
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> delay2{}; 
