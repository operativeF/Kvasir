...
//Synchronous Serial Controller 0
    namespace Ssc0Cr{    ///<Control Register
        using Addr = Register::Address<0xfff9c000,0xffff7cfc,0x00000000,std::uint32_t>;
        ///Receive Enable
    ...
    namespace Ssc0Cmr{    ///<Clock Mode Register
        using Addr = Register::Address<0xfff9c004,0xfffff000,0x00000000,std::uint32_t>;
        ///Clock Divider
    ...
    namespace Ssc0Rcmr{    ///<Receive Clock Mode Register
        using Addr = Register::Address<0xfff9c010,0x0000e000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Rfmr{    ///<Receive Frame Mode Register
        using Addr = Register::Address<0xfff9c014,0x0e80f040,0x00000000,std::uint32_t>;
        ///Data Length
    ...
    namespace Ssc0Tcmr{    ///<Transmit Clock Mode Register
        using Addr = Register::Address<0xfff9c018,0x0000f000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Tfmr{    ///<Transmit Frame Mode Register
        using Addr = Register::Address<0xfff9c01c,0x0e00f040,0x00000000,std::uint32_t>;
        ///Data Length
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> datlen{}; 
        ///Data Default Value
    ...
    namespace Ssc0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xfff9c020,0x00000000,0x00000000,std::uint32_t>;
        ///Receive Data
    ...
    namespace Ssc0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xfff9c024,0x00000000,0x00000000,std::uint32_t>;
        ///Transmit Data
    ...
    namespace Ssc0Rshr{    ///<Receive Sync. Holding Register
        using Addr = Register::Address<0xfff9c030,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Tshr{    ///<Transmit Sync. Holding Register
        using Addr = Register::Address<0xfff9c034,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Rc0r{    ///<Receive Compare 0 Register
        using Addr = Register::Address<0xfff9c038,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Rc1r{    ///<Receive Compare 1 Register
        using Addr = Register::Address<0xfff9c03c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Sr{    ///<Status Register
        using Addr = Register::Address<0xfff9c040,0xfffcf000,0x00000000,std::uint32_t>;
        ///Transmit Ready
    ...
    namespace Ssc0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff9c044,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff9c048,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff9c04c,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfff9c100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfff9c104,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfff9c108,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfff9c10c,0xffff0000,0x00000000,std::uint32_t>;
        ///Transmit Counter Register
    ...
    namespace Ssc0Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfff9c110,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfff9c114,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfff9c118,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfff9c11c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfff9c120,0xfffffcfc,0x00000000,std::uint32_t>;
    ...
    namespace Ssc0Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfff9c124,0xfffffefe,0x00000000,std::uint32_t>;
        ///Receiver Transfer Enable
