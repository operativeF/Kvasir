...
//General Purpose Backup Register
    namespace GpbrGpbr0{    ///<General Purpose Backup Register 0
        using Addr = Register::Address<0xfffffd60,0x00000000,0x00000000,std::uint32_t>;
        ///Value of GPBR x
    ...
    namespace GpbrGpbr1{    ///<General Purpose Backup Register 1
        using Addr = Register::Address<0xfffffd64,0x00000000,0x00000000,std::uint32_t>;
        ///Value of GPBR x
    ...
    namespace GpbrGpbr2{    ///<General Purpose Backup Register 2
        using Addr = Register::Address<0xfffffd68,0x00000000,0x00000000,std::uint32_t>;
        ///Value of GPBR x
    ...
    namespace GpbrGpbr3{    ///<General Purpose Backup Register 3
        using Addr = Register::Address<0xfffffd6c,0x00000000,0x00000000,std::uint32_t>;
        ///Value of GPBR x
