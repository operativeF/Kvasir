...
//Real-time Timer
    namespace RttMr{    ///<Mode Register
        using Addr = Register::Address<0xfffffd20,0xfff80000,0x00000000,std::uint32_t>;
    ...
    namespace RttAr{    ///<Alarm Register
        using Addr = Register::Address<0xfffffd24,0x00000000,0x00000000,std::uint32_t>;
        ///Alarm Value
    ...
    namespace RttVr{    ///<Value Register
        using Addr = Register::Address<0xfffffd28,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace RttSr{    ///<Status Register
        using Addr = Register::Address<0xfffffd2c,0xfffffffc,0x00000000,std::uint32_t>;
