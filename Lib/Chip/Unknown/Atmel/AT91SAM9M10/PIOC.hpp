...
//Parallel Input/Output Controller C
    ...
    namespace PiocAbsr{    ///<AB Status Register
        using Addr = Register::Address<0xfffff678,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace PiocDelayr0{    ///<I/O Delay Register
    ...
    namespace PiocDelayr1{    ///<I/O Delay Register
    ...
    namespace PiocDelayr2{    ///<I/O Delay Register
    ...
    namespace PiocDelayr3{    ///<I/O Delay Register
        using Addr = Register::Address<0xfffff6cc,0x00000000,0x00000000,std::uint32_t>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> delay0{}; 
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> delay1{}; 
