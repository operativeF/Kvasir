...
//Two-wire Interface 0
    namespace Twi0Cr{    ///<Control Register
        using Addr = Register::Address<0xfff84000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0xfff84004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0xfff84008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi0Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0xfff8400c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi0Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0xfff84010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi0Sr{    ///<Status Register
        using Addr = Register::Address<0xfff84020,0xfffff080,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff84024,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff84028,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff8402c,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xfff84030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xfff84034,0xffffff00,0x00000000,std::uint32_t>;
