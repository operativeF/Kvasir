...
//Two-wire Interface 1
    namespace Twi1Cr{    ///<Control Register
        using Addr = Register::Address<0xfff88000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0xfff88004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0xfff88008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi1Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0xfff8800c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi1Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0xfff88010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi1Sr{    ///<Status Register
        using Addr = Register::Address<0xfff88020,0xfffff080,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff88024,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff88028,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff8802c,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xfff88030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xfff88034,0xffffff00,0x00000000,std::uint32_t>;
