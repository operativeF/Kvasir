...
//Serial Peripheral Interface 1
    namespace Spi1Cr{    ///<Control Register
        using Addr = Register::Address<0xfffa8000,0xfeffff7c,0x00000000,std::uint32_t>;
        ///SPI Enable
    ...
    namespace Spi1Mr{    ///<Mode Register
        using Addr = Register::Address<0xfffa8004,0x00f0ff48,0x00000000,std::uint32_t>;
        ///Master/Slave Mode
    ...
    namespace Spi1Rdr{    ///<Receive Data Register
        using Addr = Register::Address<0xfffa8008,0xfff00000,0x00000000,std::uint32_t>;
        ///Receive Data
    ...
    namespace Spi1Tdr{    ///<Transmit Data Register
        using Addr = Register::Address<0xfffa800c,0xfef00000,0x00000000,std::uint32_t>;
        ///Transmit Data
    ...
    namespace Spi1Sr{    ///<Status Register
        using Addr = Register::Address<0xfffa8010,0xfffefc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffa8014,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffa8018,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffa801c,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Csr0{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa8030,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
    ...
    namespace Spi1Csr1{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa8034,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr2{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa8038,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr3{    ///<Chip Select Register
        using Addr = Register::Address<0xfffa803c,0x00000004,0x00000000,std::uint32_t>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
