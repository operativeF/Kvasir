...
//Power Management Controller
    namespace PmcPmcScer{    ///<System Clock Enable Register
        using Addr = Register::Address<0xfffffc00,0xfffffc23,0x00000000,std::uint32_t>;
        ///DDR Clock Enable
    ...
    namespace PmcPmcScdr{    ///<System Clock Disable Register
        using Addr = Register::Address<0xfffffc04,0xfffffc22,0x00000000,std::uint32_t>;
    ...
    namespace PmcPmcScsr{    ///<System Clock Status Register
        using Addr = Register::Address<0xfffffc08,0xfffffc22,0x00000000,std::uint32_t>;
