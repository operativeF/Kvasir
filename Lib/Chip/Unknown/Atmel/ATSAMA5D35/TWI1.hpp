...
//Two-wire Interface 1
    namespace Twi1Cr{    ///<Control Register
        using Addr = Register::Address<0xf0018000,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0xf0018004,0xff80ecff,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0xf0018008,0xff80ffff,0x00000000,std::uint32_t>;
        ///Slave Address
    ...
    namespace Twi1Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0xf001800c,0xff000000,0x00000000,std::uint32_t>;
        ///Internal Address
    ...
    namespace Twi1Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0xf0018010,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Low Divider
    ...
    namespace Twi1Sr{    ///<Status Register
        using Addr = Register::Address<0xf0018020,0xfffff080,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf0018024,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf0018028,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf001802c,0xfffff088,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf0018030,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf0018034,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Twi1WprotMode{    ///<Protection Mode Register
        using Addr = Register::Address<0xf00180e4,0x000000fe,0x00000000,std::uint32_t>;
    ...
    namespace Twi1WprotStatus{    ///<Protection Status Register
        using Addr = Register::Address<0xf00180e8,0x000000fe,0x00000000,std::uint32_t>;
