...
//Serial Peripheral Interface 0
    ...
    namespace Spi0Sr{    ///<Status Register
        using Addr = Register::Address<0xf0004010,0xfffef8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf0004014,0xfffff8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf0004018,0xfffff8f0,0x00000000,std::uint32_t>;
    ...
    namespace Spi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf000401c,0xfffff8f0,0x00000000,std::uint32_t>;
