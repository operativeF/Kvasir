...
//Universal Synchronous Asynchronous Receiver Transmitter 3
    namespace Usart3Cr{    ///<Control Register
        using Addr = Register::Address<0xfffd0000,0xfff00003,0x00000000,std::uint32_t>;
        ///Reset Receiver
    ...
    namespace Usart3Mr{    ///<Mode Register
        using Addr = Register::Address<0xfffd0004,0x08800000,0x00000000,std::uint32_t>;
        ///
    ...
    namespace Usart3Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffd0008,0xfef0c000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffd000c,0xfef0c000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffd0010,0xfef0c000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfffd0014,0xfe00c000,0x00000000,std::uint32_t>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> txrdy{}; 
    ...
    namespace Usart3Rhr{    ///<Receiver Holding Register
        using Addr = Register::Address<0xfffd0018,0xffff7e00,0x00000000,std::uint32_t>;
        ///Received Character
    ...
    namespace Usart3Thr{    ///<Transmitter Holding Register
        using Addr = Register::Address<0xfffd001c,0xffff7e00,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xfffd0020,0xfff80000,0x00000000,std::uint32_t>;
        ///Clock Divider
    ...
    namespace Usart3Rtor{    ///<Receiver Time-out Register
        using Addr = Register::Address<0xfffd0024,0xffff0000,0x00000000,std::uint32_t>;
        ///Time-out Value
    ...
    namespace Usart3Ttgr{    ///<Transmitter Timeguard Register
        using Addr = Register::Address<0xfffd0028,0xffffff00,0x00000000,std::uint32_t>;
        ///Timeguard Value
    ...
    namespace Usart3Fidi{    ///<FI DI Ratio Register
        using Addr = Register::Address<0xfffd0040,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Ner{    ///<Number of Errors Register
        using Addr = Register::Address<0xfffd0044,0xffffff00,0x00000000,std::uint32_t>;
        ///Number of Errors
    ...
    namespace Usart3If{    ///<IrDA Filter Register
        using Addr = Register::Address<0xfffd004c,0xffffff00,0x00000000,std::uint32_t>;
        ///IrDA Filter
    ...
    namespace Usart3Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0xfffd0050,0x8cf0ecf0,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfffd0100,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfffd0104,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfffd0108,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfffd010c,0xffff0000,0x00000000,std::uint32_t>;
        ///Transmit Counter Register
    ...
    namespace Usart3Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfffd0110,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfffd0114,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfffd0118,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfffd011c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfffd0120,0xfffffcfc,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfffd0124,0xfffffefe,0x00000000,std::uint32_t>;
        ///Receiver Transfer Enable
