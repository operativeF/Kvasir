...
//Reset Controller
    namespace RstcCr{    ///<Control Register
        using Addr = Register::Address<0xfffffd00,0x00fffff2,0x00000000,std::uint32_t>;
        ///Processor Reset
    ...
    namespace RstcSr{    ///<Status Register
        using Addr = Register::Address<0xfffffd04,0xfffcf8fe,0x00000000,std::uint32_t>;
        ///User Reset Status
    ...
    namespace RstcMr{    ///<Mode Register
        using Addr = Register::Address<0xfffffd08,0x00fff0ff,0x00000000,std::uint32_t>;
