...
//Universal Asynchronous Receiver Transmitter 0
    namespace Uart0Cr{    ///<Control Register
        using Addr = Register::Address<0xf0024000,0xfffffe03,0x00000000,std::uint32_t>;
        ///Reset Receiver
    ...
    namespace Uart0Mr{    ///<Mode Register
        using Addr = Register::Address<0xf0024004,0xffff31ff,0x00000000,std::uint32_t>;
        ///Parity Type
        enum class ParVal {
    ...
    namespace Uart0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf0024008,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Uart0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf002400c,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Uart0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf0024010,0xfffffd1c,0x00000000,std::uint32_t>;
    ...
    namespace Uart0Sr{    ///<Status Register
        using Addr = Register::Address<0xf0024014,0xfffffd1c,0x00000000,std::uint32_t>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> txrdy{}; 
    ...
    namespace Uart0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf0024018,0xffffff00,0x00000000,std::uint32_t>;
        ///Received Character
    ...
    namespace Uart0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf002401c,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Uart0Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xf0024020,0xffff0000,0x00000000,std::uint32_t>;
        ///Clock Divisor
