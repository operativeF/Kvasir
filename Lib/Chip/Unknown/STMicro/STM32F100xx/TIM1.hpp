...
//Advanced timer
    ...
    namespace Tim1Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40012c18,0xfff87000,0x00000000,std::uint32_t>;
        ///Input capture 2 filter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,15),Register::ReadWriteAccess,unsigned> ic2f{}; 
    ...
    namespace Tim1Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x40012c1c,0xfff87000,0x00000000,std::uint32_t>;
        ///Input capture 4 filter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,15),Register::ReadWriteAccess,unsigned> ic4f{}; 
