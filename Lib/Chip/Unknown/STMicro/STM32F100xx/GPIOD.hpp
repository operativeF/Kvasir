...
namespace Kvasir {
//General purpose I/O
    namespace GpiodCrl{    ///<Port configuration register low          (GPIOn_CRL)
    ...
    namespace GpiodCrh{    ///<Port configuration register high          (GPIOn_CRL)
        using Addr = Register::Address<0x40011404,0x00000000,0x00000000,std::uint32_t>;
        ///Port n.8 mode bits
    ...
    namespace GpiodIdr{    ///<Port input data register          (GPIOn_IDR)
        using Addr = Register::Address<0x40011408,0xffff0000,0x00000000,std::uint32_t>;
        ///Port input data
    ...
    namespace GpiodOdr{    ///<Port output data register          (GPIOn_ODR)
    ...
    namespace GpiodBsrr{    ///<Port bit set/reset register          (GPIOn_BSRR)
        using Addr = Register::Address<0x40011410,0x00000000,0x00000000,std::uint32_t>;
        ///Set bit 0
    ...
    namespace GpiodBrr{    ///<Port bit reset register          (GPIOn_BRR)
        using Addr = Register::Address<0x40011414,0xffff0000,0x00000000,std::uint32_t>;
        ///Reset bit 0
    ...
    namespace GpiodLckr{    ///<Port configuration lock          register
        using Addr = Register::Address<0x40011418,0xfffe0000,0x00000000,std::uint32_t>;
        ///Port A Lock bit 0
