...
//Real time clock
    namespace RtcCrh{    ///<RTC Control Register High
        using Addr = Register::Address<0x40002800,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace RtcCrl{    ///<RTC Control Register Low
        using Addr = Register::Address<0x40002804,0xffffffc0,0x00000000,std::uint32_t>;
        ///Second Flag
    ...
    namespace RtcPrlh{    ///<RTC Prescaler Load Register          High
        using Addr = Register::Address<0x40002808,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace RtcDivh{    ///<RTC Prescaler Divider Register          High
        using Addr = Register::Address<0x40002810,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace RtcCntl{    ///<RTC Counter Register Low
        using Addr = Register::Address<0x4000281c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace RtcAlrh{    ///<RTC Alarm Register High
        using Addr = Register::Address<0x40002820,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace RtcAlrl{    ///<RTC Alarm Register Low
        using Addr = Register::Address<0x40002824,0xffff0000,0x00000000,std::uint32_t>;
