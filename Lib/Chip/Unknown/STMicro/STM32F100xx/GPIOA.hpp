...
//General purpose I/O
    namespace GpioaCrl{    ///<Port configuration register low          (GPIOn_CRL)
        using Addr = Register::Address<0x40010800,0x00000000,0x00000000,std::uint32_t>;
        ///Port n.0 mode bits
    ...
    namespace GpioaCrh{    ///<Port configuration register high          (GPIOn_CRL)
        using Addr = Register::Address<0x40010804,0x00000000,0x00000000,std::uint32_t>;
        ///Port n.8 mode bits
    ...
    namespace GpioaIdr{    ///<Port input data register          (GPIOn_IDR)
        using Addr = Register::Address<0x40010808,0xffff0000,0x00000000,std::uint32_t>;
        ///Port input data
    ...
    namespace GpioaOdr{    ///<Port output data register          (GPIOn_ODR)
        using Addr = Register::Address<0x4001080c,0xffff0000,0x00000000,std::uint32_t>;
        ///Port output data
    ...
    namespace GpioaBsrr{    ///<Port bit set/reset register          (GPIOn_BSRR)
        using Addr = Register::Address<0x40010810,0x00000000,0x00000000,std::uint32_t>;
        ///Set bit 0
    ...
    namespace GpioaBrr{    ///<Port bit reset register          (GPIOn_BRR)
        using Addr = Register::Address<0x40010814,0xffff0000,0x00000000,std::uint32_t>;
        ///Reset bit 0
    ...
    namespace GpioaLckr{    ///<Port configuration lock          register
        using Addr = Register::Address<0x40010818,0xfffe0000,0x00000000,std::uint32_t>;
        ///Port A Lock bit 0
