...
namespace Kvasir {
//General purpose I/O
    namespace GpiocCrl{    ///<Port configuration register low          (GPIOn_CRL)
    ...
    namespace GpiocCrh{    ///<Port configuration register high          (GPIOn_CRL)
        using Addr = Register::Address<0x40011004,0x00000000,0x00000000,std::uint32_t>;
        ///Port n.8 mode bits
    ...
    namespace GpiocIdr{    ///<Port input data register          (GPIOn_IDR)
        using Addr = Register::Address<0x40011008,0xffff0000,0x00000000,std::uint32_t>;
        ///Port input data
    ...
    namespace GpiocOdr{    ///<Port output data register          (GPIOn_ODR)
    ...
    namespace GpiocBsrr{    ///<Port bit set/reset register          (GPIOn_BSRR)
        using Addr = Register::Address<0x40011010,0x00000000,0x00000000,std::uint32_t>;
        ///Set bit 0
    ...
    namespace GpiocBrr{    ///<Port bit reset register          (GPIOn_BRR)
        using Addr = Register::Address<0x40011014,0xffff0000,0x00000000,std::uint32_t>;
        ///Reset bit 0
    ...
    namespace GpiocLckr{    ///<Port configuration lock          register
        using Addr = Register::Address<0x40011018,0xfffe0000,0x00000000,std::uint32_t>;
        ///Port A Lock bit 0
