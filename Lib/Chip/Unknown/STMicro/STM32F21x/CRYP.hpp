...
//Cryptographic processor
    namespace CrypCr{    ///<control register
        using Addr = Register::Address<0x50060000,0xffff3c03,0x00000000,std::uint32_t>;
        ...
        ///Algorithm mode
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,3),Register::ReadWriteAccess,unsigned> algomode{}; 
        ///Algorithm direction
