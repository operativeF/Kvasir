...
//Debug support
    namespace DbgmcuIdcode{    ///<MCU Device ID Code Register
        using Addr = Register::Address<0x40015800,0x00000000,0x00000000,std::uint32_t>;
        ///Device Identifier
    ...
    namespace DbgmcuCr{    ///<Debug MCU Configuration          Register
        using Addr = Register::Address<0x40015804,0xfffffff9,0x00000000,std::uint32_t>;
        ///Debug Stop Mode
    ...
    namespace DbgmcuApblfz{    ///<APB Low Freeze Register
        using Addr = Register::Address<0x40015808,0xffdfe2ec,0x00000000,std::uint32_t>;
    ...
    namespace DbgmcuApbhfz{    ///<APB High Freeze Register
        using Addr = Register::Address<0x4001580c,0xfff8f7ff,0x00000000,std::uint32_t>;
