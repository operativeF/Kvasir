...
//General-purpose-timers
    ...
    namespace Tim16Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001440c,0xffffbc1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40014418,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim16Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40014444,0xffff0000,0x00000000,std::uint32_t>;
        ///Main output enable
