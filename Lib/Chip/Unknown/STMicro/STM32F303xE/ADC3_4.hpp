...
//Analog-to-Digital Converter
    namespace Adc34Csr{    ///<ADC Common status register
        using Addr = Register::Address<0x50000700,0xf800f800,0x00000000,std::uint32_t>;
        ///ADDRDY_MST
    ...
    namespace Adc34Ccr{    ///<ADC common control register
        using Addr = Register::Address<0x50000708,0xfe3c10e0,0x00000000,std::uint32_t>;
    ...
    namespace Adc34Cdr{    ///<ADC common regular data register for dual           and triple modes
        using Addr = Register::Address<0x5000070c,0x00000000,0x00000000,std::uint32_t>;
