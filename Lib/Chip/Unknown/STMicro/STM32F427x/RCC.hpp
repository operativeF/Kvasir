...
//Reset and clock control
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register
        using Addr = Register::Address<0x40023824,0xffc886cc,0x00000000,std::uint32_t>;
        ///TIM1 reset
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable          register
        using Addr = Register::Address<0x40023844,0xffc880cc,0x00000000,std::uint32_t>;
        ///TIM1 clock enable
    ...
    namespace RccAhb1lpenr{    ///<AHB1 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023850,0x81906e00,0x00000000,std::uint32_t>;
    ...
    namespace RccApb2lpenr{    ///<APB2 peripheral clock enabled in low power          mode register
        using Addr = Register::Address<0x40023864,0xffc880cc,0x00000000,std::uint32_t>;
