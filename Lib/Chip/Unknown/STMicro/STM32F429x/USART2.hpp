...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart2Sr{    ///<Status register
        using Addr = Register::Address<0x40004400,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Usart2Dr{    ///<Data register
        using Addr = Register::Address<0x40004404,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
    ...
    namespace Usart2Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40004408,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4000440c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Usart2Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004410,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Usart2Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004414,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40004418,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
