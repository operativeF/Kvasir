...
//Serial peripheral interface
    ...
    namespace Spi6Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015404,0xffffff08,0x00000000,std::uint32_t>;
    ...
    namespace Spi6Sr{    ///<status register
        using Addr = Register::Address<0x40015408,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Spi6I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001541c,0xfffff040,0x00000000,std::uint32_t>;
        ///I2S mode selection
