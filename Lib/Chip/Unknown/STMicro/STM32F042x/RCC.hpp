...
//Reset and clock control
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register           (RCC_APB2RSTR)
        using Addr = Register::Address<0x4002100c,0xffb9a5fe,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register           (RCC_APB1RSTR)
        using Addr = Register::Address<0x40021010,0xa55db6fc,0x00000000,std::uint32_t>;
        ///Timer 2 reset
    ...
    namespace RccAhbenr{    ///<AHB Peripheral Clock enable register           (RCC_AHBENR)
        using Addr = Register::Address<0x40021014,0xfeb1ffaa,0x00000000,std::uint32_t>;
        ///DMA1 clock enable
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable register           (RCC_APB2ENR)
        using Addr = Register::Address<0x40021018,0xffb9a5fe,0x00000000,std::uint32_t>;
        ///SYSCFG clock enable
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable register           (RCC_APB1ENR)
        using Addr = Register::Address<0x4002101c,0x855db6fc,0x00000000,std::uint32_t>;
    ...
    namespace RccAhbrstr{    ///<AHB peripheral reset register
        using Addr = Register::Address<0x40021028,0xfeb1ffff,0x00000000,std::uint32_t>;
        ///I/O port A reset
