...
//General-purpose-timers
    namespace Tim17Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014800,0xfffffc70,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim17Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001480c,0xffffbc1c,0x00000000,std::uint32_t>;
    ...
    namespace Tim17Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40014844,0xffff0000,0x00000000,std::uint32_t>;
        ///Main output enable
