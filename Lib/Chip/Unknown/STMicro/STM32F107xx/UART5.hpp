...
//Universal asynchronous receiver      transmitter
    ...
    namespace Uart5Cr1{    ///<UART5 CR1
        using Addr = Register::Address<0x4000500c,0xffffc000,0x00000000,std::uint32_t>;
        ///SBK
    ...
    namespace Uart5Cr3{    ///<UART5 CR3
        using Addr = Register::Address<0x40005014,0xffffff70,0x00000000,std::uint32_t>;
