...
//USB on the go full speed
    namespace UsbOtgGlobalFsGotgctl{    ///<OTG_FS control and status register          (OTG_FS_GOTGCTL)
    ...
    namespace UsbOtgGlobalFsGotgint{    ///<OTG_FS interrupt register          (OTG_FS_GOTGINT)
    ...
    namespace UsbOtgGlobalFsGahbcfg{    ///<OTG_FS AHB configuration register          (OTG_FS_GAHBCFG)
    ...
    namespace UsbOtgGlobalFsGusbcfg{    ///<OTG_FS USB configuration register          (OTG_FS_GUSBCFG)
        using Addr = Register::Address<0x5000000c,0x1fffc078,0x00000000,std::uint32_t>;
        ///FS timeout calibration
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> tocal{}; 
        ///Full Speed serial transceiver              select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> physel{}; 
        ///SRP-capable
    ...
    namespace UsbOtgGlobalFsGrstctl{    ///<OTG_FS reset register          (OTG_FS_GRSTCTL)
    ...
    namespace UsbOtgGlobalFsGintsts{    ///<OTG_FS core interrupt register          (OTG_FS_GINTSTS)
    ...
    namespace UsbOtgGlobalFsGintmsk{    ///<OTG_FS interrupt mask register          (OTG_FS_GINTMSK)
    ...
    namespace UsbOtgGlobalFsGrxstsrDevice{    ///<OTG_FS Receive status debug read(Device          mode)
    ...
    namespace UsbOtgGlobalFsGrxstsrHost{    ///<OTG_FS Receive status debug read(Host          mode)
        using Addr = Register::Address<0x5000001c,0xfe000000,0x00000000,std::uint32_t>;
        ///Endpoint number
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> epnum{}; 
        ///Byte count
    ...
    namespace UsbOtgGlobalFsGrxfsiz{    ///<OTG_FS Receive FIFO size register          (OTG_FS_GRXFSIZ)
    ...
    namespace UsbOtgGlobalFsGnptxfsizDevice{    ///<OTG_FS non-periodic transmit FIFO size          register (Device mode)
    ...
    namespace UsbOtgGlobalFsGnptxfsizHost{    ///<OTG_FS non-periodic transmit FIFO size          register (Host mode)
        using Addr = Register::Address<0x50000028,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace UsbOtgGlobalFsGnptxsts{    ///<OTG_FS non-periodic transmit FIFO/queue          status register (OTG_FS_GNPTXSTS)
    ...
    namespace UsbOtgGlobalFsGccfg{    ///<OTG_FS general core configuration register          (OTG_FS_GCCFG)
    ...
    namespace UsbOtgGlobalFsCid{    ///<core ID register
    ...
    namespace UsbOtgGlobalFsHptxfsiz{    ///<OTG_FS Host periodic transmit FIFO size          register (OTG_FS_HPTXFSIZ)
    ...
    namespace UsbOtgGlobalFsDieptxf1{    ///<OTG_FS device IN endpoint transmit FIFO size          register (OTG_FS_DIEPTXF2)
    ...
    namespace UsbOtgGlobalFsDieptxf2{    ///<OTG_FS device IN endpoint transmit FIFO size          register (OTG_FS_DIEPTXF3)
    ...
    namespace UsbOtgGlobalFsDieptxf3{    ///<OTG_FS device IN endpoint transmit FIFO size          register (OTG_FS_DIEPTXF4)
