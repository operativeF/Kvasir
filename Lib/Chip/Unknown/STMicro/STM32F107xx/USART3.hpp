...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart3Sr{    ///<Status register
        using Addr = Register::Address<0x40004800,0xfffffc00,0x00000000,std::uint32_t>;
        ///CTS flag
    ...
    namespace Usart3Dr{    ///<Data register
        using Addr = Register::Address<0x40004804,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
    ...
    namespace Usart3Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40004808,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4000480c,0xffffc000,0x00000000,std::uint32_t>;
        ///USART enable
    ...
    namespace Usart3Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004810,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Usart3Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004814,0xfffff800,0x00000000,std::uint32_t>;
    ...
    namespace Usart3Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40004818,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
