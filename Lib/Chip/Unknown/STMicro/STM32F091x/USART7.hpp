...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart7Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011800,0xe0000000,0x00000000,std::uint32_t>;
        ///USART enable
    ...
    namespace Usart7Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011804,0x0000008f,0x00000000,std::uint32_t>;
    ...
    namespace Usart7Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011808,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Usart7Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4001180c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart7Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40011810,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
    ...
    namespace Usart7Rtor{    ///<Receiver timeout register
        using Addr = Register::Address<0x40011814,0x00000000,0x00000000,std::uint32_t>;
        ///Block Length
    ...
    namespace Usart7Rqr{    ///<Request register
        using Addr = Register::Address<0x40011818,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Usart7Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001181c,0xff802000,0x00000000,std::uint32_t>;
    ...
    namespace Usart7Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40011820,0xffede4a0,0x00000000,std::uint32_t>;
    ...
    namespace Usart7Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40011824,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rdr{}; 
    }
    namespace Usart7Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40011828,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
