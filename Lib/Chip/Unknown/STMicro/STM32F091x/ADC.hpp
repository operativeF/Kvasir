...
//Analog-to-digital converter
    namespace AdcIsr{    ///<interrupt and status register
        using Addr = Register::Address<0x40012400,0xffffff60,0x00000000,std::uint32_t>;
    ...
    namespace AdcIer{    ///<interrupt enable register
        using Addr = Register::Address<0x40012404,0xffffff60,0x00000000,std::uint32_t>;
    ...
    namespace AdcCr{    ///<control register
        using Addr = Register::Address<0x40012408,0x7fffffe8,0x00000000,std::uint32_t>;
        ///ADC calibration
    ...
    namespace AdcCfgr2{    ///<configuration register 2
        using Addr = Register::Address<0x40012410,0x3fffffff,0x00000000,std::uint32_t>;
        ///JITOFF_D4
    ...
    namespace AdcCcr{    ///<common configuration register
        using Addr = Register::Address<0x40012708,0xfe3fffff,0x00000000,std::uint32_t>;
        ///VBAT enable
