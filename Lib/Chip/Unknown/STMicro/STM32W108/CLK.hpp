...
//Clock
    namespace ClkClkSleepcr{    ///<Sleep timer control register
        using Addr = Register::Address<0x40000008,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkLsi10kcr{    ///<LSI Clock (10KHz) control          register
        using Addr = Register::Address<0x4000000c,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkLsi1kcr{    ///<LSI Clock (1KHz) control          register
        using Addr = Register::Address<0x40000010,0xfc000000,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkHsecr1{    ///<HSE Clock (24MHz) control register          1
        using Addr = Register::Address<0x40004004,0xfffffff0,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkHsicr{    ///<HSI Clock (12MHz) trim          register
        using Addr = Register::Address<0x40004008,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkPeriodcr{    ///<Clock period control register
        using Addr = Register::Address<0x40004010,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkDithercr{    ///<Clock dither control register
        using Addr = Register::Address<0x40004018,0xfffffffe,0x00000000,std::uint32_t>;
        ///Dither disable
    ...
    namespace ClkClkHsecr2{    ///<HSE Clock (24MHz) control register          2
        using Addr = Register::Address<0x4000401c,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace ClkClkCpucr{    ///<Clock source select register
        using Addr = Register::Address<0x40004020,0xfffffffe,0x00000000,std::uint32_t>;
