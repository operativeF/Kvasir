...
//General-purpose I/Os
    namespace GpiodModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x140020400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x140020404,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiodOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x140020408,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpiodPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x14002040c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiodIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x140020410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x140020414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x140020418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x14002041c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodAfrl{    ///<AFRL
        using Addr = Register::Address<0x140020420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiodAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x140020424,0x00000000,0x00000000,std::uint32_t>;
