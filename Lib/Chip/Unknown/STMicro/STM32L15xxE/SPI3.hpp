...
//Serial peripheral interface
    namespace Spi3Cr1{    ///<control register 1
        using Addr = Register::Address<0x40023400,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi3Cr2{    ///<control register 2
        using Addr = Register::Address<0x40023404,0xffffff08,0x00000000,std::uint32_t>;
    ...
    namespace Spi3Sr{    ///<status register
        using Addr = Register::Address<0x40023408,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Spi3Dr{    ///<data register
        using Addr = Register::Address<0x4002340c,0xffff0000,0x00000000,std::uint32_t>;
        ///Data register
    ...
    namespace Spi3Crcpr{    ///<CRC polynomial register
        using Addr = Register::Address<0x40023410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi3Rxcrcr{    ///<RX CRC register
        using Addr = Register::Address<0x40023414,0xffff0000,0x00000000,std::uint32_t>;
        ///Rx CRC register
    ...
    namespace Spi3Txcrcr{    ///<TX CRC register
        using Addr = Register::Address<0x40023418,0xffff0000,0x00000000,std::uint32_t>;
        ///Tx CRC register
    ...
    namespace Spi3I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4002341c,0xfffff040,0x00000000,std::uint32_t>;
        ///I2S mode selection
    ...
    namespace Spi3I2spr{    ///<I2S prescaler register
        using Addr = Register::Address<0x40023420,0xfffffc00,0x00000000,std::uint32_t>;
