...
//General-purpose I/Os
    namespace GpiohModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x140020c00,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiohOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x140020c04,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiohOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x140020c08,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpiohPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x140020c0c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiohIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x140020c10,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiohOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x140020c14,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiohBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x140020c18,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiohLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x140020c1c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiohAfrl{    ///<AFRL
        using Addr = Register::Address<0x140020c20,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiohAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x140020c24,0x00000000,0x00000000,std::uint32_t>;
