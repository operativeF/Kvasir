...
//General-purpose timers
    namespace Tim3Cr1{    ///<control register 1
        using Addr = Register::Address<0x140000000,0xfffffc00,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim3Cr2{    ///<control register 2
        using Addr = Register::Address<0x140000004,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim3Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x140000008,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Dier{    ///<Interrupt enable register
        using Addr = Register::Address<0x14000000c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Sr{    ///<status register
        using Addr = Register::Address<0x140000010,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Egr{    ///<event generation register
        using Addr = Register::Address<0x140000014,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim3Ccmr1Output{    ///<capture/compare mode register          1
        using Addr = Register::Address<0x140000018,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x140000018,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccmr2Output{    ///<capture/compare mode register          2
        using Addr = Register::Address<0x14000001c,0xffff0200,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> cc4s{}; 
    ...
    namespace Tim3Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x14000001c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x140000020,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Cnt{    ///<counter
        using Addr = Register::Address<0x140000024,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 counter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim3Psc{    ///<prescaler
        using Addr = Register::Address<0x140000028,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 prescaler
    ...
    namespace Tim3Arr{    ///<auto-reload register
        using Addr = Register::Address<0x14000002c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim3Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000034,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim3Ccr2{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000038,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 2 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr2{}; 
    }
    namespace Tim3Ccr3{    ///<capture/compare register 1
        using Addr = Register::Address<0x14000003c,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim3Ccr4{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000040,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Dcr{    ///<DMA control register
        using Addr = Register::Address<0x140000048,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim3Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x14000004c,0xffff0000,0x00000000,std::uint32_t>;
