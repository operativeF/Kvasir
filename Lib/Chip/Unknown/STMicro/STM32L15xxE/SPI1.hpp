...
//Serial peripheral interface
    namespace Spi1Cr1{    ///<control register 1
        using Addr = Register::Address<0x40022800,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Cr2{    ///<control register 2
        using Addr = Register::Address<0x40022804,0xffffff08,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Sr{    ///<status register
        using Addr = Register::Address<0x40022808,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Spi1Dr{    ///<data register
        using Addr = Register::Address<0x4002280c,0xffff0000,0x00000000,std::uint32_t>;
        ///Data register
    ...
    namespace Spi1Txcrcr{    ///<TX CRC register
        using Addr = Register::Address<0x40022818,0xffff0000,0x00000000,std::uint32_t>;
        ///Tx CRC register
    ...
    namespace Spi1I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4002281c,0xfffff040,0x00000000,std::uint32_t>;
        ///I2S mode selection
    ...
    namespace Spi1I2spr{    ///<I2S prescaler register
        using Addr = Register::Address<0x40022820,0xfffffc00,0x00000000,std::uint32_t>;
