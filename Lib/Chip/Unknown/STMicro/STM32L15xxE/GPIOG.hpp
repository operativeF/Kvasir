...
//General-purpose I/Os
    namespace GpiogModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x140021400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x140021404,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x140021408,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpiogPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x14002140c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x140021410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x140021414,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x140021418,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x14002141c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogAfrl{    ///<AFRL
        using Addr = Register::Address<0x140021420,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x140021424,0x00000000,0x00000000,std::uint32_t>;
