...
//General-purpose timers
    namespace Tim2Cr1{    ///<control register 1
        using Addr = Register::Address<0x13ffffc00,0xfffffc00,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim2Cr2{    ///<control register 2
        using Addr = Register::Address<0x13ffffc04,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim2Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x13ffffc08,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Dier{    ///<Interrupt enable register
        using Addr = Register::Address<0x13ffffc0c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Sr{    ///<status register
        using Addr = Register::Address<0x13ffffc10,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Egr{    ///<event generation register
        using Addr = Register::Address<0x13ffffc14,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim2Ccmr1Output{    ///<capture/compare mode register          1
        using Addr = Register::Address<0x13ffffc18,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x13ffffc18,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Ccmr2Output{    ///<capture/compare mode register          2
        using Addr = Register::Address<0x13ffffc1c,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x13ffffc1c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x13ffffc20,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Cnt{    ///<counter
        using Addr = Register::Address<0x13ffffc24,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 counter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim2Psc{    ///<prescaler
        using Addr = Register::Address<0x13ffffc28,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 prescaler
    ...
    namespace Tim2Arr{    ///<auto-reload register
        using Addr = Register::Address<0x13ffffc2c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim2Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x13ffffc34,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim2Ccr2{    ///<capture/compare register 1
        using Addr = Register::Address<0x13ffffc38,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 2 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr2{}; 
    }
    namespace Tim2Ccr3{    ///<capture/compare register 1
        using Addr = Register::Address<0x13ffffc3c,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim2Ccr4{    ///<capture/compare register 1
        using Addr = Register::Address<0x13ffffc40,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Dcr{    ///<DMA control register
        using Addr = Register::Address<0x13ffffc48,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim2Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x13ffffc4c,0xffff0000,0x00000000,std::uint32_t>;
