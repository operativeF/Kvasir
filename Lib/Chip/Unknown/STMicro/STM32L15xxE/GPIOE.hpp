...
//General-purpose I/Os
    namespace GpioeModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x140020800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x140020804,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioeOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x140020808,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpioePupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x14002080c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioeIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x140020810,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x140020814,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x140020818,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x14002081c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeAfrl{    ///<AFRL
        using Addr = Register::Address<0x140020820,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpioeAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x140020824,0x00000000,0x00000000,std::uint32_t>;
