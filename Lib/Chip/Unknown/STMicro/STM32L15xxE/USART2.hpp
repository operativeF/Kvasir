...
//Universal synchronous asynchronous receiver      transmitter
    ...
    namespace Usart2Dr{    ///<Data register
        using Addr = Register::Address<0x40013404,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
    ...
    namespace Usart2Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40013408,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Usart2Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4001340c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Usart2Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40013410,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Usart2Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40013414,0xfffff000,0x00000000,std::uint32_t>;
