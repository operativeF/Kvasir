...
//General-purpose I/Os
    namespace GpiocModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x140020000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x140020004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x140020008,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpiocPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x14002000c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x140020010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x140020014,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x140020018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x14002001c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocAfrl{    ///<AFRL
        using Addr = Register::Address<0x140020020,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x140020024,0x00000000,0x00000000,std::uint32_t>;
