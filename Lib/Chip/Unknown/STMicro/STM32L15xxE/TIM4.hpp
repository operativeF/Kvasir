...
//General-purpose timers
    namespace Tim4Cr1{    ///<control register 1
        using Addr = Register::Address<0x140000400,0xfffffc00,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim4Cr2{    ///<control register 2
        using Addr = Register::Address<0x140000404,0xffffff07,0x00000000,std::uint32_t>;
        ///TI1 selection
    ...
    namespace Tim4Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x140000408,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Dier{    ///<Interrupt enable register
        using Addr = Register::Address<0x14000040c,0xffffa0a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Sr{    ///<status register
        using Addr = Register::Address<0x140000410,0xffffe1a0,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Egr{    ///<event generation register
        using Addr = Register::Address<0x140000414,0xffffffa0,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim4Ccmr1Output{    ///<capture/compare mode register          1
        using Addr = Register::Address<0x140000418,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x140000418,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccmr2Output{    ///<capture/compare mode register          2
        using Addr = Register::Address<0x14000041c,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccmr2Input{    ///<capture/compare mode register 2 (input          mode)
        using Addr = Register::Address<0x14000041c,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x140000420,0xffff4444,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Cnt{    ///<counter
        using Addr = Register::Address<0x140000424,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 counter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim4Psc{    ///<prescaler
        using Addr = Register::Address<0x140000428,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 prescaler
    ...
    namespace Tim4Arr{    ///<auto-reload register
        using Addr = Register::Address<0x14000042c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim4Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000434,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim4Ccr2{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000438,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 2 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr2{}; 
    }
    namespace Tim4Ccr3{    ///<capture/compare register 1
        using Addr = Register::Address<0x14000043c,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim4Ccr4{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000440,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim4Dcr{    ///<DMA control register
        using Addr = Register::Address<0x140000448,0xffffe0e0,0x00000000,std::uint32_t>;
        ///DMA burst length
    ...
    namespace Tim4Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x14000044c,0xffff0000,0x00000000,std::uint32_t>;
