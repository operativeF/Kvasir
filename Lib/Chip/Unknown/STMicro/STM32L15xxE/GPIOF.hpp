...
//General-purpose I/Os
    namespace GpiofModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x140021000,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x140021004,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x140021008,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpiofPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x14002100c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiofIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x140021010,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x140021014,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x140021018,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x14002101c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofAfrl{    ///<AFRL
        using Addr = Register::Address<0x140021020,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiofAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x140021024,0x00000000,0x00000000,std::uint32_t>;
