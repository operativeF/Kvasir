...
//Reset and clock control
    ...
    namespace RccCfgr{    ///<Clock configuration register          (RCC_CFGR)
        using Addr = Register::Address<0x40021004,0x0800c000,0x00000000,std::uint32_t>;
        ///System clock Switch
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register          (RCC_APB2RSTR)
        using Addr = Register::Address<0x4002100c,0xdff8a7fe,0x00000000,std::uint32_t>;
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register          (RCC_APB1RSTR)
        using Addr = Register::Address<0x40021010,0xc959f7cc,0x00000000,std::uint32_t>;
        ///Timer 2 reset
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable register          (RCC_APB2ENR)
        using Addr = Register::Address<0x40021018,0xdff8a7fe,0x00000000,std::uint32_t>;
        ///SYSCFG clock enable
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable register          (RCC_APB1ENR)
        using Addr = Register::Address<0x4002101c,0xc9d9f7cc,0x00000000,std::uint32_t>;
    ...
    namespace RccCfgr2{    ///<Clock configuration register 2
        using Addr = Register::Address<0x4002102c,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace RccCfgr3{    ///<Clock configuration register 3
        using Addr = Register::Address<0x40021030,0xffffeeec,0x00000000,std::uint32_t>;
