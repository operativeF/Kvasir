...
//Universal synchronous asynchronous receiver       transmitter
    namespace Usart6Sr{    ///<Status register
    ...
    namespace Usart6Dr{    ///<Data register
        using Addr = Register::Address<0x40011404,0xfffffe00,0x00000000,std::uint32_t>;
        ///Data value
    ...
    namespace Usart6Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4001140c,0xffff4000,0x00000000,std::uint32_t>;
        ///Oversampling mode
    ...
    namespace Usart6Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011410,0xffff8090,0x00000000,std::uint32_t>;
        ///LIN mode enable
    ...
    namespace Usart6Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011414,0xfffff000,0x00000000,std::uint32_t>;
