...
//General-purpose timers
    ...
    namespace Tim3Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000408,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccmr1Output{    ///<capture/compare mode register           1
        using Addr = Register::Address<0x40000418,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccmr2Output{    ///<capture/compare mode register           2
        using Addr = Register::Address<0x4000041c,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Cnt{    ///<counter
        using Addr = Register::Address<0x40000424,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 counter
    ...
    namespace Tim3Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4000042c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim3Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000434,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccr2{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000438,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Ccr3{    ///<capture/compare register 1
        using Addr = Register::Address<0x4000043c,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim3Ccr4{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000440,0xffff0000,0x00000000,std::uint32_t>;
