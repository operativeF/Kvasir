...
//Reset and clock control
    ...
    namespace RccAhbrstr{    ///<AHB peripheral reset register
        using Addr = Register::Address<0x40023810,0xfcff6f00,0x00000000,std::uint32_t>;
        ///DMA2 reset
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register
        using Addr = Register::Address<0x40023818,0x4f1935c0,0x00000000,std::uint32_t>;
    ...
    namespace RccAhbenr{    ///<AHB peripheral clock enable           register
        using Addr = Register::Address<0x4002381c,0xfcff6f00,0x00000000,std::uint32_t>;
        ///DMA2 clock enable
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable           register
        using Addr = Register::Address<0x40023824,0x4f1935c0,0x00000000,std::uint32_t>;
    ...
    namespace RccCsr{    ///<Control/status register
        using Addr = Register::Address<0x40023834,0x003ce0fc,0x00000000,std::uint32_t>;
