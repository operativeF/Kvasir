...
//General-purpose I/Os
    namespace GpiobModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40020400,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40020404,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiobOspeeder{    ///<GPIO port output speed           register
    ...
    namespace GpiobPupdr{    ///<GPIO port pull-up/pull-down           register
        using Addr = Register::Address<0x4002040c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiobIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40020410,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiobLckr{    ///<GPIO port configuration lock           register
        using Addr = Register::Address<0x4002041c,0xfffe0000,0x00000000,std::uint32_t>;
