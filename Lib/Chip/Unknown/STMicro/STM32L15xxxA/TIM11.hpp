...
//General-purpose timers
    namespace Tim11Cr1{    ///<control register 1
        using Addr = Register::Address<0x40011000,0xfffffc78,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim11Dier{    ///<Interrupt enable register
        using Addr = Register::Address<0x4001100c,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Sr{    ///<status register
        using Addr = Register::Address<0x40011010,0xfffffdfc,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Egr{    ///<event generation register
        using Addr = Register::Address<0x40011014,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Ccmr1Output{    ///<capture/compare mode register
        using Addr = Register::Address<0x40011018,0xffffff80,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Ccmr1Input{    ///<capture/compare mode register 1 (input           mode)
        using Addr = Register::Address<0x40011018,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Ccer{    ///<capture/compare enable           register
        using Addr = Register::Address<0x40011020,0xfffffff4,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Cnt{    ///<counter
        using Addr = Register::Address<0x40011024,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM10 counter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim11Psc{    ///<prescaler
        using Addr = Register::Address<0x40011028,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM9 prescaler
    ...
    namespace Tim11Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4001102c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim11Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40011034,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Or{    ///<option register
        using Addr = Register::Address<0x40011050,0xfffffffc,0x00000000,std::uint32_t>;
