...
//General purpose timers
    namespace Tim15Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014000,0xfffffc70,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim15Cr2{    ///<control register 2
        using Addr = Register::Address<0x40014004,0xfffff882,0x00000000,std::uint32_t>;
        ///Output Idle state 2
    ...
    namespace Tim15Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40014008,0xffffff08,0x00000000,std::uint32_t>;
        ///Master/Slave mode
    ...
    namespace Tim15Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001400c,0xffffb818,0x00000000,std::uint32_t>;
    ...
    namespace Tim15Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40014018,0xffff8080,0x00000000,std::uint32_t>;
    ...
    namespace Tim15Cnt{    ///<counter
        using Addr = Register::Address<0x40014024,0xffff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim15Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40014044,0xffff0000,0x00000000,std::uint32_t>;
        ///Main output enable
