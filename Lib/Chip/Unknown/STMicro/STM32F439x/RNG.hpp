...
//Random number generator
    namespace RngCr{    ///<control register
        using Addr = Register::Address<0x50060800,0xfffffff3,0x00000000,std::uint32_t>;
        ///Interrupt enable
    ...
    namespace RngSr{    ///<status register
        using Addr = Register::Address<0x50060804,0xffffff98,0x00000000,std::uint32_t>;
    ...
    namespace RngDr{    ///<data register
        using Addr = Register::Address<0x50060808,0x00000000,0x00000000,std::uint32_t>;
        ///Random data
