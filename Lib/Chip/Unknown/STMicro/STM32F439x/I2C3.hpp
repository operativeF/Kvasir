...
//Inter-integrated circuit
    namespace I2c3Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40005c00,0xffff4004,0x00000000,std::uint32_t>;
        ///Software reset
    ...
    namespace I2c3Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40005c04,0xffffe0c0,0x00000000,std::uint32_t>;
        ///DMA last transfer
    ...
    namespace I2c3Oar1{    ///<Own address register 1
        using Addr = Register::Address<0x40005c08,0xffff7c00,0x00000000,std::uint32_t>;
    ...
    namespace I2c3Oar2{    ///<Own address register 2
        using Addr = Register::Address<0x40005c0c,0xffffff00,0x00000000,std::uint32_t>;
        ///Interface address
    ...
    namespace I2c3Dr{    ///<Data register
        using Addr = Register::Address<0x40005c10,0xffffff00,0x00000000,std::uint32_t>;
        ///8-bit data register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> dr{}; 
    }
    namespace I2c3Sr1{    ///<Status register 1
        using Addr = Register::Address<0x40005c14,0xffff2020,0x00000000,std::uint32_t>;
        ///SMBus alert
    ...
    namespace I2c3Sr2{    ///<Status register 2
        using Addr = Register::Address<0x40005c18,0xffff0008,0x00000000,std::uint32_t>;
    ...
    namespace I2c3Ccr{    ///<Clock control register
        using Addr = Register::Address<0x40005c1c,0xffff3000,0x00000000,std::uint32_t>;
    ...
    namespace I2c3Trise{    ///<TRISE register
        using Addr = Register::Address<0x40005c20,0xffffffc0,0x00000000,std::uint32_t>;
        ///Maximum rise time in Fast/Standard mode              (Master mode)
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> trise{}; 
    }
    namespace I2c3Fltr{    ///<I2C FLTR register
        using Addr = Register::Address<0x40005c24,0xffffffe0,0x00000000,std::uint32_t>;
        ///Digital noise filter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> dnf{}; 
        ///Analog noise filter OFF
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> anoff{}; 
    }
}
