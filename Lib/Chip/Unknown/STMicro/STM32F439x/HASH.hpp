...
//Hash processor
    namespace HashCr{    ///<control register
        using Addr = Register::Address<0x50060400,0xfffac003,0x00000000,std::uint32_t>;
    ...
    namespace HashDin{    ///<data input register
        using Addr = Register::Address<0x50060404,0x00000000,0x00000000,std::uint32_t>;
        ///Data input
    ...
    namespace HashStr{    ///<start register
        using Addr = Register::Address<0x50060408,0xfffffee0,0x00000000,std::uint32_t>;
        ///Digest calculation
    ...
    namespace HashHr0{    ///<digest registers
        using Addr = Register::Address<0x5006040c,0x00000000,0x00000000,std::uint32_t>;
        ///H0
    ...
    namespace HashHr1{    ///<digest registers
        using Addr = Register::Address<0x50060410,0x00000000,0x00000000,std::uint32_t>;
        ///H1
    ...
    namespace HashHr2{    ///<digest registers
        using Addr = Register::Address<0x50060414,0x00000000,0x00000000,std::uint32_t>;
        ///H2
    ...
    namespace HashHr3{    ///<digest registers
        using Addr = Register::Address<0x50060418,0x00000000,0x00000000,std::uint32_t>;
        ///H3
    ...
    namespace HashHr4{    ///<digest registers
        using Addr = Register::Address<0x5006041c,0x00000000,0x00000000,std::uint32_t>;
        ///H4
    ...
    namespace HashImr{    ///<interrupt enable register
        using Addr = Register::Address<0x50060420,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace HashSr{    ///<status register
        using Addr = Register::Address<0x50060424,0xfffffff0,0x00000000,std::uint32_t>;
        ///Busy bit
    ...
    namespace HashCsr0{    ///<context swap registers
        using Addr = Register::Address<0x500604f8,0x00000000,0x00000000,std::uint32_t>;
        ///CSR0
    ...
    namespace HashCsr1{    ///<context swap registers
        using Addr = Register::Address<0x500604fc,0x00000000,0x00000000,std::uint32_t>;
        ///CSR1
    ...
    namespace HashCsr2{    ///<context swap registers
        using Addr = Register::Address<0x50060500,0x00000000,0x00000000,std::uint32_t>;
        ///CSR2
    ...
    namespace HashCsr3{    ///<context swap registers
        using Addr = Register::Address<0x50060504,0x00000000,0x00000000,std::uint32_t>;
        ///CSR3
    ...
    namespace HashCsr4{    ///<context swap registers
        using Addr = Register::Address<0x50060508,0x00000000,0x00000000,std::uint32_t>;
        ///CSR4
    ...
    namespace HashCsr5{    ///<context swap registers
        using Addr = Register::Address<0x5006050c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR5
    ...
    namespace HashCsr6{    ///<context swap registers
        using Addr = Register::Address<0x50060510,0x00000000,0x00000000,std::uint32_t>;
        ///CSR6
    ...
    namespace HashCsr7{    ///<context swap registers
        using Addr = Register::Address<0x50060514,0x00000000,0x00000000,std::uint32_t>;
        ///CSR7
    ...
    namespace HashCsr8{    ///<context swap registers
        using Addr = Register::Address<0x50060518,0x00000000,0x00000000,std::uint32_t>;
        ///CSR8
    ...
    namespace HashCsr9{    ///<context swap registers
        using Addr = Register::Address<0x5006051c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR9
    ...
    namespace HashCsr10{    ///<context swap registers
        using Addr = Register::Address<0x50060520,0x00000000,0x00000000,std::uint32_t>;
        ///CSR10
    ...
    namespace HashCsr11{    ///<context swap registers
        using Addr = Register::Address<0x50060524,0x00000000,0x00000000,std::uint32_t>;
        ///CSR11
    ...
    namespace HashCsr12{    ///<context swap registers
        using Addr = Register::Address<0x50060528,0x00000000,0x00000000,std::uint32_t>;
        ///CSR12
    ...
    namespace HashCsr13{    ///<context swap registers
        using Addr = Register::Address<0x5006052c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR13
    ...
    namespace HashCsr14{    ///<context swap registers
        using Addr = Register::Address<0x50060530,0x00000000,0x00000000,std::uint32_t>;
        ///CSR14
    ...
    namespace HashCsr15{    ///<context swap registers
        using Addr = Register::Address<0x50060534,0x00000000,0x00000000,std::uint32_t>;
        ///CSR15
    ...
    namespace HashCsr16{    ///<context swap registers
        using Addr = Register::Address<0x50060538,0x00000000,0x00000000,std::uint32_t>;
        ///CSR16
    ...
    namespace HashCsr17{    ///<context swap registers
        using Addr = Register::Address<0x5006053c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR17
    ...
    namespace HashCsr18{    ///<context swap registers
        using Addr = Register::Address<0x50060540,0x00000000,0x00000000,std::uint32_t>;
        ///CSR18
    ...
    namespace HashCsr19{    ///<context swap registers
        using Addr = Register::Address<0x50060544,0x00000000,0x00000000,std::uint32_t>;
        ///CSR19
    ...
    namespace HashCsr20{    ///<context swap registers
        using Addr = Register::Address<0x50060548,0x00000000,0x00000000,std::uint32_t>;
        ///CSR20
    ...
    namespace HashCsr21{    ///<context swap registers
        using Addr = Register::Address<0x5006054c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR21
    ...
    namespace HashCsr22{    ///<context swap registers
        using Addr = Register::Address<0x50060550,0x00000000,0x00000000,std::uint32_t>;
        ///CSR22
    ...
    namespace HashCsr23{    ///<context swap registers
        using Addr = Register::Address<0x50060554,0x00000000,0x00000000,std::uint32_t>;
        ///CSR23
    ...
    namespace HashCsr24{    ///<context swap registers
        using Addr = Register::Address<0x50060558,0x00000000,0x00000000,std::uint32_t>;
        ///CSR24
    ...
    namespace HashCsr25{    ///<context swap registers
        using Addr = Register::Address<0x5006055c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR25
    ...
    namespace HashCsr26{    ///<context swap registers
        using Addr = Register::Address<0x50060560,0x00000000,0x00000000,std::uint32_t>;
        ///CSR26
    ...
    namespace HashCsr27{    ///<context swap registers
        using Addr = Register::Address<0x50060564,0x00000000,0x00000000,std::uint32_t>;
        ///CSR27
    ...
    namespace HashCsr28{    ///<context swap registers
        using Addr = Register::Address<0x50060568,0x00000000,0x00000000,std::uint32_t>;
        ///CSR28
    ...
    namespace HashCsr29{    ///<context swap registers
        using Addr = Register::Address<0x5006056c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR29
    ...
    namespace HashCsr30{    ///<context swap registers
        using Addr = Register::Address<0x50060570,0x00000000,0x00000000,std::uint32_t>;
        ///CSR30
    ...
    namespace HashCsr31{    ///<context swap registers
        using Addr = Register::Address<0x50060574,0x00000000,0x00000000,std::uint32_t>;
        ///CSR31
    ...
    namespace HashCsr32{    ///<context swap registers
        using Addr = Register::Address<0x50060578,0x00000000,0x00000000,std::uint32_t>;
        ///CSR32
    ...
    namespace HashCsr33{    ///<context swap registers
        using Addr = Register::Address<0x5006057c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR33
    ...
    namespace HashCsr34{    ///<context swap registers
        using Addr = Register::Address<0x50060580,0x00000000,0x00000000,std::uint32_t>;
        ///CSR34
    ...
    namespace HashCsr35{    ///<context swap registers
        using Addr = Register::Address<0x50060584,0x00000000,0x00000000,std::uint32_t>;
        ///CSR35
    ...
    namespace HashCsr36{    ///<context swap registers
        using Addr = Register::Address<0x50060588,0x00000000,0x00000000,std::uint32_t>;
        ///CSR36
    ...
    namespace HashCsr37{    ///<context swap registers
        using Addr = Register::Address<0x5006058c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR37
    ...
    namespace HashCsr38{    ///<context swap registers
        using Addr = Register::Address<0x50060590,0x00000000,0x00000000,std::uint32_t>;
        ///CSR38
    ...
    namespace HashCsr39{    ///<context swap registers
        using Addr = Register::Address<0x50060594,0x00000000,0x00000000,std::uint32_t>;
        ///CSR39
    ...
    namespace HashCsr40{    ///<context swap registers
        using Addr = Register::Address<0x50060598,0x00000000,0x00000000,std::uint32_t>;
        ///CSR40
    ...
    namespace HashCsr41{    ///<context swap registers
        using Addr = Register::Address<0x5006059c,0x00000000,0x00000000,std::uint32_t>;
        ///CSR41
    ...
    namespace HashCsr42{    ///<context swap registers
        using Addr = Register::Address<0x500605a0,0x00000000,0x00000000,std::uint32_t>;
        ///CSR42
    ...
    namespace HashCsr43{    ///<context swap registers
        using Addr = Register::Address<0x500605a4,0x00000000,0x00000000,std::uint32_t>;
        ///CSR43
    ...
    namespace HashCsr44{    ///<context swap registers
        using Addr = Register::Address<0x500605a8,0x00000000,0x00000000,std::uint32_t>;
        ///CSR44
    ...
    namespace HashCsr45{    ///<context swap registers
        using Addr = Register::Address<0x500605ac,0x00000000,0x00000000,std::uint32_t>;
        ///CSR45
    ...
    namespace HashCsr46{    ///<context swap registers
        using Addr = Register::Address<0x500605b0,0x00000000,0x00000000,std::uint32_t>;
        ///CSR46
    ...
    namespace HashCsr47{    ///<context swap registers
        using Addr = Register::Address<0x500605b4,0x00000000,0x00000000,std::uint32_t>;
        ///CSR47
    ...
    namespace HashCsr48{    ///<context swap registers
        using Addr = Register::Address<0x500605b8,0x00000000,0x00000000,std::uint32_t>;
        ///CSR48
    ...
    namespace HashCsr49{    ///<context swap registers
        using Addr = Register::Address<0x500605bc,0x00000000,0x00000000,std::uint32_t>;
        ///CSR49
    ...
    namespace HashCsr50{    ///<context swap registers
        using Addr = Register::Address<0x500605c0,0x00000000,0x00000000,std::uint32_t>;
        ///CSR50
    ...
    namespace HashCsr51{    ///<context swap registers
        using Addr = Register::Address<0x500605c4,0x00000000,0x00000000,std::uint32_t>;
        ///CSR51
    ...
    namespace HashCsr52{    ///<context swap registers
        using Addr = Register::Address<0x500605c8,0x00000000,0x00000000,std::uint32_t>;
        ///CSR52
    ...
    namespace HashCsr53{    ///<context swap registers
        using Addr = Register::Address<0x500605cc,0x00000000,0x00000000,std::uint32_t>;
        ///CSR53
    ...
    namespace HashHashHr0{    ///<HASH digest register
        using Addr = Register::Address<0x50060710,0x00000000,0x00000000,std::uint32_t>;
        ///H0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h0{}; 
    }
    namespace HashHashHr1{    ///<read-only
        using Addr = Register::Address<0x50060714,0x00000000,0x00000000,std::uint32_t>;
        ///H1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h1{}; 
    }
    namespace HashHashHr2{    ///<read-only
        using Addr = Register::Address<0x50060718,0x00000000,0x00000000,std::uint32_t>;
        ///H2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h2{}; 
    }
    namespace HashHashHr3{    ///<read-only
        using Addr = Register::Address<0x5006071c,0x00000000,0x00000000,std::uint32_t>;
        ///H3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h3{}; 
    }
    namespace HashHashHr4{    ///<read-only
        using Addr = Register::Address<0x50060720,0x00000000,0x00000000,std::uint32_t>;
        ///H4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h4{}; 
    }
    namespace HashHashHr5{    ///<read-only
        using Addr = Register::Address<0x50060724,0x00000000,0x00000000,std::uint32_t>;
        ///H5
    ...
    namespace HashHashHr6{    ///<read-only
        using Addr = Register::Address<0x50060728,0x00000000,0x00000000,std::uint32_t>;
        ///H6
    ...
    namespace HashHashHr7{    ///<read-only
        using Addr = Register::Address<0x5006072c,0x00000000,0x00000000,std::uint32_t>;
        ///H7
