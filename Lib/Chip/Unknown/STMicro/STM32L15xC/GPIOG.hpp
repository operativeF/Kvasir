...
//General-purpose I/Os
    namespace GpiogModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40021c00,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40021c04,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogOspeeder{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40021c08,0x00000000,0x00000000,std::uint32_t>;
        ///OSPEEDR15
    ...
    namespace GpiogPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x40021c0c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiogIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40021c10,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40021c14,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40021c18,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x40021c1c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogAfrl{    ///<AFRL
        using Addr = Register::Address<0x40021c20,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiogAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40021c24,0x00000000,0x00000000,std::uint32_t>;
