...
//General-purpose timers
    namespace Tim5Cr1{    ///<control register 1
        using Addr = Register::Address<0x40000c00,0xfffffc00,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim5Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000c08,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim5Ccmr1Output{    ///<capture/compare mode register          1
        using Addr = Register::Address<0x40000c18,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim5Ccmr2Output{    ///<capture/compare mode register          2
        using Addr = Register::Address<0x40000c1c,0xffff0200,0x00000000,std::uint32_t>;
    ...
    namespace Tim5Cnt{    ///<counter
        using Addr = Register::Address<0x40000c24,0xffff0000,0x00000000,std::uint32_t>;
        ///TIM2 counter
    ...
    namespace Tim5Arr{    ///<auto-reload register
        using Addr = Register::Address<0x40000c2c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim5Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000c34,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim5Ccr2{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000c38,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim5Ccr3{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000c3c,0xffff0000,0x00000000,std::uint32_t>;
        ///Capture/Compare 1 value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Tim5Ccr4{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000c40,0xffff0000,0x00000000,std::uint32_t>;
