...
//Analog to digital converter
    namespace Adc2Sr{    ///<status register
        using Addr = Register::Address<0x40012800,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Cr1{    ///<control register 1
        using Addr = Register::Address<0x40012804,0xff3f0000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Cr2{    ///<control register 2
        using Addr = Register::Address<0x40012808,0xff0106f0,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x4001280c,0xf8000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x40012810,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Jofr1{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x40012814,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Jofr2{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x40012818,0xfffff000,0x00000000,std::uint32_t>;
        ///Data offset for injected channel              x
    ...
    namespace Adc2Jofr3{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x4001281c,0xfffff000,0x00000000,std::uint32_t>;
        ///Data offset for injected channel              x
    ...
    namespace Adc2Jofr4{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x40012820,0xfffff000,0x00000000,std::uint32_t>;
        ///Data offset for injected channel              x
    ...
    namespace Adc2Htr{    ///<watchdog higher threshold          register
        using Addr = Register::Address<0x40012824,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Ltr{    ///<watchdog lower threshold          register
        using Addr = Register::Address<0x40012828,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x4001282c,0xff000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x40012830,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x40012834,0xc0000000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x40012838,0xffc00000,0x00000000,std::uint32_t>;
    ...
    namespace Adc2Jdr1{    ///<injected data register x
        using Addr = Register::Address<0x4001283c,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
    ...
    namespace Adc2Jdr2{    ///<injected data register x
        using Addr = Register::Address<0x40012840,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc2Jdr3{    ///<injected data register x
        using Addr = Register::Address<0x40012844,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc2Jdr4{    ///<injected data register x
        using Addr = Register::Address<0x40012848,0xffff0000,0x00000000,std::uint32_t>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc2Dr{    ///<regular data register
        using Addr = Register::Address<0x4001284c,0xffff0000,0x00000000,std::uint32_t>;
        ///Regular data
