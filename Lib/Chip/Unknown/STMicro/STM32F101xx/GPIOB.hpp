...
namespace Kvasir {
//General purpose I/O
    namespace GpiobCrl{    ///<Port configuration register low          (GPIOn_CRL)
        using Addr = Register::Address<0x40010c00,0x00000000,0x00000000,std::uint32_t>;
        ///Port n.0 mode bits
    ...
    namespace GpiobCrh{    ///<Port configuration register high          (GPIOn_CRL)
        using Addr = Register::Address<0x40010c04,0x00000000,0x00000000,std::uint32_t>;
        ///Port n.8 mode bits
    ...
    namespace GpiobIdr{    ///<Port input data register          (GPIOn_IDR)
        using Addr = Register::Address<0x40010c08,0xffff0000,0x00000000,std::uint32_t>;
        ///Port input data
    ...
    namespace GpiobOdr{    ///<Port output data register          (GPIOn_ODR)
        using Addr = Register::Address<0x40010c0c,0xffff0000,0x00000000,std::uint32_t>;
        ///Port output data
    ...
    namespace GpiobBsrr{    ///<Port bit set/reset register          (GPIOn_BSRR)
        using Addr = Register::Address<0x40010c10,0x00000000,0x00000000,std::uint32_t>;
        ///Set bit 0
    ...
    namespace GpiobBrr{    ///<Port bit reset register          (GPIOn_BRR)
        using Addr = Register::Address<0x40010c14,0xffff0000,0x00000000,std::uint32_t>;
        ///Reset bit 0
    ...
    namespace GpiobLckr{    ///<Port configuration lock          register
        using Addr = Register::Address<0x40010c18,0xfffe0000,0x00000000,std::uint32_t>;
        ///Port A Lock bit 0
