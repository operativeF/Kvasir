...
//General purpose timer
    ...
    namespace Tim13Cr2{    ///<control register 2
        using Addr = Register::Address<0x40001c04,0xffffff8f,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40001c18,0xffffff84,0x00000000,std::uint32_t>;
    ...
    namespace Tim13Ccmr1Input{    ///<capture/compare mode register (input          mode)
