...
//General purpose timer
    namespace Tim11Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015400,0xfffffc78,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim11Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015404,0xffffff8f,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001540c,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Sr{    ///<status register
        using Addr = Register::Address<0x40015410,0xfffffdfc,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Egr{    ///<event generation register
        using Addr = Register::Address<0x40015414,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40015418,0xffffff84,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Ccmr1Input{    ///<capture/compare mode register (input          mode)
        using Addr = Register::Address<0x40015418,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40015420,0xfffffff4,0x00000000,std::uint32_t>;
    ...
    namespace Tim11Cnt{    ///<counter
        using Addr = Register::Address<0x40015424,0xffff0000,0x00000000,std::uint32_t>;
        ///counter value
    ...
    namespace Tim11Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4001542c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim11Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40015434,0xffff0000,0x00000000,std::uint32_t>;
