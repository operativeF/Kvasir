...
//Routing interface
    namespace RiIcr{    ///<RI input capture register
        using Addr = Register::Address<0x40007c08,0xffc00000,0x00000000,std::uint32_t>;
        ///IC4
    ...
    namespace RiAscr1{    ///<RI analog switches control register          1
        using Addr = Register::Address<0x40007c0c,0x00020000,0x00000000,std::uint32_t>;
        ///Switch control mode
    ...
    namespace RiAscr2{    ///<RI analog switches control register          2
        using Addr = Register::Address<0x40007c10,0xc000f000,0x00000000,std::uint32_t>;
    ...
    namespace RiHyscr3{    ///<RI hysteresis control register          3
        using Addr = Register::Address<0x40007c1c,0x00000000,0x00000000,std::uint32_t>;
