...
//Serial peripheral interface
    ...
    namespace Spi4Cr2{    ///<control register 2
        using Addr = Register::Address<0x40013404,0xffffff08,0x00000000,std::uint32_t>;
    ...
    namespace Spi4Sr{    ///<status register
        using Addr = Register::Address<0x40013408,0xfffffe00,0x00000000,std::uint32_t>;
    ...
    namespace Spi4I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001341c,0xfffff040,0x00000000,std::uint32_t>;
        ///I2S mode selection
