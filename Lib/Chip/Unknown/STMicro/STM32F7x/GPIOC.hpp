...
//General-purpose I/Os
    namespace GpiocModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40020800,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40020804,0xffff0000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocGpiobOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x40020808,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x4002080c,0x00000000,0x00000000,std::uint32_t>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40020810,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40020814,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x40020818,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002081c,0xfffe0000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocAfrl{    ///<GPIO alternate function lowregister
        using Addr = Register::Address<0x40020820,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40020824,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace GpiocBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x40020828,0xffff0000,0x00000000,std::uint32_t>;
        ///Port D Reset bit 0
