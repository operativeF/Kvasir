...
//General purpose timers
    ...
    namespace Tim3Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000408,0xfffe0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Or1{    ///<TIM3 option register 1
        using Addr = Register::Address<0x40000450,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim3Or2{    ///<TIM3 option register 2
        using Addr = Register::Address<0x40000460,0xfffe3fff,0x00000000,std::uint32_t>;
