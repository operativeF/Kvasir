...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart6Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011400,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart6Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011408,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Usart6Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001141c,0xff802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Usart6Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40011420,0xffede4a0,0x00000000,std::uint32_t>;
