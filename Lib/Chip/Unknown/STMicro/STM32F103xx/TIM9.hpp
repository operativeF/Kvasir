...
//General purpose timer
    namespace Tim9Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014c00,0xfffffc70,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim9Cr2{    ///<control register 2
        using Addr = Register::Address<0x40014c04,0xffffff8f,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40014c08,0xffffff08,0x00000000,std::uint32_t>;
        ///Master/Slave mode
    ...
    namespace Tim9Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x40014c0c,0xffffffb8,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Sr{    ///<status register
        using Addr = Register::Address<0x40014c10,0xfffff9b8,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Egr{    ///<event generation register
        using Addr = Register::Address<0x40014c14,0xffffffb8,0x00000000,std::uint32_t>;
        ///Trigger generation
    ...
    namespace Tim9Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40014c18,0xffff8080,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40014c18,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40014c20,0xffffff44,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Cnt{    ///<counter
        using Addr = Register::Address<0x40014c24,0xffff0000,0x00000000,std::uint32_t>;
        ///counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim9Psc{    ///<prescaler
        using Addr = Register::Address<0x40014c28,0xffff0000,0x00000000,std::uint32_t>;
        ///Prescaler value
    ...
    namespace Tim9Arr{    ///<auto-reload register
        using Addr = Register::Address<0x40014c2c,0xffff0000,0x00000000,std::uint32_t>;
        ///Auto-reload value
    ...
    namespace Tim9Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40014c34,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace Tim9Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40014c38,0xffff0000,0x00000000,std::uint32_t>;
