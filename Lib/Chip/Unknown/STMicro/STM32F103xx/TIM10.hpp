...
//General purpose timer
    namespace Tim10Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015000,0xfffffc78,0x00000000,std::uint32_t>;
        ///Clock division
    ...
    namespace Tim10Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015004,0xffffff8f,0x00000000,std::uint32_t>;
    ...
    namespace Tim10Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001500c,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim10Sr{    ///<status register
        using Addr = Register::Address<0x40015010,0xfffffdfc,0x00000000,std::uint32_t>;
    ...
    namespace Tim10Egr{    ///<event generation register
        using Addr = Register::Address<0x40015014,0xfffffffc,0x00000000,std::uint32_t>;
    ...
    namespace Tim10Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40015018,0xffffff84,0x00000000,std::uint32_t>;
    ...
    namespace Tim10Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40015020,0xfffffff4,0x00000000,std::uint32_t>;
